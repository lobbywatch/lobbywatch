...
) ENGINE=InnoDB AUTO_INCREMENT=6993 DEFAULT CHARSET=utf8 COMMENT='Interessenbindungen von Parlamentariern';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=73292 DEFAULT CHARSET=utf8 COMMENT='Interessenbindungen von Parlamentariern';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=6437 DEFAULT CHARSET=utf8 COMMENT='Liste der Lobbyorganisationen';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=72076 DEFAULT CHARSET=utf8 COMMENT='Liste der Lobbyorganisationen';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=12759 DEFAULT CHARSET=utf8 COMMENT='Liste der Parlamentarier';
SET character_set_client = @saved_cs_client ;
...
-- Dump completed on 2019-07-09 11:41:22
