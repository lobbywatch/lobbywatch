...
--
-- Host: localhost
-- Erstellungszeit: 08. Aug 2014 um 21:18
...
,`anzahl_interessenbindung_tief_neu` bigint(21)
,`anzahl_interessenbindung_mittel_neu` bigint(21)
,`anzahl_interessenbindung_hoch_neu` bigint(21)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_parlamentarier_lobbyfaktor` AS select `parlamentarier`.`id` AS `id`,count(distinct `interessenbindung_tief`.`id`) AS `anzahl_interessenbindung_tief`,count(distinct `interessenbindung_mittel`.`id`) AS `anzahl_interessenbindung_mittel`,count(distinct `interessenbindung_hoch`.`id`) AS `anzahl_interessenbindung_hoch`,count(distinct `interessenbindung_tief_neu`.`id`) AS `anzahl_interessenbindung_tief_neu`,count(distinct `interessenbindung_mittel_neu`.`id`) AS `anzahl_interessenbindung_mittel_neu`,count(distinct `interessenbindung_hoch_neu`.`id`) AS `anzahl_interessenbindung_hoch_neu`,((((count(distinct `interessenbindung_tief`.`id`) * 1) + (count(distinct `interessenbindung_mittel`.`id`) * 5)) + (count(distinct `interessenbindung_hoch`.`id`) * 11)) + (((count(distinct `interessenbindung_tief_neu`.`id`) * 1) + (count(distinct `interessenbindung_mittel_neu`.`id`) * 5)) + (count(distinct `interessenbindung_hoch_neu`.`id`) * 11))) AS `lobbyfaktor`,(((count(distinct `interessenbindung_tief`.`id`) * 1) + (count(distinct `interessenbindung_mittel`.`id`) * 5)) + (count(distinct `interessenbindung_hoch`.`id`) * 11)) AS `lobbyfaktor_einfach` from ((((((`v_parlamentarier_simple` `parlamentarier` left join `v_interessenbindung` `interessenbindung_hoch` on(((`parlamentarier`.`id` = `interessenbindung_hoch`.`parlamentarier_id`) and (isnull(`interessenbindung_hoch`.`bis`) or (`interessenbindung_hoch`.`bis` >= now())) and (`interessenbindung_hoch`.`wirksamkeit` = 'hoch')))) left join `v_interessenbindung` `interessenbindung_mittel` on(((`parlamentarier`.`id` = `interessenbindung_mittel`.`parlamentarier_id`) and (isnull(`interessenbindung_mittel`.`bis`) or (`interessenbindung_mittel`.`bis` >= now())) and (`interessenbindung_mittel`.`wirksamkeit` = 'mittel')))) left join `v_interessenbindung` `interessenbindung_tief` on(((`parlamentarier`.`id` = `interessenbindung_tief`.`parlamentarier_id`) and (isnull(`interessenbindung_tief`.`bis`) or (`interessenbindung_tief`.`bis` >= now())) and (`interessenbindung_tief`.`wirksamkeit` = 'tief')))) left join `v_interessenbindung` `interessenbindung_hoch_neu` on(((`parlamentarier`.`id` = `interessenbindung_hoch_neu`.`parlamentarier_id`) and (isnull(`interessenbindung_hoch_neu`.`bis`) or (`interessenbindung_hoch_neu`.`bis` >= now())) and (`interessenbindung_hoch_neu`.`wirksamkeit` = 'hoch') and (`interessenbindung_hoch_neu`.`von` > `parlamentarier`.`im_rat_seit`)))) left join `v_interessenbindung` `interessenbindung_mittel_neu` on(((`parlamentarier`.`id` = `interessenbindung_mittel_neu`.`parlamentarier_id`) and (isnull(`interessenbindung_mittel_neu`.`bis`) or (`interessenbindung_mittel_neu`.`bis` >= now())) and (`interessenbindung_mittel_neu`.`wirksamkeit` = 'mittel') and (`interessenbindung_mittel_neu`.`von` > `parlamentarier`.`im_rat_seit`)))) left join `v_interessenbindung` `interessenbindung_tief_neu` on(((`parlamentarier`.`id` = `interessenbindung_tief_neu`.`parlamentarier_id`) and (isnull(`interessenbindung_tief_neu`.`bis`) or (`interessenbindung_tief_neu`.`bis` >= now())) and (`interessenbindung_tief_neu`.`wirksamkeit` = 'tief') and (`interessenbindung_tief_neu`.`von` > `parlamentarier`.`im_rat_seit`)))) group by `parlamentarier`.`id`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_zutrittsberechtigung_lobbyfaktor` AS select `zutrittsberechtigung`.`id` AS `id`,count(distinct `interessenbindung_tief`.`id`) AS `anzahl_interessenbindung_tief`,count(distinct `interessenbindung_mittel`.`id`) AS `anzahl_interessenbindung_mittel`,count(distinct `interessenbindung_hoch`.`id`) AS `anzahl_interessenbindung_hoch`,((count(distinct `interessenbindung_tief`.`id`) + (count(distinct `interessenbindung_mittel`.`id`) * 5)) + (count(distinct `interessenbindung_hoch`.`id`) * 11)) AS `lobbyfaktor` from (((`zutrittsberechtigung` left join `v_interessenbindung` `interessenbindung_hoch` on(((`zutrittsberechtigung`.`id` = `interessenbindung_hoch`.`parlamentarier_id`) and (isnull(`interessenbindung_hoch`.`bis`) or (`interessenbindung_hoch`.`bis` >= now())) and (`interessenbindung_hoch`.`wirksamkeit` = 'hoch')))) left join `v_interessenbindung` `interessenbindung_mittel` on(((`zutrittsberechtigung`.`id` = `interessenbindung_mittel`.`parlamentarier_id`) and (isnull(`interessenbindung_mittel`.`bis`) or (`interessenbindung_mittel`.`bis` >= now())) and (`interessenbindung_mittel`.`wirksamkeit` = 'mittel')))) left join `v_interessenbindung` `interessenbindung_tief` on(((`zutrittsberechtigung`.`id` = `interessenbindung_tief`.`parlamentarier_id`) and (isnull(`interessenbindung_tief`.`bis`) or (`interessenbindung_tief`.`bis` >= now())) and (`interessenbindung_tief`.`wirksamkeit` = 'tief')))) group by `zutrittsberechtigung`.`id`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_zutrittsberechtigung_lobbyfaktor_max` AS select max(`lobbyfaktor`.`anzahl_interessenbindung_tief`) AS `anzahl_interessenbindung_tief_max`,max(`lobbyfaktor`.`anzahl_interessenbindung_mittel`) AS `anzahl_interessenbindung_mittel_max`,max(`lobbyfaktor`.`anzahl_interessenbindung_hoch`) AS `anzahl_interessenbindung_hoch_max`,max(`lobbyfaktor`.`lobbyfaktor`) AS `lobbyfaktor_max` from `v_zutrittsberechtigung_lobbyfaktor` `lobbyfaktor`;
