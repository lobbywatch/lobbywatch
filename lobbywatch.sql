...
CREATE TABLE `country` (
  ...
  `iso-2` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ISO 3166 ALPHA-2 Code',
  `iso-3` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ISO 3166 ALPHA-3 Code',
...
) ENGINE=InnoDB AUTO_INCREMENT=12881 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Liste der Parlamentarier';
SET character_set_client = @saved_cs_client ;
...
-- Dump completed on 2019-08-24  8:04:55
