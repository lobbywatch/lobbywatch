...
CREATE DATABASE IF NOT EXISTS `lobbywatch` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
...
CREATE TABLE `branche` (
  ...
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name der Branche, z.B. Gesundheit, Energie',
  `name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name der Branche, z.B. Gesundheit, Energie',
  ...
  `technischer_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Technischer Name für Branche. Keine Sonderzeichen sind erlaubt. Wird z.B. für das finden des Branchensymboles gebraucht.',
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Beschreibung der Branche',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung der Branche',
  `angaben` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Angaben zur Branche',
  `angaben_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Angaben zur Branche auf Französisch',
  `farbcode` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'HTML-Farbcode, z.B. red oder #23FF23',
  `symbol_abs` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Symbolbild (Icon) der Branche, absoluter Pfad',
  `symbol_rel` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kleines Symbolbild (Icon) der Branche, relativer Pfad, kann mit $rel_files_url/ zu URL ergänzt werden',
  `symbol_klein_rel` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kleines Symbolbild (Icon) der Branche, relativer Pfad, kann mit $rel_files_url/ zu URL ergänzt werden',
  `symbol_dateiname_wo_ext` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Symbolbilddateiname ohne Erweiterung',
  `symbol_dateierweiterung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Dateierweiterung des Symbolbildes',
  `symbol_dateiname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Symbolbilddateiname mit Erweiterung',
  `symbol_mime_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'MIME Type des Symbolbildes',
...
) ENGINE=InnoDB AUTO_INCREMENT=200 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Wirtschaftsbranchen';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `country` (
  ...
  `continent` enum('Antarctica','Australia','Africa','North America','South America','Europe','Asia') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kontinent',
  `name_en` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name des Landes auf Englisch',
  `official_name_en` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Offizieller Name des Landes (englisch)',
  `capital_en` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Hauptstadt auf Englisch',
  `name_de` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name des Landes auf Deutsch',
  `official_name_de` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Offizieller Name des Landes (deutsch)',
  `capital_de` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Hauptstadt auf Deutsch',
  `name_fr` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name',
  `official_name_fr` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Offizieller Name des Landes (französisch)',
  `capital_fr` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Hauptstadt auf Französisch',
  `name_it` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Italienischer Name',
  `official_name_it` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Offizieller Name des Landes (italiensich)',
  `capital_it` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Hauptstadt auf Italienisch',
  `iso2` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ISO 3166 ALPHA-2 Code',
  `iso3` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ISO 3166 ALPHA-3 Code',
  `vehicle_code` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nationalitätszeichen für Fahrzeuge',
  `ioc` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT ' Ländercodes des Internationalen Olympischen Komitees (IOC)',
  `tld` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Top Level Domain für Internet',
  `currency` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Währungsabkürzung',
  `phone` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Internatinale Vorwahl',
...
) ENGINE=InnoDB AUTO_INCREMENT=252 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Länder der Welt mit ISO Code (http://countrylist.net)';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `fraktion` (
  ...
  `abkuerzung` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Fraktionsabkürzung',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener Name der Fraktion',
  `name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Fraktion',
  `position` enum('links','rechts','mitte') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Politische Position der Fraktion',
  `farbcode` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'HTML-Farbcode, z.B. red oder #23FF23',
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung der Fraktion',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung der Fraktion',
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Fraktionen des Parlamentes';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Fraktionen des Parlamentes';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `in_kommission` (
  ...
  `funktion` enum('praesident','vizepraesident','mitglied','co-praesident') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mitglied' COMMENT 'Funktion des Parlamentariers in der Kommission',
  `parlament_committee_function` int(11) DEFAULT NULL COMMENT 'committeeFunction von ws.parlament.ch',
  `parlament_committee_function_name` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'committeeFunctionName von ws.parlament.ch',
...
) ENGINE=InnoDB AUTO_INCREMENT=1394 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Kommissionszugehörigkeit von Parlamentariern';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=10333 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Kommissionszugehörigkeit von Parlamentariern';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `interessenbindung` (
  ...
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
  `kontrolliert_datum` timestamp NULL DEFAULT NULL COMMENT 'Der Eintrag wurde durch eine zweite Person am angegebenen Datum kontrolliert. (Leer/NULL bedeutet noch nicht kontrolliert.)',
  `autorisiert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Autorisiert durch. Sonstige Angaben als Notiz erfassen.',
...
) ENGINE=InnoDB AUTO_INCREMENT=7019 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Interessenbindungen von Parlamentariern';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
CREATE TABLE `interessenbindung_jahr` (
  ...
  `beschreibung` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Beschreibung der Vergütung. Möglichst kurz. Wird nicht ausgewertet, jedoch angezeigt.',
  `quelle_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL der Quelle; zum Beleg',
...
) ENGINE=InnoDB AUTO_INCREMENT=1789 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresvergütung durch Interessenbindungen';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=7173 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresvergütung durch Interessenbindungen';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=73486 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Interessenbindungen von Parlamentariern';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `interessengruppe` (
  ...
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Bezeichnung der Interessengruppe',
  `name_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Bezeichnung der Interessengruppe',
  `branche_id` int(11) NOT NULL COMMENT 'Fremdschlüssel Branche',
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Eingrenzung und Beschreibung zur Interessengruppe',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Eingrenzung und Beschreibung zur Interessengruppe auf französisch',
  `alias_namen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Strichpunkt-getrennte Aufzählung von alternative Namen für die Lobbygruppe; bei der Suche werden für ein einfacheres Finden auch in den Alias-Namen gesucht.',
  `alias_namen_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Strichpunkt-getrennte Aufzählung von alternativen französischen Namen für die Lobbygruppe; bei der Suche werden für ein einfacheres Finden auch in den Alias-Namen gesucht.',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  `eingabe_abgeschlossen_datum` timestamp NULL DEFAULT NULL COMMENT 'Die Eingabe ist für den Ersteller der Einträge abgeschlossen und bereit für die Kontrolle. (Leer/NULL bedeutet, dass die Eingabe noch im Gange ist.)',
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
...
) ENGINE=InnoDB AUTO_INCREMENT=148 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Interessengruppen einer Branche';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1713 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Interessengruppen einer Branche';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `interessenraum` (
  ...
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name des Interessenbereiches',
  `name_fr` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name des Interessenbereiches',
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung des Interessenraumes',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung des Interessenraumes',
...
CREATE TABLE `kanton` (
  ...
  `abkuerzung` enum('AG','AR','AI','BL','BS','BE','FR','GE','GL','GR','JU','LU','NE','NW','OW','SH','SZ','SO','SG','TI','TG','UR','VD','VS','ZG','ZH') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kantonskürzel',
  `kantonsnr` tinyint(4) NOT NULL COMMENT 'Nummer des Kantons gemäss Verfassung',
  `name_de` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Deutscher Name des Kantons',
  `name_fr` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Französischer Name',
  `name_it` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Italienischer Name',
  ...
  `amtssprache` set('de','fr','it','rm') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Amtssprachen des Kantons',
  `hauptort_de` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Hauptort des Kantons',
  `hauptort_fr` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Hauptort auf französisch',
  `hauptort_it` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Hauptort auf italienisch',
  ...
  `wappen_svg` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SVG Wappen des Kantons',
  `wappen_svg_pfad` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Pfad zu SVG Wappen des Kantons',
  `wappen_klein` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Pfad zu kleinem Wappen des Kantons (25px)',
  `wappen` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Pfad zu Wappen des Kantons (50px)',
  `lagebild` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Pfad zum lagebild des Kantons',
  `homepage` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Homepage des Kantons',
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung des Kantons',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  `eingabe_abgeschlossen_datum` timestamp NULL DEFAULT NULL COMMENT 'Die Eingabe ist für den Ersteller der Einträge abgeschlossen und bereit für die Kontrolle. (Leer/NULL bedeutet, dass die Eingabe noch im Gange ist.)',
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
...
) ENGINE=InnoDB AUTO_INCREMENT=245 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresbasierte Angaben zu Kantonen';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `kommission` (
  ...
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung der Kommission',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung der Kommission',
  `sachbereiche` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Liste der Sachbereiche der Kommission, abgetrennt durch ";".',
  `sachbereiche_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Liste der Sachbereiche der Kommission auf französisch, abgetrennt durch ";".',
  ...
  `parlament_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Link zur Seite auf Parlament.ch',
...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Parlamententskommissionen';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=507 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Parlamententskommissionen';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=3365 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Mandate der Zugangsberechtigten';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
CREATE TABLE `mandat_jahr` (
  ...
  `beschreibung` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Beschreibung der Verfgütung. Möglichst kurz. Wird nicht ausgewertet, jedoch angezeigt.',
  `quelle_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL der Quelle; zum Beleg',
  `quelle_url_gueltig` tinyint(1) DEFAULT NULL COMMENT 'Ist Quell-URL noch gueltig? Funktioniert er noch?',
  `quelle` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Quellenangabe, Format: "[Publikation], DD.MM.YYYY", falls vorhanden bitte die URL im Feld "Quelle URL" auch hinzufügen',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  ...
  CONSTRAINT `fk_mandat_id` FOREIGN KEY (`mandat_id`) REFERENCES `mandat` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresvergütung durch Mandate';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresvergütung durch Mandate';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=30587 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Mandate der Zugangsberechtigten';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mil_grad` (
  ...
  `name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name des militärischen Grades',
  `name_fr` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name des militärischen Grades',
  `abkuerzung` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Abkürzung des militärischen Grades',
  `abkuerzung_fr` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Abkürzung des militärischen Grades',
  `typ` enum('Mannschaft','Unteroffizier','Hoeherer Unteroffizier','Offizier','Hoeherer Stabsoffizier') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Stufe des militärischen Grades',
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Militärische Grade (Armee XXI)';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Militärische Grade (Armee XXI)';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mv_interessenbindung` (
  `anzeige_name` text COLLATE utf8mb4_unicode_ci,
  ...
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgeändert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  ...
  `wirksamkeit` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `organisation_lobbyeinfluss` varchar(9) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for v_interessenbindung';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for v_mandat';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mv_organisation` (
  `anzeige_name` varchar(454) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anzeige_mixed` varchar(454) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anzeige_bimixed` varchar(302) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `searchable_name` text COLLATE utf8mb4_unicode_ci,
  `anzeige_name_de` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name der Organisation. Sollte nur juristischem Namen entsprechen, ohne Zusätze, wie Adresse.',
  `anzeige_name_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name',
  `name` varchar(454) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id` int(11) NOT NULL DEFAULT '0' COMMENT 'Technischer Schlüssel der Lobbyorganisation',
  `name_de` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name der Organisation. Sollte nur juristischem Namen entsprechen, ohne Zusätze, wie Adresse.',
  ...
  `alias_namen_de` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Strichpunkt-getrennte Aufzählung von alternative Namen für die Organisation; bei der Suche werden für ein einfacheres Finden auch in den Alias-Namen gesucht.',
  `abkuerzung_fr` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Abkürzung der Organisation',
  `alias_namen_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Aliasnamen: Strichpunkt-getrennte Aufzählung von alternative Namen für die Organisation; bei der Suche werden für ein einfacheres Finden auch in den Alias-Namen gesucht.',
  `abkuerzung_it` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Italienische Abkürzung der Organisation',
  `alias_namen_it` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Italienischer Aliasnamen: Strichpunkt-getrennte Aufzählung von alternativen Namen für die Organisation; bei der Suche wird für ein einfacheres Finden auch in den Alias-Namen gesucht.',
  ...
  `rechtsform` enum('AG','GmbH','Stiftung','Verein','Informelle Gruppe','Parlamentarische Gruppe','Oeffentlich-rechtlich','Einzelunternehmen','KG','Genossenschaft','Staatlich','Ausserparlamentarische Kommission','Einfache Gesellschaft') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Rechtsform der Organisation',
  `rechtsform_handelsregister` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Code der Rechtsform des Handelsregister, z.B. 0106 für AG. Das Feld kann importiert werden.',
  ...
  `typ` set('EinzelOrganisation','DachOrganisation','MitgliedsOrganisation','LeistungsErbringer','dezidierteLobby','Gemeinnuetzig','Gewinnorientiert') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Typ der Organisation. Beziehungen können über Organisation_Beziehung eingegeben werden.',
  `vernehmlassung` enum('immer','punktuell','nie') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Häufigkeit der Teilname an nationalen Vernehmlassungen',
  ...
  `homepage` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Link zur Webseite',
  `handelsregister_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Link zum Eintrag im Handelsregister',
  `twitter_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Twittername',
  ...
  `adresse_strasse` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Adresse der Organisation',
  `adresse_zusatz` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Adressezusatz, z.B. Postfach',
  `adresse_plz` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Postleitzahl der Organisation',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  ...
  `kontrolliert_datum_unix` bigint(11) DEFAULT NULL,
  `freigabe_datum_unix` bigint(11) DEFAULT NULL,
  `branche_ALT` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `branche_de_ALT` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `branche_fr_ALT` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe_de` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe_branche` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe_branche_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe_branche_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe_branche_id` int(11) COMMENT 'Fremdschlüssel Branche',
  `interessengruppe_branche_kommission1_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Nationalrat',
  `interessengruppe_branche_kommission1_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe_branche_kommission1_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe_branche_kommission1_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe_branche_kommission1_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe_branche_kommission1_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe_branche_kommission1_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe_branche_kommission2_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Ständerat',
  `interessengruppe_branche_kommission2_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe_branche_kommission2_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe_branche_kommission2_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe_branche_kommission2_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe_branche_kommission2_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe_branche_kommission2_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe1` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_id` int(11) DEFAULT NULL COMMENT 'Technischer Schlüssel der Interessengruppe',
  `interessengruppe1_de` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_id` int(11) COMMENT 'Fremdschlüssel Branche',
  `interessengruppe1_branche_kommission_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_kommission_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_kommission_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_kommissionen_abkuerzung` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_kommissionen_abkuerzung_de` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_kommissionen_abkuerzung_fr` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe1_branche_kommission1_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Nationalrat',
  `interessengruppe1_branche_kommission1_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe1_branche_kommission1_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe1_branche_kommission1_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe1_branche_kommission1_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe1_branche_kommission1_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe1_branche_kommission1_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe1_branche_kommission2_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Ständerat',
  `interessengruppe1_branche_kommission2_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe1_branche_kommission2_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe1_branche_kommission2_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe1_branche_kommission2_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe1_branche_kommission2_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe1_branche_kommission2_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe2` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_de` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_id` int(11) COMMENT 'Fremdschlüssel Branche',
  `interessengruppe2_branche_kommission_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_kommission_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_kommission_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_kommissionen_abkuerzung` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_kommissionen_abkuerzung_de` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_kommissionen_abkuerzung_fr` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe2_branche_kommission1_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Nationalrat',
  `interessengruppe2_branche_kommission1_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe2_branche_kommission1_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe2_branche_kommission1_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe2_branche_kommission1_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe2_branche_kommission1_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe2_branche_kommission1_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe2_branche_kommission2_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Ständerat',
  `interessengruppe2_branche_kommission2_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe2_branche_kommission2_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe2_branche_kommission2_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe2_branche_kommission2_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe2_branche_kommission2_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe2_branche_kommission2_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe3` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_de` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_id` int(11) COMMENT 'Fremdschlüssel Branche',
  `interessengruppe3_branche_kommission_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_kommission_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_kommission_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_kommissionen_abkuerzung` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_kommissionen_abkuerzung_de` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_kommissionen_abkuerzung_fr` varchar(33) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interessengruppe3_branche_kommission1_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Nationalrat',
  `interessengruppe3_branche_kommission1_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe3_branche_kommission1_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe3_branche_kommission1_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe3_branche_kommission1_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe3_branche_kommission1_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe3_branche_kommission1_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `interessengruppe3_branche_kommission2_id` int(11) DEFAULT NULL COMMENT 'Zuständige Kommission im Ständerat',
  `interessengruppe3_branche_kommission2_abkuerzung` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe3_branche_kommission2_abkuerzung_de` varchar(15) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel der Kommission',
  `interessengruppe3_branche_kommission2_abkuerzung_fr` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französisches Kürzel der Kommission',
  `interessengruppe3_branche_kommission2_name` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe3_branche_kommission2_name_de` varchar(100) COLLATE utf8mb4_unicode_ci COMMENT 'Ausgeschriebener Name der Kommission',
  `interessengruppe3_branche_kommission2_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Kommission',
  `refreshed_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Materialized View aktualisiert am',
  `land` varchar(200) COLLATE utf8mb4_unicode_ci COMMENT 'Name des Landes auf Deutsch',
  `interessenraum` varchar(50) COLLATE utf8mb4_unicode_ci COMMENT 'Name des Interessenbereiches',
  `interessenraum_de` varchar(50) COLLATE utf8mb4_unicode_ci COMMENT 'Name des Interessenbereiches',
  `interessenraum_fr` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name des Interessenbereiches',
  ...
  `geschaeftsbericht_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Link zum Geschäftsbericht',
  `quelle_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL der Quelle',
  ...
  `lobbyeinfluss` varchar(9) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lobbyeinfluss_index` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_freigabe` (`freigabe_datum`),
  KEY `idx_branche_freigabe` (`ALT_branche_id`,`freigabe_datum`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for v_organisation';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mv_parlamentarier` (
  `anzeige_name` varchar(152) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anzeige_name_de` varchar(152) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anzeige_name_fr` varchar(152) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(202) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_de` varchar(202) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_fr` varchar(202) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id` int(11) NOT NULL DEFAULT '0' COMMENT 'Technischer Schlüssel des Parlamentariers',
  `nachname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nachname des Parlamentariers',
  `vorname` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Vornahme des Parlamentariers',
  `vorname_kurz` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Alltagsvorname oder gebräuchlicher Spitzname, z.B. Nik für Niklaus',
  `zweiter_vorname` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Zweiter Vorname des Parlamentariers',
  ...
  `kommissionen` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abkürzungen der Kommissionen des Parlamentariers (automatisch erzeugt [in_Kommission Trigger])',
  `partei_id` int(11) DEFAULT NULL COMMENT 'Fremdschlüssel Partei. Leer bedeutet parteilos.',
  `parteifunktion` enum('mitglied','praesident','vizepraesident') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mitglied' COMMENT 'Funktion des Parlamentariers in der Partei',
  `fraktion_id` int(11) DEFAULT NULL COMMENT 'Fraktionszugehörigkeit im nationalen Parlament. Fremdschlüssel.',
  `fraktionsfunktion` enum('mitglied','praesident','vizepraesident') COLLATE utf8mb4_unicode_ci DEFAULT 'mitglied' COMMENT 'Funktion des Parlamentariers in der Fraktion',
  ...
  `beruf` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Beruf des Parlamentariers',
  `beruf_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Beruf des Parlamentariers auf französisch',
  ...
  `titel` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Titel des Parlamentariers, wird von ws.parlament.ch importiert',
  `aemter` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Politische Ämter (importiert von ws.parlament.ch mandate)',
  `weitere_aemter` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Zusätzliche Ämter (importiert von ws.parlament.ch additionalMandate)',
  `zivilstand` enum('ledig','verheiratet','geschieden','eingetragene partnerschaft','getrennt','verwitwet') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Zivilstand',
  ...
  `geschlecht` enum('M','F') COLLATE utf8mb4_unicode_ci DEFAULT 'M' COMMENT 'Geschlecht des Parlamentariers, M=Mann, F=Frau',
  `geburtstag` date DEFAULT NULL COMMENT 'Geburtstag des Parlamentariers',
  `photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Photo des Parlamentariers (JPEG/jpg)',
  `photo_dateiname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Photodateiname ohne Erweiterung',
  `photo_dateierweiterung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Erweiterung der Photodatei',
  `photo_dateiname_voll` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Photodateiname mit Erweiterung',
  `photo_mime_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'MIME Type des Photos',
  `kleinbild` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT 'leer.png' COMMENT 'Bild 44x62 px oder leer.png',
  `sitzplatz` int(11) DEFAULT NULL COMMENT 'Sitzplatznr im Parlament. Siehe Sitzordnung auf parlament.ch',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'E-Mail-Adresse des Parlamentariers',
  `homepage` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Homepage des Parlamentariers',
  `homepage_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Zweite Homepage, importiert von ws.parlament.ch',
  ...
  `parlament_interessenbindungen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Importierte Interessenbindungen von ws.parlament.ch',
  `parlament_interessenbindungen_json` json DEFAULT NULL COMMENT 'Importierte Interessenbindungen von ws.parlament.ch als JSON. Rechtsformen: -, AG, Anst., EG, EidgKomm, Gen., GmbH, KollG, Komm., Körp., Stift., Ve., öffStift; Gremien: -, A, AufR., Bei., D, GL, GL, V, GV, Pat., Sr., V, VR, Vw., ZA, ZV; Funktionen: -, A, AufR., Bei., D, GL, GL, V, GV, Pat., Sr., V, VR, Vw., ZA, ZV',
  ...
  `adresse_strasse` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Wohnadresse des Parlamentariers, falls verfügbar, sonst Postadresse; Adressen erhältlich auf parlament.ch',
  `adresse_zusatz` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Wohnadresse des Parlamentariers, falls verfügbar, sonst Postadresse; Adressen erhältlich auf parlament.ch',
  `adresse_plz` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Wohnadresse des Parlamentariers, falls verfügbar, sonst Postadresse; Adressen erhältlich auf parlament.ch',
  `adresse_ort` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Wohnadresse des Parlamentariers, falls verfügbar, sonst Postadresse; Adressen erhältlich auf parlament.ch',
  `telephon_1` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Telephonnummer 1, z.B. Festnetz',
  `telephon_2` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Telephonnummer 2, z.B. Mobiltelephon',
  `erfasst` enum('Ja','Nein') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ist der Parlamentarier erfasst? Falls der Parlamentarier beispielsweise nicht mehr zur Wiederwahl antritt und deshalb nicht erfasst wird, kann dieses Feld auf Nein gestellt werden. NULL bedeutet Status unklar.',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  `eingabe_abgeschlossen_datum` timestamp NULL DEFAULT NULL COMMENT 'Die Eingabe ist für den Ersteller der Einträge abgeschlossen und bereit für die Kontrolle. (Leer/NULL bedeutet, dass die Eingabe noch im Gange ist.)',
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
  `kontrolliert_datum` timestamp NULL DEFAULT NULL COMMENT 'Der Eintrag wurde durch eine zweite Person am angegebenen Datum kontrolliert. (Leer/NULL bedeutet noch nicht kontrolliert.)',
  `autorisierung_verschickt_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Autorisierungsanfrage verschickt durch',
  ...
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgeändert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  `beruf_de` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Beruf des Parlamentariers',
  ...
  `rat` varchar(10) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel des Rates',
  `kanton` enum('AG','AR','AI','BL','BS','BE','FR','GE','GL','GR','JU','LU','NE','NW','OW','SH','SZ','SO','SG','TI','TG','UR','VD','VS','ZG','ZH') COLLATE utf8mb4_unicode_ci COMMENT 'Kantonskürzel',
  `romandie` tinyint(1) DEFAULT '0' COMMENT 'Gehört dieser Kanton zur Romandie?',
  `rat_de` varchar(10) COLLATE utf8mb4_unicode_ci COMMENT 'Kürzel des Rates',
  `kanton_name_de` varchar(50) COLLATE utf8mb4_unicode_ci COMMENT 'Deutscher Name des Kantons',
  `rat_fr` varchar(10) COLLATE utf8mb4_unicode_ci COMMENT 'Französische Abkürzung',
  `kanton_name_fr` varchar(50) COLLATE utf8mb4_unicode_ci COMMENT 'Französischer Name',
  `kommissionen_namen` text COLLATE utf8mb4_unicode_ci,
  `kommissionen_namen_de` text COLLATE utf8mb4_unicode_ci,
  `kommissionen_namen_fr` text COLLATE utf8mb4_unicode_ci,
  `kommissionen_abkuerzung` text COLLATE utf8mb4_unicode_ci,
  `kommissionen_abkuerzung_de` text COLLATE utf8mb4_unicode_ci,
  `kommissionen_abkuerzung_fr` text COLLATE utf8mb4_unicode_ci,
  `kommissionen_anzahl` bigint(21) NOT NULL DEFAULT '0',
  `partei` varchar(20) COLLATE utf8mb4_unicode_ci COMMENT 'Parteiabkürzung',
  `partei_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener Name der Partei',
  `fraktion` varchar(20) COLLATE utf8mb4_unicode_ci COMMENT 'Fraktionsabkürzung',
  `militaerischer_grad` varchar(30) COLLATE utf8mb4_unicode_ci COMMENT 'Name des militärischen Grades',
  `partei_de` varchar(20) COLLATE utf8mb4_unicode_ci COMMENT 'Parteiabkürzung',
  `partei_name_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener Name der Partei',
  `militaerischer_grad_de` varchar(30) COLLATE utf8mb4_unicode_ci COMMENT 'Name des militärischen Grades',
  `partei_fr` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Parteiabkürzung',
  `partei_name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Partei',
  `militaerischer_grad_fr` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Name des militärischen Grades',
  `beruf_branche_id` int(11) COMMENT 'Fremdschlüssel Branche',
  `titel_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `titel_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parlamentarier_id` int(11) COMMENT 'Fremdschlüssel Parlamentarier',
  `anzahl_interessenbindungen` bigint(21) DEFAULT '0',
  `anzahl_hauptberufliche_interessenbindungen` bigint(21) DEFAULT '0',
  `anzahl_nicht_hauptberufliche_interessenbindungen` bigint(21) DEFAULT '0',
  `anzahl_abgelaufene_interessenbindungen` bigint(21) DEFAULT '0',
  `anzahl_interessenbindungen_alle` bigint(21) DEFAULT '0',
  `anzahl_erfasste_verguetungen` bigint(21) DEFAULT '0',
  `anzahl_erfasste_hauptberufliche_verguetungen` bigint(21) DEFAULT '0',
  `anzahl_erfasste_nicht_hauptberufliche_verguetungen` bigint(21) DEFAULT '0',
  `verguetungstransparenz_berechnet` decimal(23,2) DEFAULT NULL,
  `verguetungstransparenz_berechnet_nicht_beruflich` decimal(23,2) DEFAULT NULL,
  `verguetungstransparenz_berechnet_alle` decimal(23,2) DEFAULT NULL,
  `verguetungstransparenz_beurteilung_stichdatum` date COMMENT 'Stichdatum der Auswertung der Vergütungstransparenz',
  `verguetungstransparenz_beurteilung` enum('ja','nein','teilweise') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ist der dieser Parlamentarier transparent bzgl seinen Vergütungen? ja, nein, teilweise (Leer/NULL bedeutet noch nicht eingetragen)',
  `refreshed_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Materialized View aktualisiert am',
  `anzahl_interessenbindung_tief` tinyint(3) unsigned DEFAULT NULL,
  `anzahl_interessenbindung_mittel` tinyint(3) unsigned DEFAULT NULL,
  `anzahl_interessenbindung_hoch` tinyint(3) unsigned DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for v_parlamentarier';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mv_parlamentarier_lobbyfaktor` (
  ...
  `refreshed_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Materialized View aktualisiert am',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for v_parlamentarier_lobbyfaktor';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mv_search_table` (
  `id` int(11) NOT NULL DEFAULT '0',
  `table_name` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `page` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `table_weight` bigint(20) NOT NULL DEFAULT '0',
  `name_de` varchar(193) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_fr` varchar(193) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `search_keywords_de` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `search_keywords_fr` text COLLATE utf8mb4_unicode_ci,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for parlamentarier, zutrittsberechtigung, branche, interessengruppe, kommission, organisation, partei';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `mv_zutrittsberechtigung` (
  `anzeige_name` varchar(170) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anzeige_name_de` varchar(170) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anzeige_name_fr` varchar(170) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(169) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_de` varchar(169) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_fr` varchar(169) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id` int(11) NOT NULL DEFAULT '0' COMMENT 'Technischer Schlüssel der Zugangsberechtigung',
  `nachname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nachname des berechtigten Persion',
  `vorname` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Vorname der berechtigten Person',
  `zweiter_vorname` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Zweiter Vorname der zutrittsberechtigten Person',
  `beschreibung_de` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung der Person. Der Text ist öffentlich einsehbar.',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung der Person. Der Text ist öffentlich einsehbar.',
  `parlamentarier_kommissionen` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abkürzungen der Kommissionen des zugehörigen Parlamentariers (automatisch erzeugt [in_Kommission/person Trigger])',
  ...
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kontakt E-Mail-Adresse der zutrittsberechtigen Person',
  `homepage` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Homepage der zutrittsberechtigen Person',
  `twitter_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Twittername',
  `linkedin_profil_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL zum LinkedIn-Profil',
  `xing_profil_name` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Profilname in XING (letzter Teil von Link), wird ergänzt mit https://www.xing.com/profile/ zu einem ganzen Link',
  `facebook_name` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Facebookname (letzter Teil von Link), wird mit https://www.facebook.com/ zu einem ganzen Link ergänzt',
  `telephon_1` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Telephonnummer 1, z.B. Festnetz',
  `telephon_2` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Telephonnummer 2, z.B. Mobiltelephon',
  `erfasst` enum('Ja','Nein') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ist die Person erfasst? Falls der zugehörige Parlamentarier beispielsweise nicht mehr zur Wiederwahl antritt und deshalb die Person nicht erfasst wird, kann dieses Feld auf Nein gestellt werden. NULL bedeutet Status unklar.',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa_person` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  ...
  `kontrolliert_visa_person` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
  ...
  `autorisiert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Autorisiert durch. Sonstige Angaben als Notiz erfassen.',
  `autorisiert_datum` date DEFAULT NULL COMMENT 'Autorisiert am. Leer/NULL bedeutet noch nicht autorisiert. Ein Datum bedeutet, dass der Eintrag vom Parlamentarier autorisiert wurde.',
  `freigabe_visa_person` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Freigabe von wem? (Freigabe = Daten sind fertig)',
  `freigabe_datum_person` timestamp NULL DEFAULT NULL COMMENT 'Freigabedatum (Freigabe = Daten sind fertig)',
  `created_visa_person` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Datensatz erstellt von',
  `created_date_person` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
  `updated_visa_person` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgeändert von',
  `updated_date_person` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  `published_person` int(1) NOT NULL DEFAULT '0',
  ...
  `funktion` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Funktion der zutrittsberechtigen Person.',
  `funktion_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Funktion der zutrittsberechtigen Person auf französisch.',
  ...
  `partei_de` varchar(20) COLLATE utf8mb4_unicode_ci COMMENT 'Parteiabkürzung',
  `partei_fr` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Parteiabkürzung',
  `parlamentarier_name` varchar(152) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Materialzed view for v_zutrittsberechtigung';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=6471 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Liste der Lobbyorganisationen';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
CREATE TABLE `organisation_anhang` (
  ...
  `datei` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Datei',
  `dateiname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Dateiname ohne Erweiterung',
  `dateierweiterung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Erweiterung der Datei',
  `dateiname_voll` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Dateiname inkl. Erweiterung',
  `mime_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'MIME Type der Datei',
  `encoding` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Encoding der Datei',
  `beschreibung` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Beschreibung des Anhangs',
  `freigabe_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Freigabe von wem? (Freigabe = Daten sind fertig)',
  `freigabe_datum` timestamp NULL DEFAULT NULL COMMENT 'Freigabedatum (Freigabe = Daten sind fertig)',
  `created_visa` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Datensatz erstellt von',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Anhänge zu Organisationen';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Anhänge zu Organisationen';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `organisation_beziehung` (
  ...
  `art` enum('arbeitet fuer','mitglied von','tochtergesellschaft von','partner von','beteiligt an') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Beschreibt die Beziehung einer Organisation zu einer Zielorgansation',
  `beschreibung` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bezeichung der Organisationsbeziehung. Möglichst kurz. Wird nicht ausgewertet, jedoch angezeigt.',
  `beschreibung_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Bezeichung der Organisationsbeziehung. Möglichst kurz. Wird nicht ausgewertet, jedoch angezeigt.',
  `quelle_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL der Quelle; zum Beleg',
  `quelle_url_gueltig` tinyint(1) DEFAULT NULL COMMENT 'Ist Quell-URL noch gueltig? Funktioniert er noch?',
  `quelle` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Quellenangabe, Format: "[Publikation], DD.MM.YYYY", falls vorhanden bitte die URL im Feld "Quelle URL" auch hinzufügen',
...
) ENGINE=InnoDB AUTO_INCREMENT=3404 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Beschreibt die Beziehung von Organisationen zueinander';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=15371 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Beschreibt die Beziehung von Organisationen zueinander';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresbasierte Angaben zu Organisationen';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Jahresbasierte Angaben zu Organisationen';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=72227 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Liste der Lobbyorganisationen';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=346 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Liste der Parlamentarier';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=570 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Anhänge zu Parlamentariern';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1523 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Anhänge zu Parlamentariern';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=12882 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Liste der Parlamentarier';
SET character_set_client = @saved_cs_client ;

--
-- Table structure for table `parlamentarier_transparenz`
--

DROP TABLE IF EXISTS `parlamentarier_transparenz`;
SET @saved_cs_client     = @@character_set_client ;
SET character_set_client = utf8 ;
CREATE TABLE `parlamentarier_transparenz` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Technischer Schlüssel',
  `parlamentarier_id` int(11) NOT NULL COMMENT 'Fremdschlüssel des Parlamentariers',
  `stichdatum` date NOT NULL COMMENT 'Stichdatum der Auswertung der Vergütungstransparenz',
  `verguetung_transparent` enum('ja','nein','teilweise') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ist der dieser Parlamentarier transparent bzgl seinen Vergütungen? ja, nein, teilweise (Leer/NULL bedeutet noch nicht eingetragen)',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  `eingabe_abgeschlossen_datum` timestamp NULL DEFAULT NULL COMMENT 'Die Eingabe ist für den Ersteller der Einträge abgeschlossen und bereit für die Kontrolle. (Leer/NULL bedeutet, dass die Eingabe noch im Gange ist.)',
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
  ...
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_stichdatum_unique` (`parlamentarier_id`,`stichdatum`) COMMENT 'Fachlicher unique constraint',
  CONSTRAINT `fk_parlamentarier_id` FOREIGN KEY (`parlamentarier_id`) REFERENCES `parlamentarier` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Transparenzinformationen zu den Parlamentariern, z.B. Verütungstransparenz';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
--
-- Table structure for table `parlamentarier_transparenz_log`
--

DROP TABLE IF EXISTS `parlamentarier_transparenz_log`;
SET @saved_cs_client     = @@character_set_client ;
SET character_set_client = utf8 ;
CREATE TABLE `parlamentarier_transparenz_log` (
  `id` int(11) NOT NULL COMMENT 'Technischer Schlüssel der Live-Daten',
  `parlamentarier_id` int(11) NOT NULL COMMENT 'Fremdschlüssel des Parlamentariers',
  `stichdatum` date NOT NULL COMMENT 'Stichdatum der Auswertung der Vergütungstransparenz',
  `verguetung_transparent` enum('ja','nein','teilweise') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ist der dieser Parlamentarier transparent bzgl seinen Vergütungen? ja, nein, teilweise (Leer/NULL bedeutet noch nicht eingetragen)',
  ...
  `snapshot_id` int(11) DEFAULT NULL COMMENT 'Fremdschlüssel zu einem Snapshot',
  PRIMARY KEY (`log_id`),
  KEY `fk_parlamentarier_transparenz_log_snapshot_id` (`snapshot_id`),
  CONSTRAINT `fk_parlamentarier_transparenz_log_snapshot_id` FOREIGN KEY (`snapshot_id`) REFERENCES `snapshot` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Transparenzinformationen zu den Parlamentariern, z.B. Verütungstransparenz';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `partei` (
  ...
  `abkuerzung` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Parteiabkürzung',
  `abkuerzung_fr` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Parteiabkürzung',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener Name der Partei',
  `name_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ausgeschriebener französischer Name der Partei',
  ...
  `position` enum('links','rechts','mitte') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Politische Position der Partei',
  `farbcode` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'HTML-Farbcode, z.B. red oder #23FF23',
  `homepage` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Homepage der Partei',
  `homepage_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Homepage der Partei',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kontakt E-Mail-Adresse der Partei',
  `email_fr` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Kontakt E-Mail-Adresse der Partei',
  `twitter_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Twittername',
  `twitter_name_fr` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französischer Twittername',
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung der Partei',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung der Partei',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  `eingabe_abgeschlossen_datum` timestamp NULL DEFAULT NULL COMMENT 'Die Eingabe ist für den Ersteller der Einträge abgeschlossen und bereit für die Kontrolle. (Leer/NULL bedeutet, dass die Eingabe noch im Gange ist.)',
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Politische Parteien des Parlamentes';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Politische Parteien des Parlamentes';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `person` (
  ...
  `vorname` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Vorname der berechtigten Person',
  `zweiter_vorname` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Zweiter Vorname der zutrittsberechtigten Person',
  `namensunterscheidung` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Namenszusatz zur Unterscheiden von Personen mit exakt gleichem Namen. Ein Unterscheidungsmerkmal der Person z.B. der Beruf, sollte im Feld gespeichert werden. NUR BEI PERSONEN MIT EXAKT GLEICHEM VORNAMEN UND NAMEN VERWENDEN.',
  `beschreibung_de` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Beschreibung der Person. Der Text ist öffentlich einsehbar.',
  `beschreibung_fr` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Französische Beschreibung der Person. Der Text ist öffentlich einsehbar.',
  `parlamentarier_kommissionen` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abkürzungen der Kommissionen des zugehörigen Parlamentariers (automatisch erzeugt [in_Kommission/person Trigger])',
  `zutrittsberechtigung_von` varchar(75) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Welcher Parlamentarier gab die Zutrittsberechtigung?',
  `beruf` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Beruf der Person',
  `beruf_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Französische Bezeichung des Beruf der Person',
  `titel` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Titel der Person, z.B. Lic. iur.',
  `beruf_interessengruppe_id` int(11) DEFAULT NULL COMMENT 'Fremdschlüssel zur Interessengruppe für den Beruf',
  `partei_id` int(11) DEFAULT NULL COMMENT 'Fremdschlüssel Partei. Parteimitgliedschaft der zutrittsberechtigten Person.',
  `geschlecht` enum('M','F') COLLATE utf8mb4_unicode_ci DEFAULT 'M' COMMENT 'Geschlecht des Parlamentariers, M=Mann, F=Frau',
  `arbeitssprache` enum('de','fr','it') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Arbeitssprache des Zutrittsberechtigten',
  ...
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  PRIMARY KEY (`id`),
  UNIQUE KEY `person_nachname_zweiter_name_vorname_unique` (`nachname`,`vorname`,`zweiter_vorname`,`namensunterscheidung`) COMMENT 'Fachlicher unique constraint: Eindeutiger Name der Person',
...
) ENGINE=InnoDB AUTO_INCREMENT=732 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lobbyist';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=503 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Anhänge zu Zutrittsberechtigten';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1299 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Anhänge zu Zutrittsberechtigten';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=15694 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lobbyist';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `rat` (
  ...
  `abkuerzung` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kürzel des Rates',
  `abkuerzung_fr` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Französische Abkürzung',
  `name_de` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name auf deutsch',
  `name_fr` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Name auf französisch',
  `name_it` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Name auf italienisch',
  `name_en` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Name auf englisch',
  `anzahl_mitglieder` smallint(6) DEFAULT NULL COMMENT 'Anzahl Mitglieder des Rates',
  `typ` enum('legislativ','exekutiv','judikativ') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Typ des Rates',
  ...
  `beschreibung` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Eine Beschreibung',
  `homepage_de` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Deutschsprachige Homepage',
  `homepage_fr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Franszösichsprache Homepage',
  `homepage_it` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Italienischsprachige Homepage',
  `homepage_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Englischsprachige Homepage',
  `mitglied_bezeichnung_maennlich_de` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Deutsche Bezeichnung der Männer',
  `mitglied_bezeichnung_weiblich_de` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Deutsche Bezeichung der Frauen',
  `mitglied_bezeichnung_maennlich_fr` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Französische Bezeichnung der Männer',
  `mitglied_bezeichnung_weiblich_fr` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Französische Bezeichung der Frauen',
  `parlament_id` int(11) NOT NULL COMMENT 'ID auf ws.parlament.ch',
  `parlament_type` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ratstypecode von ws.parlament.ch',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `eingabe_abgeschlossen_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe abgeschlossen hat.',
  `eingabe_abgeschlossen_datum` timestamp NULL DEFAULT NULL COMMENT 'Die Eingabe ist für den Ersteller der Einträge abgeschlossen und bereit für die Kontrolle. (Leer/NULL bedeutet, dass die Eingabe noch im Gange ist.)',
  `kontrolliert_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Kürzel der Person, welche die Eingabe kontrolliert hat.',
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabelle der Räte von Lobbywatch';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `settings` (
  ...
  `key_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Schlüsselname der Einstellung. NICHT VERÄNDERN. Wird vom Programm vorgegeben',
  `value` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Wert der Einstellung. Dieser Wert ist nach den Bedürfnissen anzupassen.',
  `description` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Hinweise zur Bedeutung dieser Einstellung. Welche Werte sind möglich',
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Einstellungen zur Lobbywatch-DB';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
CREATE TABLE `settings_category` (
  ...
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name der Settingskategorie',
  `description` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Beschreibung der Settingskategorie',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `created_visa` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Datensatz erstellt von',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgeändert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Kategorie für Settings';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Kategorie für Settings';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=655 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Einstellungen zur Lobbywatch-DB';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `snapshot` (
  ...
  `beschreibung` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Beschreibung des Snapshots',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Eintrge am besten mit Datum und Visa versehen.',
  `created_visa` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Erstellt von',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Abgeändert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lobbywatch snapshots';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `translation_source` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Technischer Schlüssel',
  `source` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Eindeutiger Schlüssel',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Context der Übersetzung',
  `textgroup` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT 'Gruppe von Übersetzungen, z.B. für ein Modul (see hook_locale())',
  `location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ort wo der Text vorkommt, DB-Tabelle o. Programmfunktion',
  `field` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Name of the field',
  `version` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Version of Lobbywatch, where the string was last updated (for translation optimization).',
  `created_visa` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Datensatz erstellt von',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgeändert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
...
) ENGINE=InnoDB AUTO_INCREMENT=1889 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Translations for lobbywatch DB';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2471 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Translations for lobbywatch DB';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `translation_target` (
  ...
  `lang` enum('de','fr') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Sprache des Textes',
  `translation` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Übersetzter Text; "-", wenn der lange Text genommen wird.',
...
) ENGINE=InnoDB AUTO_INCREMENT=2384 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Translations for lobbywatch DB';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
CREATE TABLE `user` (
  ...
  `nachname` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nachname des Benutzers',
  `vorname` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Vorname des Benutzers',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'E-Mail-Adresse des Benutzers',
  `token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Internal data for verification and password recovering',
  ...
  `mobile` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mobile Nr zum Passwortsenden über WhatsApp',
  ...
  `farbcode` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'HTML-Farbcode, z.B. red oder #23FF23',
  `notizen` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.',
  `created_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Datensatz erstellt von',
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Erstellt am',
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgeändert von',
...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='PHP Generator users';
SET character_set_client = @saved_cs_client ;
...
CREATE TABLE `user_permission` (
  ...
  `page_name` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `permission_name` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`,`page_name`(255),`permission_name`)
) ENGINE=InnoDB AUTO_INCREMENT=469 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='PHP Generator user permissions';
SET character_set_client = @saved_cs_client ;
...
--
-- Temporary table structure for view `v_interessenbindung_jahr_last`
--

DROP TABLE IF EXISTS `v_interessenbindung_jahr_last`;
DROP VIEW IF EXISTS `v_interessenbindung_jahr_last`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_interessenbindung_jahr_last` AS SELECT 
 1 AS `interessenbindung_id`,
 1 AS `verguetung`,
 1 AS `verguetung_jahr`,
 1 AS `verguetung_beschreibung`;
...
--
-- Temporary table structure for view `v_interessenbindung_jahr_max`
--

DROP TABLE IF EXISTS `v_interessenbindung_jahr_max`;
DROP VIEW IF EXISTS `v_interessenbindung_jahr_max`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_interessenbindung_jahr_max` AS SELECT 
 1 AS `interessenbindung_id`,
 1 AS `verguetung`,
 1 AS `verguetung_jahr`,
 1 AS `verguetung_beschreibung`,
...
--
-- Temporary table structure for view `v_interessenbindung_jahr_raw`
--

DROP TABLE IF EXISTS `v_interessenbindung_jahr_raw`;
DROP VIEW IF EXISTS `v_interessenbindung_jahr_raw`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_interessenbindung_jahr_raw` AS SELECT 
 1 AS `id`,
 1 AS `parlamentarier_id`,
 1 AS `organisation_id`,
 1 AS `art`,
...
CREATE VIEW `v_interessenbindung_liste` AS SELECT 
 ...
 1 AS `interessengruppe1`,
 1 AS `interessengruppe1_fr`,
 1 AS `interessengruppe1_branche`,
 1 AS `interessengruppe1_branche_id`,
...
--
-- Temporary table structure for view `v_last_updated_parlamentarier_transparenz`
--

DROP TABLE IF EXISTS `v_last_updated_parlamentarier_transparenz`;
DROP VIEW IF EXISTS `v_last_updated_parlamentarier_transparenz`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_last_updated_parlamentarier_transparenz` AS SELECT 
 1 AS `table_name`,
 1 AS `name`,
 1 AS `anzahl_eintraege`,
 1 AS `last_visa`,
...
CREATE VIEW `v_organisation` AS SELECT 
 ...
 1 AS `interessengruppe_branche_id`,
 1 AS `interessengruppe_branche_kommission1_id`,
 1 AS `interessengruppe_branche_kommission1_abkuerzung`,
 1 AS `interessengruppe_branche_kommission1_abkuerzung_de`,
 1 AS `interessengruppe_branche_kommission1_abkuerzung_fr`,
 1 AS `interessengruppe_branche_kommission1_name`,
 1 AS `interessengruppe_branche_kommission1_name_de`,
 1 AS `interessengruppe_branche_kommission1_name_fr`,
 1 AS `interessengruppe_branche_kommission2_id`,
 1 AS `interessengruppe_branche_kommission2_abkuerzung`,
 1 AS `interessengruppe_branche_kommission2_abkuerzung_de`,
 1 AS `interessengruppe_branche_kommission2_abkuerzung_fr`,
 1 AS `interessengruppe_branche_kommission2_name`,
 1 AS `interessengruppe_branche_kommission2_name_de`,
 1 AS `interessengruppe_branche_kommission2_name_fr`,
 1 AS `interessengruppe1`,
 1 AS `interessengruppe1_id`,
 1 AS `interessengruppe1_de`,
 1 AS `interessengruppe1_fr`,
 1 AS `interessengruppe1_branche`,
 1 AS `interessengruppe1_branche_de`,
 1 AS `interessengruppe1_branche_fr`,
 1 AS `interessengruppe1_branche_id`,
 1 AS `interessengruppe1_branche_kommission_abkuerzung`,
 1 AS `interessengruppe1_branche_kommission_abkuerzung_de`,
 1 AS `interessengruppe1_branche_kommission_abkuerzung_fr`,
 1 AS `interessengruppe1_branche_kommissionen_abkuerzung`,
 1 AS `interessengruppe1_branche_kommissionen_abkuerzung_de`,
 1 AS `interessengruppe1_branche_kommissionen_abkuerzung_fr`,
 1 AS `interessengruppe1_branche_kommission1_id`,
 1 AS `interessengruppe1_branche_kommission1_abkuerzung`,
 1 AS `interessengruppe1_branche_kommission1_abkuerzung_de`,
 1 AS `interessengruppe1_branche_kommission1_abkuerzung_fr`,
 1 AS `interessengruppe1_branche_kommission1_name`,
 1 AS `interessengruppe1_branche_kommission1_name_de`,
 1 AS `interessengruppe1_branche_kommission1_name_fr`,
 1 AS `interessengruppe1_branche_kommission2_id`,
 1 AS `interessengruppe1_branche_kommission2_abkuerzung`,
 1 AS `interessengruppe1_branche_kommission2_abkuerzung_de`,
 1 AS `interessengruppe1_branche_kommission2_abkuerzung_fr`,
 1 AS `interessengruppe1_branche_kommission2_name`,
 1 AS `interessengruppe1_branche_kommission2_name_de`,
 1 AS `interessengruppe1_branche_kommission2_name_fr`,
 1 AS `interessengruppe2`,
 ...
 1 AS `interessengruppe2_branche_id`,
 1 AS `interessengruppe2_branche_kommission_abkuerzung`,
 1 AS `interessengruppe2_branche_kommission_abkuerzung_de`,
 1 AS `interessengruppe2_branche_kommission_abkuerzung_fr`,
 1 AS `interessengruppe2_branche_kommissionen_abkuerzung`,
 1 AS `interessengruppe2_branche_kommissionen_abkuerzung_de`,
 1 AS `interessengruppe2_branche_kommissionen_abkuerzung_fr`,
 1 AS `interessengruppe2_branche_kommission1_id`,
 1 AS `interessengruppe2_branche_kommission1_abkuerzung`,
 1 AS `interessengruppe2_branche_kommission1_abkuerzung_de`,
 1 AS `interessengruppe2_branche_kommission1_abkuerzung_fr`,
 1 AS `interessengruppe2_branche_kommission1_name`,
 1 AS `interessengruppe2_branche_kommission1_name_de`,
 1 AS `interessengruppe2_branche_kommission1_name_fr`,
 1 AS `interessengruppe2_branche_kommission2_id`,
 1 AS `interessengruppe2_branche_kommission2_abkuerzung`,
 1 AS `interessengruppe2_branche_kommission2_abkuerzung_de`,
 1 AS `interessengruppe2_branche_kommission2_abkuerzung_fr`,
 1 AS `interessengruppe2_branche_kommission2_name`,
 1 AS `interessengruppe2_branche_kommission2_name_de`,
 1 AS `interessengruppe2_branche_kommission2_name_fr`,
 1 AS `interessengruppe3`,
 ...
 1 AS `interessengruppe3_branche_id`,
 1 AS `interessengruppe3_branche_kommission_abkuerzung`,
 1 AS `interessengruppe3_branche_kommission_abkuerzung_de`,
 1 AS `interessengruppe3_branche_kommission_abkuerzung_fr`,
 1 AS `interessengruppe3_branche_kommissionen_abkuerzung`,
 1 AS `interessengruppe3_branche_kommissionen_abkuerzung_de`,
 1 AS `interessengruppe3_branche_kommissionen_abkuerzung_fr`,
 1 AS `interessengruppe3_branche_kommission1_id`,
 1 AS `interessengruppe3_branche_kommission1_abkuerzung`,
 1 AS `interessengruppe3_branche_kommission1_abkuerzung_de`,
 1 AS `interessengruppe3_branche_kommission1_abkuerzung_fr`,
 1 AS `interessengruppe3_branche_kommission1_name`,
 1 AS `interessengruppe3_branche_kommission1_name_de`,
 1 AS `interessengruppe3_branche_kommission1_name_fr`,
 1 AS `interessengruppe3_branche_kommission2_id`,
 1 AS `interessengruppe3_branche_kommission2_abkuerzung`,
 1 AS `interessengruppe3_branche_kommission2_abkuerzung_de`,
 1 AS `interessengruppe3_branche_kommission2_abkuerzung_fr`,
 1 AS `interessengruppe3_branche_kommission2_name`,
 1 AS `interessengruppe3_branche_kommission2_name_de`,
 1 AS `interessengruppe3_branche_kommission2_name_fr`,
 1 AS `refreshed_date`,
 1 AS `land`,
 1 AS `interessenraum`,
...
--
-- Temporary table structure for view `v_organisation_normalized_interessengruppe_raw`
--

DROP TABLE IF EXISTS `v_organisation_normalized_interessengruppe_raw`;
DROP VIEW IF EXISTS `v_organisation_normalized_interessengruppe_raw`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_organisation_normalized_interessengruppe_raw` AS SELECT 
 1 AS `anzeige_name`,
 1 AS `anzeige_mixed`,
 1 AS `anzeige_bimixed`,
 1 AS `searchable_name`,
 ...
 1 AS `vernehmlassung`,
 1 AS `interessengruppe1_id`,
 1 AS `--organisation.interessengruppe2_id`,
 1 AS `--organisation.interessengruppe3_id`,
 1 AS `homepage`,
 1 AS `handelsregister_url`,
 1 AS `twitter_name`,
 1 AS `beschreibung`,
 ...
 1 AS `interessengruppe_branche_fr`,
 1 AS `interessengruppe_branche_id`,
 1 AS `interessengruppe_branche_kommission_abkuerzung`,
 1 AS `interessengruppe_branche_kommission_abkuerzung_de`,
 1 AS `interessengruppe_branche_kommission_abkuerzung_fr`,
 1 AS `interessengruppe_branche_kommissionen_abkuerzung`,
 1 AS `interessengruppe_branche_kommissionen_abkuerzung_de`,
 1 AS `interessengruppe_branche_kommissionen_abkuerzung_fr`,
 1 AS `interessengruppe_branche_kommission1_id`,
 1 AS `interessengruppe_branche_kommission1_abkuerzung`,
 1 AS `interessengruppe_branche_kommission1_abkuerzung_de`,
 1 AS `interessengruppe_branche_kommission1_abkuerzung_fr`,
...
CREATE VIEW `v_parlamentarier` AS SELECT 
 ...
 1 AS `parlament_interessenbindungen_json`,
 ...
 1 AS `titel_fr`,
 1 AS `parlamentarier_id`,
 1 AS `anzahl_interessenbindungen`,
 1 AS `anzahl_hauptberufliche_interessenbindungen`,
 1 AS `anzahl_nicht_hauptberufliche_interessenbindungen`,
 1 AS `anzahl_abgelaufene_interessenbindungen`,
 1 AS `anzahl_interessenbindungen_alle`,
 1 AS `anzahl_erfasste_verguetungen`,
 1 AS `anzahl_erfasste_hauptberufliche_verguetungen`,
 1 AS `anzahl_erfasste_nicht_hauptberufliche_verguetungen`,
 1 AS `verguetungstransparenz_berechnet`,
 1 AS `verguetungstransparenz_berechnet_nicht_beruflich`,
 1 AS `verguetungstransparenz_berechnet_alle`,
 1 AS `verguetungstransparenz_beurteilung_stichdatum`,
 1 AS `verguetungstransparenz_beurteilung`,
 1 AS `refreshed_date`,
 1 AS `anzahl_interessenbindung_tief`,
 1 AS `anzahl_interessenbindung_mittel`,
 1 AS `anzahl_interessenbindung_hoch`,
...
--
-- Temporary table structure for view `v_parlamentarier_transparenz`
--

DROP TABLE IF EXISTS `v_parlamentarier_transparenz`;
DROP VIEW IF EXISTS `v_parlamentarier_transparenz`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_parlamentarier_transparenz` AS SELECT 
 1 AS `id`,
 1 AS `parlamentarier_id`,
 1 AS `stichdatum`,
 1 AS `verguetung_transparent`,
 1 AS `notizen`,
 1 AS `eingabe_abgeschlossen_visa`,
 1 AS `eingabe_abgeschlossen_datum`,
 1 AS `kontrolliert_visa`,
...
--
-- Temporary table structure for view `v_parlamentarier_transparenz_calculated`
--

DROP TABLE IF EXISTS `v_parlamentarier_transparenz_calculated`;
DROP VIEW IF EXISTS `v_parlamentarier_transparenz_calculated`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_parlamentarier_transparenz_calculated` AS SELECT 
 1 AS `parlamentarier_id`,
 1 AS `anzahl_interessenbindungen`,
 1 AS `anzahl_hauptberufliche_interessenbindungen`,
 1 AS `anzahl_nicht_hauptberufliche_interessenbindungen`,
...
--
-- Temporary table structure for view `v_parlamentarier_transparenz_last_all`
--

DROP TABLE IF EXISTS `v_parlamentarier_transparenz_last_all`;
DROP VIEW IF EXISTS `v_parlamentarier_transparenz_last_all`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_parlamentarier_transparenz_last_all` AS SELECT 
 1 AS `max_stichdatum`,
 1 AS `id`,
 1 AS `parlamentarier_id`,
 1 AS `stichdatum`,
...
--
-- Temporary table structure for view `v_parlamentarier_transparenz_last_published`
--

DROP TABLE IF EXISTS `v_parlamentarier_transparenz_last_published`;
DROP VIEW IF EXISTS `v_parlamentarier_transparenz_last_published`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_parlamentarier_transparenz_last_published` AS SELECT 
 1 AS `max_stichdatum`,
 1 AS `id`,
 1 AS `parlamentarier_id`,
 1 AS `stichdatum`,
...
--
-- Temporary table structure for view `v_parlamentarier_transparenz_last_stichdatum_all`
--

DROP TABLE IF EXISTS `v_parlamentarier_transparenz_last_stichdatum_all`;
DROP VIEW IF EXISTS `v_parlamentarier_transparenz_last_stichdatum_all`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_parlamentarier_transparenz_last_stichdatum_all` AS SELECT 
 1 AS `id`,
 1 AS `parlamentarier_id`,
 1 AS `stichdatum`,
 1 AS `verguetung_transparent`,
...
--
-- Temporary table structure for view `v_parlamentarier_transparenz_last_stichdatum_published`
--

DROP TABLE IF EXISTS `v_parlamentarier_transparenz_last_stichdatum_published`;
DROP VIEW IF EXISTS `v_parlamentarier_transparenz_last_stichdatum_published`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE VIEW `v_parlamentarier_transparenz_last_stichdatum_published` AS SELECT 
 1 AS `id`,
 1 AS `parlamentarier_id`,
 1 AS `stichdatum`,
 1 AS `verguetung_transparent`,
...
CREATE TABLE `zutrittsberechtigung` (
  ...
  `parlamentarier_id` int(11) NOT NULL COMMENT 'Fremdschlüssel Parlamentarier',
  `person_id` int(11) NOT NULL COMMENT 'Fremdschlüssel zur zutrittsberechtigten Person',
  `parlamentarier_kommissionen` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abkürzungen der Kommissionen des zugehörigen Parlamentariers (automatisch erzeugt [in_Kommission/zutrittsberechtigung Trigger])',
  `funktion` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Funktion der zutrittsberechtigen Person.',
  `funktion_fr` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Funktion der zutrittsberechtigen Person auf französisch.',
  `von` date DEFAULT NULL COMMENT 'Beginn der Zutrittsberechtigung, leer (NULL) = unbekannt',
  `bis` date DEFAULT NULL COMMENT 'Ende der Zutrittsberechtigung, leer (NULL) = aktuell gültig, nicht leer = historischer Eintrag',
...
) ENGINE=InnoDB AUTO_INCREMENT=947 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Dauerhafter Badge für einen Gast ("Götti")';
SET character_set_client = @saved_cs_client ;
SET @saved_cs_client      = @@character_set_client  ;
SET @saved_cs_results     = @@character_set_results  ;
SET @saved_col_connection = @@collation_connection  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=5781 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Dauerhafter Badge für einen Gast ("Götti")';
SET character_set_client = @saved_cs_client ;
...
VIEW `v_branche_simple` AS select concat(`branche`.`name`) AS `anzeige_name`,concat(`branche`.`name`) AS `anzeige_name_de`,concat(`branche`.`name_fr`) AS `anzeige_name_fr`,concat_ws(' / ',`branche`.`name`,`branche`.`name_fr`) AS `anzeige_name_mixed`,`branche`.`id` AS `id`,`branche`.`name` AS `name`,`branche`.`name_fr` AS `name_fr`,`branche`.`kommission_id` AS `kommission_id`,`branche`.`kommission2_id` AS `kommission2_id`,`branche`.`technischer_name` AS `technischer_name`,`branche`.`beschreibung` AS `beschreibung`,`branche`.`beschreibung_fr` AS `beschreibung_fr`,`branche`.`angaben` AS `angaben`,`branche`.`angaben_fr` AS `angaben_fr`,`branche`.`farbcode` AS `farbcode`,`branche`.`symbol_abs` AS `symbol_abs`,`branche`.`symbol_rel` AS `symbol_rel`,`branche`.`symbol_klein_rel` AS `symbol_klein_rel`,`branche`.`symbol_dateiname_wo_ext` AS `symbol_dateiname_wo_ext`,`branche`.`symbol_dateierweiterung` AS `symbol_dateierweiterung`,`branche`.`symbol_dateiname` AS `symbol_dateiname`,`branche`.`symbol_mime_type` AS `symbol_mime_type`,`branche`.`notizen` AS `notizen`,`branche`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`branche`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`branche`.`kontrolliert_visa` AS `kontrolliert_visa`,`branche`.`kontrolliert_datum` AS `kontrolliert_datum`,`branche`.`freigabe_visa` AS `freigabe_visa`,`branche`.`freigabe_datum` AS `freigabe_datum`,`branche`.`created_visa` AS `created_visa`,`branche`.`created_date` AS `created_date`,`branche`.`updated_visa` AS `updated_visa`,`branche`.`updated_date` AS `updated_date`,`branche`.`name` AS `name_de`,`branche`.`beschreibung` AS `beschreibung_de`,`branche`.`angaben` AS `angaben_de`,ifnull((`branche`.`freigabe_datum` <= now()),FALSE) AS `published`,unix_timestamp(`branche`.`created_date`) AS `created_date_unix`,unix_timestamp(`branche`.`updated_date`) AS `updated_date_unix`,unix_timestamp(`branche`.`eingabe_abgeschlossen_datum`) AS `eingabe_abgeschlossen_datum_unix`,unix_timestamp(`branche`.`kontrolliert_datum`) AS `kontrolliert_datum_unix`,unix_timestamp(`branche`.`freigabe_datum`) AS `freigabe_datum_unix` from `branche` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_in_kommission_simple` AS select `in_kommission`.`id` AS `id`,`in_kommission`.`parlamentarier_id` AS `parlamentarier_id`,`in_kommission`.`kommission_id` AS `kommission_id`,`in_kommission`.`funktion` AS `funktion`,`in_kommission`.`parlament_committee_function` AS `parlament_committee_function`,`in_kommission`.`parlament_committee_function_name` AS `parlament_committee_function_name`,`in_kommission`.`von` AS `von`,`in_kommission`.`bis` AS `bis`,`in_kommission`.`notizen` AS `notizen`,`in_kommission`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`in_kommission`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`in_kommission`.`kontrolliert_visa` AS `kontrolliert_visa`,`in_kommission`.`kontrolliert_datum` AS `kontrolliert_datum`,`in_kommission`.`freigabe_visa` AS `freigabe_visa`,`in_kommission`.`freigabe_datum` AS `freigabe_datum`,`in_kommission`.`created_visa` AS `created_visa`,`in_kommission`.`created_date` AS `created_date`,`in_kommission`.`updated_visa` AS `updated_visa`,`in_kommission`.`updated_date` AS `updated_date`,((isnull(`in_kommission`.`von`) or (`in_kommission`.`von` <= now())) and (isnull(`in_kommission`.`bis`) or (`in_kommission`.`bis` > now()))) AS `aktiv`,ifnull((`in_kommission`.`freigabe_datum` <= now()),FALSE) AS `published`,unix_timestamp(`in_kommission`.`bis`) AS `bis_unix`,unix_timestamp(`in_kommission`.`von`) AS `von_unix`,unix_timestamp(`in_kommission`.`created_date`) AS `created_date_unix`,unix_timestamp(`in_kommission`.`updated_date`) AS `updated_date_unix`,unix_timestamp(`in_kommission`.`eingabe_abgeschlossen_datum`) AS `eingabe_abgeschlossen_datum_unix`,unix_timestamp(`in_kommission`.`kontrolliert_datum`) AS `kontrolliert_datum_unix`,unix_timestamp(`in_kommission`.`freigabe_datum`) AS `freigabe_datum_unix` from `in_kommission` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_interessenbindung_jahr_last` AS select `interessenbindung_jahr`.`interessenbindung_id` AS `interessenbindung_id`,`interessenbindung_jahr`.`verguetung` AS `verguetung`,`interessenbindung_jahr`.`jahr` AS `verguetung_jahr`,`interessenbindung_jahr`.`beschreibung` AS `verguetung_beschreibung` from (`v_interessenbindung_simple` `interessenbindung` left join `v_interessenbindung_jahr` `interessenbindung_jahr` on((`interessenbindung_jahr`.`id` = (select `ijn`.`id` from `v_interessenbindung_jahr` `ijn` where ((`ijn`.`interessenbindung_id` = `interessenbindung`.`id`) and (`ijn`.`freigabe_datum` <= now())) order by `ijn`.`jahr` desc limit 1)))) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_interessenbindung_jahr_max`
--
...
--
-- Final view structure for view `v_interessenbindung_jahr_raw`
--
...
VIEW `v_interessenbindung_simple` AS select `interessenbindung`.`id` AS `id`,`interessenbindung`.`parlamentarier_id` AS `parlamentarier_id`,`interessenbindung`.`organisation_id` AS `organisation_id`,`interessenbindung`.`art` AS `art`,`interessenbindung`.`funktion_im_gremium` AS `funktion_im_gremium`,`interessenbindung`.`deklarationstyp` AS `deklarationstyp`,`interessenbindung`.`status` AS `status`,`interessenbindung`.`hauptberuflich` AS `hauptberuflich`,`interessenbindung`.`behoerden_vertreter` AS `behoerden_vertreter`,`interessenbindung`.`beschreibung` AS `beschreibung`,`interessenbindung`.`beschreibung_fr` AS `beschreibung_fr`,`interessenbindung`.`quelle_url` AS `quelle_url`,`interessenbindung`.`quelle_url_gueltig` AS `quelle_url_gueltig`,`interessenbindung`.`quelle` AS `quelle`,`interessenbindung`.`von` AS `von`,`interessenbindung`.`bis` AS `bis`,`interessenbindung`.`notizen` AS `notizen`,`interessenbindung`.`updated_by_import` AS `updated_by_import`,`interessenbindung`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`interessenbindung`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`interessenbindung`.`kontrolliert_visa` AS `kontrolliert_visa`,`interessenbindung`.`kontrolliert_datum` AS `kontrolliert_datum`,`interessenbindung`.`autorisiert_visa` AS `autorisiert_visa`,`interessenbindung`.`autorisiert_datum` AS `autorisiert_datum`,`interessenbindung`.`freigabe_visa` AS `freigabe_visa`,`interessenbindung`.`freigabe_datum` AS `freigabe_datum`,`interessenbindung`.`created_visa` AS `created_visa`,`interessenbindung`.`created_date` AS `created_date`,`interessenbindung`.`updated_visa` AS `updated_visa`,`interessenbindung`.`updated_date` AS `updated_date`,((isnull(`interessenbindung`.`von`) or (`interessenbindung`.`von` <= now())) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now()))) AS `aktiv`,ifnull((`interessenbindung`.`freigabe_datum` <= now()),FALSE) AS `published`,unix_timestamp(`interessenbindung`.`bis`) AS `bis_unix`,unix_timestamp(`interessenbindung`.`von`) AS `von_unix`,unix_timestamp(`interessenbindung`.`created_date`) AS `created_date_unix`,unix_timestamp(`interessenbindung`.`updated_date`) AS `updated_date_unix`,unix_timestamp(`interessenbindung`.`eingabe_abgeschlossen_datum`) AS `eingabe_abgeschlossen_datum_unix`,unix_timestamp(`interessenbindung`.`kontrolliert_datum`) AS `kontrolliert_datum_unix`,unix_timestamp(`interessenbindung`.`freigabe_datum`) AS `freigabe_datum_unix` from `interessenbindung` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_kanton_jahr_last` AS select `kanton_jahr`.`jahr` AS `max_jahr`,`kanton_jahr`.`id` AS `id`,`kanton_jahr`.`kanton_id` AS `kanton_id`,`kanton_jahr`.`jahr` AS `jahr`,`kanton_jahr`.`anzahl_nationalraete` AS `anzahl_nationalraete`,`kanton_jahr`.`einwohner` AS `einwohner`,`kanton_jahr`.`auslaenderanteil` AS `auslaenderanteil`,`kanton_jahr`.`bevoelkerungsdichte` AS `bevoelkerungsdichte`,`kanton_jahr`.`anzahl_gemeinden` AS `anzahl_gemeinden`,`kanton_jahr`.`steuereinnahmen` AS `steuereinnahmen`,`kanton_jahr`.`ausgaben` AS `ausgaben`,`kanton_jahr`.`finanzausgleich` AS `finanzausgleich`,`kanton_jahr`.`schulden` AS `schulden`,`kanton_jahr`.`notizen` AS `notizen`,`kanton_jahr`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`kanton_jahr`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`kanton_jahr`.`kontrolliert_visa` AS `kontrolliert_visa`,`kanton_jahr`.`kontrolliert_datum` AS `kontrolliert_datum`,`kanton_jahr`.`freigabe_visa` AS `freigabe_visa`,`kanton_jahr`.`freigabe_datum` AS `freigabe_datum`,`kanton_jahr`.`created_visa` AS `created_visa`,`kanton_jahr`.`created_date` AS `created_date`,`kanton_jahr`.`updated_visa` AS `updated_visa`,`kanton_jahr`.`updated_date` AS `updated_date` from `kanton_jahr` where (`kanton_jahr`.`jahr` = (select max(`max_kj`.`jahr`) from `kanton_jahr` `max_kj` where (`max_kj`.`kanton_id` = `kanton_jahr`.`kanton_id`))) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_kanton_simple` AS select `kanton`.`name_de` AS `anzeige_name`,`kanton`.`name_de` AS `anzeige_name_de`,`kanton`.`name_fr` AS `anzeige_name_fr`,concat_ws(' / ',`kanton`.`name_de`,`kanton`.`name_fr`) AS `anzeige_name_mixed`,`kanton`.`id` AS `id`,`kanton`.`abkuerzung` AS `abkuerzung`,`kanton`.`kantonsnr` AS `kantonsnr`,`kanton`.`name_de` AS `name_de`,`kanton`.`name_fr` AS `name_fr`,`kanton`.`name_it` AS `name_it`,`kanton`.`romandie` AS `romandie`,`kanton`.`anzahl_staenderaete` AS `anzahl_staenderaete`,`kanton`.`amtssprache` AS `amtssprache`,`kanton`.`hauptort_de` AS `hauptort_de`,`kanton`.`hauptort_fr` AS `hauptort_fr`,`kanton`.`hauptort_it` AS `hauptort_it`,`kanton`.`flaeche_km2` AS `flaeche_km2`,`kanton`.`beitrittsjahr` AS `beitrittsjahr`,`kanton`.`wappen_svg` AS `wappen_svg`,`kanton`.`wappen_svg_pfad` AS `wappen_svg_pfad`,`kanton`.`wappen_klein` AS `wappen_klein`,`kanton`.`wappen` AS `wappen`,`kanton`.`lagebild` AS `lagebild`,`kanton`.`homepage` AS `homepage`,`kanton`.`beschreibung` AS `beschreibung`,`kanton`.`notizen` AS `notizen`,`kanton`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`kanton`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`kanton`.`kontrolliert_visa` AS `kontrolliert_visa`,`kanton`.`kontrolliert_datum` AS `kontrolliert_datum`,`kanton`.`freigabe_visa` AS `freigabe_visa`,`kanton`.`freigabe_datum` AS `freigabe_datum`,`kanton`.`created_visa` AS `created_visa`,`kanton`.`created_date` AS `created_date`,`kanton`.`updated_visa` AS `updated_visa`,`kanton`.`updated_date` AS `updated_date` from `kanton` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
--
-- Final view structure for view `v_last_updated_parlamentarier_transparenz`
--
...
VIEW `v_last_updated_parlamentarier_transparenz` AS (select 'parlamentarier_transparenz' AS `table_name`,'Parlamentariertransparenz' AS `name`,(select count(0) from `parlamentarier_transparenz`) AS `anzahl_eintraege`,`t`.`updated_visa` AS `last_visa`,`t`.`updated_date` AS `last_updated`,`t`.`id` AS `last_updated_id` from `parlamentarier_transparenz` `t` order by `t`.`updated_date` desc limit 1) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_mandat_simple` AS select `mandat`.`id` AS `id`,`mandat`.`person_id` AS `person_id`,`mandat`.`organisation_id` AS `organisation_id`,`mandat`.`art` AS `art`,`mandat`.`funktion_im_gremium` AS `funktion_im_gremium`,`mandat`.`hauptberuflich` AS `hauptberuflich`,`mandat`.`beschreibung` AS `beschreibung`,`mandat`.`beschreibung_fr` AS `beschreibung_fr`,`mandat`.`quelle_url` AS `quelle_url`,`mandat`.`quelle_url_gueltig` AS `quelle_url_gueltig`,`mandat`.`quelle` AS `quelle`,`mandat`.`von` AS `von`,`mandat`.`bis` AS `bis`,`mandat`.`notizen` AS `notizen`,`mandat`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`mandat`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`mandat`.`kontrolliert_visa` AS `kontrolliert_visa`,`mandat`.`kontrolliert_datum` AS `kontrolliert_datum`,`mandat`.`autorisiert_visa` AS `autorisiert_visa`,`mandat`.`autorisiert_datum` AS `autorisiert_datum`,`mandat`.`freigabe_visa` AS `freigabe_visa`,`mandat`.`freigabe_datum` AS `freigabe_datum`,`mandat`.`created_visa` AS `created_visa`,`mandat`.`created_date` AS `created_date`,`mandat`.`updated_visa` AS `updated_visa`,`mandat`.`updated_date` AS `updated_date`,((isnull(`mandat`.`von`) or (`mandat`.`von` <= now())) and (isnull(`mandat`.`bis`) or (`mandat`.`bis` > now()))) AS `aktiv`,ifnull((`mandat`.`freigabe_datum` <= now()),FALSE) AS `published`,unix_timestamp(`mandat`.`bis`) AS `bis_unix`,unix_timestamp(`mandat`.`von`) AS `von_unix`,unix_timestamp(`mandat`.`created_date`) AS `created_date_unix`,unix_timestamp(`mandat`.`updated_date`) AS `updated_date_unix`,unix_timestamp(`mandat`.`eingabe_abgeschlossen_datum`) AS `eingabe_abgeschlossen_datum_unix`,unix_timestamp(`mandat`.`kontrolliert_datum`) AS `kontrolliert_datum_unix`,unix_timestamp(`mandat`.`freigabe_datum`) AS `freigabe_datum_unix` from `mandat` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_organisation` AS select `mv_organisation`.`anzeige_name` AS `anzeige_name`,`mv_organisation`.`anzeige_mixed` AS `anzeige_mixed`,`mv_organisation`.`anzeige_bimixed` AS `anzeige_bimixed`,`mv_organisation`.`searchable_name` AS `searchable_name`,`mv_organisation`.`anzeige_name_de` AS `anzeige_name_de`,`mv_organisation`.`anzeige_name_fr` AS `anzeige_name_fr`,`mv_organisation`.`name` AS `name`,`mv_organisation`.`id` AS `id`,`mv_organisation`.`name_de` AS `name_de`,`mv_organisation`.`name_fr` AS `name_fr`,`mv_organisation`.`name_it` AS `name_it`,`mv_organisation`.`uid` AS `uid`,`mv_organisation`.`ort` AS `ort`,`mv_organisation`.`abkuerzung_de` AS `abkuerzung_de`,`mv_organisation`.`alias_namen_de` AS `alias_namen_de`,`mv_organisation`.`abkuerzung_fr` AS `abkuerzung_fr`,`mv_organisation`.`alias_namen_fr` AS `alias_namen_fr`,`mv_organisation`.`abkuerzung_it` AS `abkuerzung_it`,`mv_organisation`.`alias_namen_it` AS `alias_namen_it`,`mv_organisation`.`land_id` AS `land_id`,`mv_organisation`.`interessenraum_id` AS `interessenraum_id`,`mv_organisation`.`rechtsform` AS `rechtsform`,`mv_organisation`.`rechtsform_handelsregister` AS `rechtsform_handelsregister`,`mv_organisation`.`rechtsform_zefix` AS `rechtsform_zefix`,`mv_organisation`.`typ` AS `typ`,`mv_organisation`.`vernehmlassung` AS `vernehmlassung`,`mv_organisation`.`interessengruppe_id` AS `interessengruppe_id`,`mv_organisation`.`interessengruppe2_id` AS `interessengruppe2_id`,`mv_organisation`.`interessengruppe3_id` AS `interessengruppe3_id`,`mv_organisation`.`ALT_branche_id` AS `ALT_branche_id`,`mv_organisation`.`homepage` AS `homepage`,`mv_organisation`.`handelsregister_url` AS `handelsregister_url`,`mv_organisation`.`twitter_name` AS `twitter_name`,`mv_organisation`.`beschreibung` AS `beschreibung`,`mv_organisation`.`beschreibung_fr` AS `beschreibung_fr`,`mv_organisation`.`sekretariat` AS `sekretariat`,`mv_organisation`.`adresse_strasse` AS `adresse_strasse`,`mv_organisation`.`adresse_zusatz` AS `adresse_zusatz`,`mv_organisation`.`adresse_plz` AS `adresse_plz`,`mv_organisation`.`notizen` AS `notizen`,`mv_organisation`.`updated_by_import` AS `updated_by_import`,`mv_organisation`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`mv_organisation`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`mv_organisation`.`kontrolliert_visa` AS `kontrolliert_visa`,`mv_organisation`.`kontrolliert_datum` AS `kontrolliert_datum`,`mv_organisation`.`freigabe_visa` AS `freigabe_visa`,`mv_organisation`.`freigabe_datum` AS `freigabe_datum`,`mv_organisation`.`created_visa` AS `created_visa`,`mv_organisation`.`created_date` AS `created_date`,`mv_organisation`.`updated_visa` AS `updated_visa`,`mv_organisation`.`updated_date` AS `updated_date`,`mv_organisation`.`published` AS `published`,`mv_organisation`.`created_date_unix` AS `created_date_unix`,`mv_organisation`.`updated_date_unix` AS `updated_date_unix`,`mv_organisation`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`mv_organisation`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`mv_organisation`.`freigabe_datum_unix` AS `freigabe_datum_unix`,`mv_organisation`.`branche_ALT` AS `branche_ALT`,`mv_organisation`.`branche_de_ALT` AS `branche_de_ALT`,`mv_organisation`.`branche_fr_ALT` AS `branche_fr_ALT`,`mv_organisation`.`interessengruppe` AS `interessengruppe`,`mv_organisation`.`interessengruppe_de` AS `interessengruppe_de`,`mv_organisation`.`interessengruppe_fr` AS `interessengruppe_fr`,`mv_organisation`.`interessengruppe_branche` AS `interessengruppe_branche`,`mv_organisation`.`interessengruppe_branche_de` AS `interessengruppe_branche_de`,`mv_organisation`.`interessengruppe_branche_fr` AS `interessengruppe_branche_fr`,`mv_organisation`.`interessengruppe_branche_id` AS `interessengruppe_branche_id`,`mv_organisation`.`interessengruppe_branche_kommission1_id` AS `interessengruppe_branche_kommission1_id`,`mv_organisation`.`interessengruppe_branche_kommission1_abkuerzung` AS `interessengruppe_branche_kommission1_abkuerzung`,`mv_organisation`.`interessengruppe_branche_kommission1_abkuerzung_de` AS `interessengruppe_branche_kommission1_abkuerzung_de`,`mv_organisation`.`interessengruppe_branche_kommission1_abkuerzung_fr` AS `interessengruppe_branche_kommission1_abkuerzung_fr`,`mv_organisation`.`interessengruppe_branche_kommission1_name` AS `interessengruppe_branche_kommission1_name`,`mv_organisation`.`interessengruppe_branche_kommission1_name_de` AS `interessengruppe_branche_kommission1_name_de`,`mv_organisation`.`interessengruppe_branche_kommission1_name_fr` AS `interessengruppe_branche_kommission1_name_fr`,`mv_organisation`.`interessengruppe_branche_kommission2_id` AS `interessengruppe_branche_kommission2_id`,`mv_organisation`.`interessengruppe_branche_kommission2_abkuerzung` AS `interessengruppe_branche_kommission2_abkuerzung`,`mv_organisation`.`interessengruppe_branche_kommission2_abkuerzung_de` AS `interessengruppe_branche_kommission2_abkuerzung_de`,`mv_organisation`.`interessengruppe_branche_kommission2_abkuerzung_fr` AS `interessengruppe_branche_kommission2_abkuerzung_fr`,`mv_organisation`.`interessengruppe_branche_kommission2_name` AS `interessengruppe_branche_kommission2_name`,`mv_organisation`.`interessengruppe_branche_kommission2_name_de` AS `interessengruppe_branche_kommission2_name_de`,`mv_organisation`.`interessengruppe_branche_kommission2_name_fr` AS `interessengruppe_branche_kommission2_name_fr`,`mv_organisation`.`interessengruppe1` AS `interessengruppe1`,`mv_organisation`.`interessengruppe1_id` AS `interessengruppe1_id`,`mv_organisation`.`interessengruppe1_de` AS `interessengruppe1_de`,`mv_organisation`.`interessengruppe1_fr` AS `interessengruppe1_fr`,`mv_organisation`.`interessengruppe1_branche` AS `interessengruppe1_branche`,`mv_organisation`.`interessengruppe1_branche_de` AS `interessengruppe1_branche_de`,`mv_organisation`.`interessengruppe1_branche_fr` AS `interessengruppe1_branche_fr`,`mv_organisation`.`interessengruppe1_branche_id` AS `interessengruppe1_branche_id`,`mv_organisation`.`interessengruppe1_branche_kommission_abkuerzung` AS `interessengruppe1_branche_kommission_abkuerzung`,`mv_organisation`.`interessengruppe1_branche_kommission_abkuerzung_de` AS `interessengruppe1_branche_kommission_abkuerzung_de`,`mv_organisation`.`interessengruppe1_branche_kommission_abkuerzung_fr` AS `interessengruppe1_branche_kommission_abkuerzung_fr`,`mv_organisation`.`interessengruppe1_branche_kommissionen_abkuerzung` AS `interessengruppe1_branche_kommissionen_abkuerzung`,`mv_organisation`.`interessengruppe1_branche_kommissionen_abkuerzung_de` AS `interessengruppe1_branche_kommissionen_abkuerzung_de`,`mv_organisation`.`interessengruppe1_branche_kommissionen_abkuerzung_fr` AS `interessengruppe1_branche_kommissionen_abkuerzung_fr`,`mv_organisation`.`interessengruppe1_branche_kommission1_id` AS `interessengruppe1_branche_kommission1_id`,`mv_organisation`.`interessengruppe1_branche_kommission1_abkuerzung` AS `interessengruppe1_branche_kommission1_abkuerzung`,`mv_organisation`.`interessengruppe1_branche_kommission1_abkuerzung_de` AS `interessengruppe1_branche_kommission1_abkuerzung_de`,`mv_organisation`.`interessengruppe1_branche_kommission1_abkuerzung_fr` AS `interessengruppe1_branche_kommission1_abkuerzung_fr`,`mv_organisation`.`interessengruppe1_branche_kommission1_name` AS `interessengruppe1_branche_kommission1_name`,`mv_organisation`.`interessengruppe1_branche_kommission1_name_de` AS `interessengruppe1_branche_kommission1_name_de`,`mv_organisation`.`interessengruppe1_branche_kommission1_name_fr` AS `interessengruppe1_branche_kommission1_name_fr`,`mv_organisation`.`interessengruppe1_branche_kommission2_id` AS `interessengruppe1_branche_kommission2_id`,`mv_organisation`.`interessengruppe1_branche_kommission2_abkuerzung` AS `interessengruppe1_branche_kommission2_abkuerzung`,`mv_organisation`.`interessengruppe1_branche_kommission2_abkuerzung_de` AS `interessengruppe1_branche_kommission2_abkuerzung_de`,`mv_organisation`.`interessengruppe1_branche_kommission2_abkuerzung_fr` AS `interessengruppe1_branche_kommission2_abkuerzung_fr`,`mv_organisation`.`interessengruppe1_branche_kommission2_name` AS `interessengruppe1_branche_kommission2_name`,`mv_organisation`.`interessengruppe1_branche_kommission2_name_de` AS `interessengruppe1_branche_kommission2_name_de`,`mv_organisation`.`interessengruppe1_branche_kommission2_name_fr` AS `interessengruppe1_branche_kommission2_name_fr`,`mv_organisation`.`interessengruppe2` AS `interessengruppe2`,`mv_organisation`.`interessengruppe2_de` AS `interessengruppe2_de`,`mv_organisation`.`interessengruppe2_fr` AS `interessengruppe2_fr`,`mv_organisation`.`interessengruppe2_branche` AS `interessengruppe2_branche`,`mv_organisation`.`interessengruppe2_branche_de` AS `interessengruppe2_branche_de`,`mv_organisation`.`interessengruppe2_branche_fr` AS `interessengruppe2_branche_fr`,`mv_organisation`.`interessengruppe2_branche_id` AS `interessengruppe2_branche_id`,`mv_organisation`.`interessengruppe2_branche_kommission_abkuerzung` AS `interessengruppe2_branche_kommission_abkuerzung`,`mv_organisation`.`interessengruppe2_branche_kommission_abkuerzung_de` AS `interessengruppe2_branche_kommission_abkuerzung_de`,`mv_organisation`.`interessengruppe2_branche_kommission_abkuerzung_fr` AS `interessengruppe2_branche_kommission_abkuerzung_fr`,`mv_organisation`.`interessengruppe2_branche_kommissionen_abkuerzung` AS `interessengruppe2_branche_kommissionen_abkuerzung`,`mv_organisation`.`interessengruppe2_branche_kommissionen_abkuerzung_de` AS `interessengruppe2_branche_kommissionen_abkuerzung_de`,`mv_organisation`.`interessengruppe2_branche_kommissionen_abkuerzung_fr` AS `interessengruppe2_branche_kommissionen_abkuerzung_fr`,`mv_organisation`.`interessengruppe2_branche_kommission1_id` AS `interessengruppe2_branche_kommission1_id`,`mv_organisation`.`interessengruppe2_branche_kommission1_abkuerzung` AS `interessengruppe2_branche_kommission1_abkuerzung`,`mv_organisation`.`interessengruppe2_branche_kommission1_abkuerzung_de` AS `interessengruppe2_branche_kommission1_abkuerzung_de`,`mv_organisation`.`interessengruppe2_branche_kommission1_abkuerzung_fr` AS `interessengruppe2_branche_kommission1_abkuerzung_fr`,`mv_organisation`.`interessengruppe2_branche_kommission1_name` AS `interessengruppe2_branche_kommission1_name`,`mv_organisation`.`interessengruppe2_branche_kommission1_name_de` AS `interessengruppe2_branche_kommission1_name_de`,`mv_organisation`.`interessengruppe2_branche_kommission1_name_fr` AS `interessengruppe2_branche_kommission1_name_fr`,`mv_organisation`.`interessengruppe2_branche_kommission2_id` AS `interessengruppe2_branche_kommission2_id`,`mv_organisation`.`interessengruppe2_branche_kommission2_abkuerzung` AS `interessengruppe2_branche_kommission2_abkuerzung`,`mv_organisation`.`interessengruppe2_branche_kommission2_abkuerzung_de` AS `interessengruppe2_branche_kommission2_abkuerzung_de`,`mv_organisation`.`interessengruppe2_branche_kommission2_abkuerzung_fr` AS `interessengruppe2_branche_kommission2_abkuerzung_fr`,`mv_organisation`.`interessengruppe2_branche_kommission2_name` AS `interessengruppe2_branche_kommission2_name`,`mv_organisation`.`interessengruppe2_branche_kommission2_name_de` AS `interessengruppe2_branche_kommission2_name_de`,`mv_organisation`.`interessengruppe2_branche_kommission2_name_fr` AS `interessengruppe2_branche_kommission2_name_fr`,`mv_organisation`.`interessengruppe3` AS `interessengruppe3`,`mv_organisation`.`interessengruppe3_de` AS `interessengruppe3_de`,`mv_organisation`.`interessengruppe3_fr` AS `interessengruppe3_fr`,`mv_organisation`.`interessengruppe3_branche` AS `interessengruppe3_branche`,`mv_organisation`.`interessengruppe3_branche_de` AS `interessengruppe3_branche_de`,`mv_organisation`.`interessengruppe3_branche_fr` AS `interessengruppe3_branche_fr`,`mv_organisation`.`interessengruppe3_branche_id` AS `interessengruppe3_branche_id`,`mv_organisation`.`interessengruppe3_branche_kommission_abkuerzung` AS `interessengruppe3_branche_kommission_abkuerzung`,`mv_organisation`.`interessengruppe3_branche_kommission_abkuerzung_de` AS `interessengruppe3_branche_kommission_abkuerzung_de`,`mv_organisation`.`interessengruppe3_branche_kommission_abkuerzung_fr` AS `interessengruppe3_branche_kommission_abkuerzung_fr`,`mv_organisation`.`interessengruppe3_branche_kommissionen_abkuerzung` AS `interessengruppe3_branche_kommissionen_abkuerzung`,`mv_organisation`.`interessengruppe3_branche_kommissionen_abkuerzung_de` AS `interessengruppe3_branche_kommissionen_abkuerzung_de`,`mv_organisation`.`interessengruppe3_branche_kommissionen_abkuerzung_fr` AS `interessengruppe3_branche_kommissionen_abkuerzung_fr`,`mv_organisation`.`interessengruppe3_branche_kommission1_id` AS `interessengruppe3_branche_kommission1_id`,`mv_organisation`.`interessengruppe3_branche_kommission1_abkuerzung` AS `interessengruppe3_branche_kommission1_abkuerzung`,`mv_organisation`.`interessengruppe3_branche_kommission1_abkuerzung_de` AS `interessengruppe3_branche_kommission1_abkuerzung_de`,`mv_organisation`.`interessengruppe3_branche_kommission1_abkuerzung_fr` AS `interessengruppe3_branche_kommission1_abkuerzung_fr`,`mv_organisation`.`interessengruppe3_branche_kommission1_name` AS `interessengruppe3_branche_kommission1_name`,`mv_organisation`.`interessengruppe3_branche_kommission1_name_de` AS `interessengruppe3_branche_kommission1_name_de`,`mv_organisation`.`interessengruppe3_branche_kommission1_name_fr` AS `interessengruppe3_branche_kommission1_name_fr`,`mv_organisation`.`interessengruppe3_branche_kommission2_id` AS `interessengruppe3_branche_kommission2_id`,`mv_organisation`.`interessengruppe3_branche_kommission2_abkuerzung` AS `interessengruppe3_branche_kommission2_abkuerzung`,`mv_organisation`.`interessengruppe3_branche_kommission2_abkuerzung_de` AS `interessengruppe3_branche_kommission2_abkuerzung_de`,`mv_organisation`.`interessengruppe3_branche_kommission2_abkuerzung_fr` AS `interessengruppe3_branche_kommission2_abkuerzung_fr`,`mv_organisation`.`interessengruppe3_branche_kommission2_name` AS `interessengruppe3_branche_kommission2_name`,`mv_organisation`.`interessengruppe3_branche_kommission2_name_de` AS `interessengruppe3_branche_kommission2_name_de`,`mv_organisation`.`interessengruppe3_branche_kommission2_name_fr` AS `interessengruppe3_branche_kommission2_name_fr`,`mv_organisation`.`refreshed_date` AS `refreshed_date`,`mv_organisation`.`land` AS `land`,`mv_organisation`.`interessenraum` AS `interessenraum`,`mv_organisation`.`interessenraum_de` AS `interessenraum_de`,`mv_organisation`.`interessenraum_fr` AS `interessenraum_fr`,`mv_organisation`.`organisation_jahr_id` AS `organisation_jahr_id`,`mv_organisation`.`jahr` AS `jahr`,`mv_organisation`.`umsatz` AS `umsatz`,`mv_organisation`.`gewinn` AS `gewinn`,`mv_organisation`.`kapital` AS `kapital`,`mv_organisation`.`mitarbeiter_weltweit` AS `mitarbeiter_weltweit`,`mv_organisation`.`mitarbeiter_schweiz` AS `mitarbeiter_schweiz`,`mv_organisation`.`geschaeftsbericht_url` AS `geschaeftsbericht_url`,`mv_organisation`.`quelle_url` AS `quelle_url`,`mv_organisation`.`anzahl_interessenbindung_tief` AS `anzahl_interessenbindung_tief`,`mv_organisation`.`anzahl_interessenbindung_mittel` AS `anzahl_interessenbindung_mittel`,`mv_organisation`.`anzahl_interessenbindung_hoch` AS `anzahl_interessenbindung_hoch`,`mv_organisation`.`anzahl_interessenbindung_tief_nach_wahl` AS `anzahl_interessenbindung_tief_nach_wahl`,`mv_organisation`.`anzahl_interessenbindung_mittel_nach_wahl` AS `anzahl_interessenbindung_mittel_nach_wahl`,`mv_organisation`.`anzahl_interessenbindung_hoch_nach_wahl` AS `anzahl_interessenbindung_hoch_nach_wahl`,`mv_organisation`.`anzahl_mandat_tief` AS `anzahl_mandat_tief`,`mv_organisation`.`anzahl_mandat_mittel` AS `anzahl_mandat_mittel`,`mv_organisation`.`anzahl_mandat_hoch` AS `anzahl_mandat_hoch`,`mv_organisation`.`lobbyeinfluss` AS `lobbyeinfluss`,`mv_organisation`.`lobbyeinfluss_index` AS `lobbyeinfluss_index` from `mv_organisation` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_organisation_jahr_last` AS select `organisation_jahr`.`jahr` AS `max_jahr`,`organisation_jahr`.`id` AS `id`,`organisation_jahr`.`organisation_id` AS `organisation_id`,`organisation_jahr`.`jahr` AS `jahr`,`organisation_jahr`.`umsatz` AS `umsatz`,`organisation_jahr`.`gewinn` AS `gewinn`,`organisation_jahr`.`kapital` AS `kapital`,`organisation_jahr`.`mitarbeiter_weltweit` AS `mitarbeiter_weltweit`,`organisation_jahr`.`mitarbeiter_schweiz` AS `mitarbeiter_schweiz`,`organisation_jahr`.`geschaeftsbericht_url` AS `geschaeftsbericht_url`,`organisation_jahr`.`quelle_url` AS `quelle_url`,`organisation_jahr`.`quelle_url_gueltig` AS `quelle_url_gueltig`,`organisation_jahr`.`quelle` AS `quelle`,`organisation_jahr`.`notizen` AS `notizen`,`organisation_jahr`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`organisation_jahr`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`organisation_jahr`.`kontrolliert_visa` AS `kontrolliert_visa`,`organisation_jahr`.`kontrolliert_datum` AS `kontrolliert_datum`,`organisation_jahr`.`freigabe_visa` AS `freigabe_visa`,`organisation_jahr`.`freigabe_datum` AS `freigabe_datum`,`organisation_jahr`.`created_visa` AS `created_visa`,`organisation_jahr`.`created_date` AS `created_date`,`organisation_jahr`.`updated_visa` AS `updated_visa`,`organisation_jahr`.`updated_date` AS `updated_date` from `organisation_jahr` where (`organisation_jahr`.`jahr` = (select max(`max_oj`.`jahr`) from `organisation_jahr` `max_oj` where (`max_oj`.`organisation_id` = `organisation_jahr`.`organisation_id`))) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_organisation_medium_raw` AS select `organisation`.`anzeige_name` AS `anzeige_name`,`organisation`.`anzeige_mixed` AS `anzeige_mixed`,`organisation`.`anzeige_bimixed` AS `anzeige_bimixed`,`organisation`.`searchable_name` AS `searchable_name`,`organisation`.`anzeige_name_de` AS `anzeige_name_de`,`organisation`.`anzeige_name_fr` AS `anzeige_name_fr`,`organisation`.`name` AS `name`,`organisation`.`id` AS `id`,`organisation`.`name_de` AS `name_de`,`organisation`.`name_fr` AS `name_fr`,`organisation`.`name_it` AS `name_it`,`organisation`.`uid` AS `uid`,`organisation`.`ort` AS `ort`,`organisation`.`abkuerzung_de` AS `abkuerzung_de`,`organisation`.`alias_namen_de` AS `alias_namen_de`,`organisation`.`abkuerzung_fr` AS `abkuerzung_fr`,`organisation`.`alias_namen_fr` AS `alias_namen_fr`,`organisation`.`abkuerzung_it` AS `abkuerzung_it`,`organisation`.`alias_namen_it` AS `alias_namen_it`,`organisation`.`land_id` AS `land_id`,`organisation`.`interessenraum_id` AS `interessenraum_id`,`organisation`.`rechtsform` AS `rechtsform`,`organisation`.`rechtsform_handelsregister` AS `rechtsform_handelsregister`,`organisation`.`rechtsform_zefix` AS `rechtsform_zefix`,`organisation`.`typ` AS `typ`,`organisation`.`vernehmlassung` AS `vernehmlassung`,`organisation`.`interessengruppe_id` AS `interessengruppe_id`,`organisation`.`interessengruppe2_id` AS `interessengruppe2_id`,`organisation`.`interessengruppe3_id` AS `interessengruppe3_id`,`organisation`.`ALT_branche_id` AS `ALT_branche_id`,`organisation`.`homepage` AS `homepage`,`organisation`.`handelsregister_url` AS `handelsregister_url`,`organisation`.`twitter_name` AS `twitter_name`,`organisation`.`beschreibung` AS `beschreibung`,`organisation`.`beschreibung_fr` AS `beschreibung_fr`,`organisation`.`sekretariat` AS `sekretariat`,`organisation`.`adresse_strasse` AS `adresse_strasse`,`organisation`.`adresse_zusatz` AS `adresse_zusatz`,`organisation`.`adresse_plz` AS `adresse_plz`,`organisation`.`notizen` AS `notizen`,`organisation`.`updated_by_import` AS `updated_by_import`,`organisation`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`organisation`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`organisation`.`kontrolliert_visa` AS `kontrolliert_visa`,`organisation`.`kontrolliert_datum` AS `kontrolliert_datum`,`organisation`.`freigabe_visa` AS `freigabe_visa`,`organisation`.`freigabe_datum` AS `freigabe_datum`,`organisation`.`created_visa` AS `created_visa`,`organisation`.`created_date` AS `created_date`,`organisation`.`updated_visa` AS `updated_visa`,`organisation`.`updated_date` AS `updated_date`,`organisation`.`published` AS `published`,`organisation`.`created_date_unix` AS `created_date_unix`,`organisation`.`updated_date_unix` AS `updated_date_unix`,`organisation`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`organisation`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`organisation`.`freigabe_datum_unix` AS `freigabe_datum_unix`,`branche`.`anzeige_name` AS `branche_ALT`,`branche`.`anzeige_name_de` AS `branche_de_ALT`,`branche`.`anzeige_name_de` AS `branche_fr_ALT`,`interessengruppe1`.`anzeige_name` AS `interessengruppe`,`interessengruppe1`.`anzeige_name_de` AS `interessengruppe_de`,`interessengruppe1`.`anzeige_name_fr` AS `interessengruppe_fr`,`interessengruppe1`.`branche` AS `interessengruppe_branche`,`interessengruppe1`.`branche_de` AS `interessengruppe_branche_de`,`interessengruppe1`.`branche_fr` AS `interessengruppe_branche_fr`,`interessengruppe1`.`branche_id` AS `interessengruppe_branche_id`,`interessengruppe1`.`kommission1_id` AS `interessengruppe_branche_kommission1_id`,`interessengruppe1`.`kommission1_abkuerzung` AS `interessengruppe_branche_kommission1_abkuerzung`,`interessengruppe1`.`kommission1_abkuerzung_de` AS `interessengruppe_branche_kommission1_abkuerzung_de`,`interessengruppe1`.`kommission1_abkuerzung_fr` AS `interessengruppe_branche_kommission1_abkuerzung_fr`,`interessengruppe1`.`kommission1_name` AS `interessengruppe_branche_kommission1_name`,`interessengruppe1`.`kommission1_name_de` AS `interessengruppe_branche_kommission1_name_de`,`interessengruppe1`.`kommission1_name_fr` AS `interessengruppe_branche_kommission1_name_fr`,`interessengruppe1`.`kommission2_id` AS `interessengruppe_branche_kommission2_id`,`interessengruppe1`.`kommission2_abkuerzung` AS `interessengruppe_branche_kommission2_abkuerzung`,`interessengruppe1`.`kommission2_abkuerzung_de` AS `interessengruppe_branche_kommission2_abkuerzung_de`,`interessengruppe1`.`kommission2_abkuerzung_fr` AS `interessengruppe_branche_kommission2_abkuerzung_fr`,`interessengruppe1`.`kommission2_name` AS `interessengruppe_branche_kommission2_name`,`interessengruppe1`.`kommission2_name_de` AS `interessengruppe_branche_kommission2_name_de`,`interessengruppe1`.`kommission2_name_fr` AS `interessengruppe_branche_kommission2_name_fr`,`interessengruppe1`.`anzeige_name` AS `interessengruppe1`,`interessengruppe1`.`id` AS `interessengruppe1_id`,`interessengruppe1`.`anzeige_name_de` AS `interessengruppe1_de`,`interessengruppe1`.`anzeige_name_fr` AS `interessengruppe1_fr`,`interessengruppe1`.`branche` AS `interessengruppe1_branche`,`interessengruppe1`.`branche_de` AS `interessengruppe1_branche_de`,`interessengruppe1`.`branche_fr` AS `interessengruppe1_branche_fr`,`interessengruppe1`.`branche_id` AS `interessengruppe1_branche_id`,replace(replace(ifnull(`interessengruppe1`.`kommission1_abkuerzung`,`interessengruppe1`.`kommission2_abkuerzung`),'-NR',''),'-SR','') AS `interessengruppe1_branche_kommission_abkuerzung`,replace(replace(ifnull(`interessengruppe1`.`kommission1_abkuerzung_de`,`interessengruppe1`.`kommission2_abkuerzung_de`),'-NR',''),'-SR','') AS `interessengruppe1_branche_kommission_abkuerzung_de`,replace(replace(ifnull(`interessengruppe1`.`kommission1_abkuerzung_fr`,`interessengruppe1`.`kommission2_abkuerzung_fr`),'-CN',''),'-CE','') AS `interessengruppe1_branche_kommission_abkuerzung_fr`,concat_ws(' / ',`interessengruppe1`.`kommission1_abkuerzung`,`interessengruppe1`.`kommission2_abkuerzung`) AS `interessengruppe1_branche_kommissionen_abkuerzung`,concat_ws(' / ',`interessengruppe1`.`kommission1_abkuerzung_de`,`interessengruppe1`.`kommission2_abkuerzung_de`) AS `interessengruppe1_branche_kommissionen_abkuerzung_de`,concat_ws(' / ',`interessengruppe1`.`kommission1_abkuerzung_fr`,`interessengruppe1`.`kommission2_abkuerzung_fr`) AS `interessengruppe1_branche_kommissionen_abkuerzung_fr`,`interessengruppe1`.`kommission1_id` AS `interessengruppe1_branche_kommission1_id`,`interessengruppe1`.`kommission1_abkuerzung` AS `interessengruppe1_branche_kommission1_abkuerzung`,`interessengruppe1`.`kommission1_abkuerzung_de` AS `interessengruppe1_branche_kommission1_abkuerzung_de`,`interessengruppe1`.`kommission1_abkuerzung_fr` AS `interessengruppe1_branche_kommission1_abkuerzung_fr`,`interessengruppe1`.`kommission1_name` AS `interessengruppe1_branche_kommission1_name`,`interessengruppe1`.`kommission1_name_de` AS `interessengruppe1_branche_kommission1_name_de`,`interessengruppe1`.`kommission1_name_fr` AS `interessengruppe1_branche_kommission1_name_fr`,`interessengruppe1`.`kommission2_id` AS `interessengruppe1_branche_kommission2_id`,`interessengruppe1`.`kommission2_abkuerzung` AS `interessengruppe1_branche_kommission2_abkuerzung`,`interessengruppe1`.`kommission2_abkuerzung_de` AS `interessengruppe1_branche_kommission2_abkuerzung_de`,`interessengruppe1`.`kommission2_abkuerzung_fr` AS `interessengruppe1_branche_kommission2_abkuerzung_fr`,`interessengruppe1`.`kommission2_name` AS `interessengruppe1_branche_kommission2_name`,`interessengruppe1`.`kommission2_name_de` AS `interessengruppe1_branche_kommission2_name_de`,`interessengruppe1`.`kommission2_name_fr` AS `interessengruppe1_branche_kommission2_name_fr`,`interessengruppe2`.`anzeige_name` AS `interessengruppe2`,`interessengruppe2`.`anzeige_name_de` AS `interessengruppe2_de`,`interessengruppe2`.`anzeige_name_fr` AS `interessengruppe2_fr`,`interessengruppe2`.`branche` AS `interessengruppe2_branche`,`interessengruppe2`.`branche_de` AS `interessengruppe2_branche_de`,`interessengruppe2`.`branche_fr` AS `interessengruppe2_branche_fr`,`interessengruppe2`.`branche_id` AS `interessengruppe2_branche_id`,replace(replace(ifnull(`interessengruppe2`.`kommission1_abkuerzung`,`interessengruppe2`.`kommission2_abkuerzung`),'-NR',''),'-SR','') AS `interessengruppe2_branche_kommission_abkuerzung`,replace(replace(ifnull(`interessengruppe2`.`kommission1_abkuerzung_de`,`interessengruppe2`.`kommission2_abkuerzung_de`),'-NR',''),'-SR','') AS `interessengruppe2_branche_kommission_abkuerzung_de`,replace(replace(ifnull(`interessengruppe2`.`kommission1_abkuerzung_fr`,`interessengruppe2`.`kommission2_abkuerzung_fr`),'-CN',''),'-CE','') AS `interessengruppe2_branche_kommission_abkuerzung_fr`,concat_ws(' / ',`interessengruppe2`.`kommission1_abkuerzung`,`interessengruppe2`.`kommission2_abkuerzung`) AS `interessengruppe2_branche_kommissionen_abkuerzung`,concat_ws(' / ',`interessengruppe2`.`kommission1_abkuerzung_de`,`interessengruppe2`.`kommission2_abkuerzung_de`) AS `interessengruppe2_branche_kommissionen_abkuerzung_de`,concat_ws(' / ',`interessengruppe2`.`kommission1_abkuerzung_fr`,`interessengruppe2`.`kommission2_abkuerzung_fr`) AS `interessengruppe2_branche_kommissionen_abkuerzung_fr`,`interessengruppe2`.`kommission1_id` AS `interessengruppe2_branche_kommission1_id`,`interessengruppe2`.`kommission1_abkuerzung` AS `interessengruppe2_branche_kommission1_abkuerzung`,`interessengruppe2`.`kommission1_abkuerzung_de` AS `interessengruppe2_branche_kommission1_abkuerzung_de`,`interessengruppe2`.`kommission1_abkuerzung_fr` AS `interessengruppe2_branche_kommission1_abkuerzung_fr`,`interessengruppe2`.`kommission1_name` AS `interessengruppe2_branche_kommission1_name`,`interessengruppe2`.`kommission1_name_de` AS `interessengruppe2_branche_kommission1_name_de`,`interessengruppe2`.`kommission1_name_fr` AS `interessengruppe2_branche_kommission1_name_fr`,`interessengruppe2`.`kommission2_id` AS `interessengruppe2_branche_kommission2_id`,`interessengruppe2`.`kommission2_abkuerzung` AS `interessengruppe2_branche_kommission2_abkuerzung`,`interessengruppe2`.`kommission2_abkuerzung_de` AS `interessengruppe2_branche_kommission2_abkuerzung_de`,`interessengruppe2`.`kommission2_abkuerzung_fr` AS `interessengruppe2_branche_kommission2_abkuerzung_fr`,`interessengruppe2`.`kommission2_name` AS `interessengruppe2_branche_kommission2_name`,`interessengruppe2`.`kommission2_name_de` AS `interessengruppe2_branche_kommission2_name_de`,`interessengruppe2`.`kommission2_name_fr` AS `interessengruppe2_branche_kommission2_name_fr`,`interessengruppe3`.`anzeige_name` AS `interessengruppe3`,`interessengruppe3`.`anzeige_name_de` AS `interessengruppe3_de`,`interessengruppe3`.`anzeige_name_fr` AS `interessengruppe3_fr`,`interessengruppe3`.`branche` AS `interessengruppe3_branche`,`interessengruppe3`.`branche_de` AS `interessengruppe3_branche_de`,`interessengruppe3`.`branche_fr` AS `interessengruppe3_branche_fr`,`interessengruppe3`.`branche_id` AS `interessengruppe3_branche_id`,replace(replace(ifnull(`interessengruppe3`.`kommission1_abkuerzung`,`interessengruppe3`.`kommission2_abkuerzung`),'-NR',''),'-SR','') AS `interessengruppe3_branche_kommission_abkuerzung`,replace(replace(ifnull(`interessengruppe3`.`kommission1_abkuerzung_de`,`interessengruppe3`.`kommission2_abkuerzung_de`),'-NR',''),'-SR','') AS `interessengruppe3_branche_kommission_abkuerzung_de`,replace(replace(ifnull(`interessengruppe3`.`kommission1_abkuerzung_fr`,`interessengruppe3`.`kommission2_abkuerzung_fr`),'-CN',''),'-CE','') AS `interessengruppe3_branche_kommission_abkuerzung_fr`,concat_ws(' / ',`interessengruppe3`.`kommission1_abkuerzung`,`interessengruppe3`.`kommission2_abkuerzung`) AS `interessengruppe3_branche_kommissionen_abkuerzung`,concat_ws(' / ',`interessengruppe3`.`kommission1_abkuerzung_de`,`interessengruppe3`.`kommission2_abkuerzung_de`) AS `interessengruppe3_branche_kommissionen_abkuerzung_de`,concat_ws(' / ',`interessengruppe3`.`kommission1_abkuerzung_fr`,`interessengruppe3`.`kommission2_abkuerzung_fr`) AS `interessengruppe3_branche_kommissionen_abkuerzung_fr`,`interessengruppe3`.`kommission1_id` AS `interessengruppe3_branche_kommission1_id`,`interessengruppe3`.`kommission1_abkuerzung` AS `interessengruppe3_branche_kommission1_abkuerzung`,`interessengruppe3`.`kommission1_abkuerzung_de` AS `interessengruppe3_branche_kommission1_abkuerzung_de`,`interessengruppe3`.`kommission1_abkuerzung_fr` AS `interessengruppe3_branche_kommission1_abkuerzung_fr`,`interessengruppe3`.`kommission1_name` AS `interessengruppe3_branche_kommission1_name`,`interessengruppe3`.`kommission1_name_de` AS `interessengruppe3_branche_kommission1_name_de`,`interessengruppe3`.`kommission1_name_fr` AS `interessengruppe3_branche_kommission1_name_fr`,`interessengruppe3`.`kommission2_id` AS `interessengruppe3_branche_kommission2_id`,`interessengruppe3`.`kommission2_abkuerzung` AS `interessengruppe3_branche_kommission2_abkuerzung`,`interessengruppe3`.`kommission2_abkuerzung_de` AS `interessengruppe3_branche_kommission2_abkuerzung_de`,`interessengruppe3`.`kommission2_abkuerzung_fr` AS `interessengruppe3_branche_kommission2_abkuerzung_fr`,`interessengruppe3`.`kommission2_name` AS `interessengruppe3_branche_kommission2_name`,`interessengruppe3`.`kommission2_name_de` AS `interessengruppe3_branche_kommission2_name_de`,`interessengruppe3`.`kommission2_name_fr` AS `interessengruppe3_branche_kommission2_name_fr`,now() AS `refreshed_date` from ((((`v_organisation_simple` `organisation` left join `v_branche` `branche` on((`branche`.`id` = `organisation`.`ALT_branche_id`))) left join `v_interessengruppe` `interessengruppe1` on((`interessengruppe1`.`id` = `organisation`.`interessengruppe_id`))) left join `v_interessengruppe` `interessengruppe2` on((`interessengruppe2`.`id` = `organisation`.`interessengruppe2_id`))) left join `v_interessengruppe` `interessengruppe3` on((`interessengruppe3`.`id` = `organisation`.`interessengruppe3_id`))) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_organisation_normalized_interessengruppe_raw`
--
...
VIEW `v_organisation_normalized_interessengruppe_raw` AS select `organisation`.`anzeige_name` AS `anzeige_name`,`organisation`.`anzeige_mixed` AS `anzeige_mixed`,`organisation`.`anzeige_bimixed` AS `anzeige_bimixed`,`organisation`.`searchable_name` AS `searchable_name`,`organisation`.`anzeige_name_de` AS `anzeige_name_de`,`organisation`.`anzeige_name_fr` AS `anzeige_name_fr`,`organisation`.`name` AS `name`,`organisation`.`id` AS `id`,`organisation`.`name_de` AS `name_de`,`organisation`.`name_fr` AS `name_fr`,`organisation`.`name_it` AS `name_it`,`organisation`.`uid` AS `uid`,`organisation`.`ort` AS `ort`,`organisation`.`abkuerzung_de` AS `abkuerzung_de`,`organisation`.`alias_namen_de` AS `alias_namen_de`,`organisation`.`abkuerzung_fr` AS `abkuerzung_fr`,`organisation`.`alias_namen_fr` AS `alias_namen_fr`,`organisation`.`abkuerzung_it` AS `abkuerzung_it`,`organisation`.`alias_namen_it` AS `alias_namen_it`,`organisation`.`land_id` AS `land_id`,`organisation`.`interessenraum_id` AS `interessenraum_id`,`organisation`.`rechtsform` AS `rechtsform`,`organisation`.`rechtsform_handelsregister` AS `rechtsform_handelsregister`,`organisation`.`rechtsform_zefix` AS `rechtsform_zefix`,`organisation`.`typ` AS `typ`,`organisation`.`vernehmlassung` AS `vernehmlassung`,-(-(`organisation`.`interessengruppe_id`)) AS `interessengruppe1_id`,-(-(`organisation`.`interessengruppe2_id`)) AS `--organisation.interessengruppe2_id`,-(-(`organisation`.`interessengruppe3_id`)) AS `--organisation.interessengruppe3_id`,`organisation`.`homepage` AS `homepage`,`organisation`.`handelsregister_url` AS `handelsregister_url`,`organisation`.`twitter_name` AS `twitter_name`,`organisation`.`beschreibung` AS `beschreibung`,`organisation`.`beschreibung_fr` AS `beschreibung_fr`,`organisation`.`sekretariat` AS `sekretariat`,`organisation`.`adresse_strasse` AS `adresse_strasse`,`organisation`.`adresse_zusatz` AS `adresse_zusatz`,`organisation`.`adresse_plz` AS `adresse_plz`,`organisation`.`notizen` AS `notizen`,`organisation`.`updated_by_import` AS `updated_by_import`,`organisation`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`organisation`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`organisation`.`kontrolliert_visa` AS `kontrolliert_visa`,`organisation`.`kontrolliert_datum` AS `kontrolliert_datum`,`organisation`.`freigabe_visa` AS `freigabe_visa`,`organisation`.`freigabe_datum` AS `freigabe_datum`,`organisation`.`created_visa` AS `created_visa`,`organisation`.`created_date` AS `created_date`,`organisation`.`updated_visa` AS `updated_visa`,`organisation`.`updated_date` AS `updated_date`,`organisation`.`published` AS `published`,`organisation`.`created_date_unix` AS `created_date_unix`,`organisation`.`updated_date_unix` AS `updated_date_unix`,`organisation`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`organisation`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`organisation`.`freigabe_datum_unix` AS `freigabe_datum_unix`,`interessengruppe`.`id` AS `interessengruppe_id`,`interessengruppe`.`anzeige_name` AS `interessengruppe`,`interessengruppe`.`anzeige_name_de` AS `interessengruppe_de`,`interessengruppe`.`anzeige_name_fr` AS `interessengruppe_fr`,`interessengruppe`.`branche` AS `interessengruppe_branche`,`interessengruppe`.`branche_de` AS `interessengruppe_branche_de`,`interessengruppe`.`branche_fr` AS `interessengruppe_branche_fr`,`interessengruppe`.`branche_id` AS `interessengruppe_branche_id`,replace(replace(ifnull(`interessengruppe`.`kommission1_abkuerzung`,`interessengruppe`.`kommission2_abkuerzung`),'-NR',''),'-SR','') AS `interessengruppe_branche_kommission_abkuerzung`,replace(replace(ifnull(`interessengruppe`.`kommission1_abkuerzung_de`,`interessengruppe`.`kommission2_abkuerzung_de`),'-NR',''),'-SR','') AS `interessengruppe_branche_kommission_abkuerzung_de`,replace(replace(ifnull(`interessengruppe`.`kommission1_abkuerzung_fr`,`interessengruppe`.`kommission2_abkuerzung_fr`),'-CN',''),'-CE','') AS `interessengruppe_branche_kommission_abkuerzung_fr`,concat_ws(' / ',`interessengruppe`.`kommission1_abkuerzung`,`interessengruppe`.`kommission2_abkuerzung`) AS `interessengruppe_branche_kommissionen_abkuerzung`,concat_ws(' / ',`interessengruppe`.`kommission1_abkuerzung_de`,`interessengruppe`.`kommission2_abkuerzung_de`) AS `interessengruppe_branche_kommissionen_abkuerzung_de`,concat_ws(' / ',`interessengruppe`.`kommission1_abkuerzung_fr`,`interessengruppe`.`kommission2_abkuerzung_fr`) AS `interessengruppe_branche_kommissionen_abkuerzung_fr`,`interessengruppe`.`kommission1_id` AS `interessengruppe_branche_kommission1_id`,`interessengruppe`.`kommission1_abkuerzung` AS `interessengruppe_branche_kommission1_abkuerzung`,`interessengruppe`.`kommission1_abkuerzung_de` AS `interessengruppe_branche_kommission1_abkuerzung_de`,`interessengruppe`.`kommission1_abkuerzung_fr` AS `interessengruppe_branche_kommission1_abkuerzung_fr`,`interessengruppe`.`kommission1_name` AS `interessengruppe_branche_kommission1_name`,`interessengruppe`.`kommission1_name_de` AS `interessengruppe_branche_kommission1_name_de`,`interessengruppe`.`kommission1_name_fr` AS `interessengruppe_branche_kommission1_name_fr`,`interessengruppe`.`kommission2_id` AS `interessengruppe_branche_kommission2_id`,`interessengruppe`.`kommission2_abkuerzung` AS `interessengruppe_branche_kommission2_abkuerzung`,`interessengruppe`.`kommission2_abkuerzung_de` AS `interessengruppe_branche_kommission2_abkuerzung_de`,`interessengruppe`.`kommission2_abkuerzung_fr` AS `interessengruppe_branche_kommission2_abkuerzung_fr`,`interessengruppe`.`kommission2_name` AS `interessengruppe_branche_kommission2_name`,`interessengruppe`.`kommission2_name_de` AS `interessengruppe_branche_kommission2_name_de`,`interessengruppe`.`kommission2_name_fr` AS `interessengruppe_branche_kommission2_name_fr`,now() AS `refreshed_date` from (`v_organisation_simple` `organisation` left join `v_interessengruppe` `interessengruppe` on(((`organisation`.`interessengruppe_id` = `interessengruppe`.`id`) or (`organisation`.`interessengruppe2_id` = `interessengruppe`.`id`) or (`organisation`.`interessengruppe3_id` = `interessengruppe`.`id`)))) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_organisation_raw` AS select `organisation`.`anzeige_name` AS `anzeige_name`,`organisation`.`anzeige_mixed` AS `anzeige_mixed`,`organisation`.`anzeige_bimixed` AS `anzeige_bimixed`,`organisation`.`searchable_name` AS `searchable_name`,`organisation`.`anzeige_name_de` AS `anzeige_name_de`,`organisation`.`anzeige_name_fr` AS `anzeige_name_fr`,`organisation`.`name` AS `name`,`organisation`.`id` AS `id`,`organisation`.`name_de` AS `name_de`,`organisation`.`name_fr` AS `name_fr`,`organisation`.`name_it` AS `name_it`,`organisation`.`uid` AS `uid`,`organisation`.`ort` AS `ort`,`organisation`.`abkuerzung_de` AS `abkuerzung_de`,`organisation`.`alias_namen_de` AS `alias_namen_de`,`organisation`.`abkuerzung_fr` AS `abkuerzung_fr`,`organisation`.`alias_namen_fr` AS `alias_namen_fr`,`organisation`.`abkuerzung_it` AS `abkuerzung_it`,`organisation`.`alias_namen_it` AS `alias_namen_it`,`organisation`.`land_id` AS `land_id`,`organisation`.`interessenraum_id` AS `interessenraum_id`,`organisation`.`rechtsform` AS `rechtsform`,`organisation`.`rechtsform_handelsregister` AS `rechtsform_handelsregister`,`organisation`.`rechtsform_zefix` AS `rechtsform_zefix`,`organisation`.`typ` AS `typ`,`organisation`.`vernehmlassung` AS `vernehmlassung`,`organisation`.`interessengruppe_id` AS `interessengruppe_id`,`organisation`.`interessengruppe2_id` AS `interessengruppe2_id`,`organisation`.`interessengruppe3_id` AS `interessengruppe3_id`,`organisation`.`ALT_branche_id` AS `ALT_branche_id`,`organisation`.`homepage` AS `homepage`,`organisation`.`handelsregister_url` AS `handelsregister_url`,`organisation`.`twitter_name` AS `twitter_name`,`organisation`.`beschreibung` AS `beschreibung`,`organisation`.`beschreibung_fr` AS `beschreibung_fr`,`organisation`.`sekretariat` AS `sekretariat`,`organisation`.`adresse_strasse` AS `adresse_strasse`,`organisation`.`adresse_zusatz` AS `adresse_zusatz`,`organisation`.`adresse_plz` AS `adresse_plz`,`organisation`.`notizen` AS `notizen`,`organisation`.`updated_by_import` AS `updated_by_import`,`organisation`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`organisation`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`organisation`.`kontrolliert_visa` AS `kontrolliert_visa`,`organisation`.`kontrolliert_datum` AS `kontrolliert_datum`,`organisation`.`freigabe_visa` AS `freigabe_visa`,`organisation`.`freigabe_datum` AS `freigabe_datum`,`organisation`.`created_visa` AS `created_visa`,`organisation`.`created_date` AS `created_date`,`organisation`.`updated_visa` AS `updated_visa`,`organisation`.`updated_date` AS `updated_date`,`organisation`.`published` AS `published`,`organisation`.`created_date_unix` AS `created_date_unix`,`organisation`.`updated_date_unix` AS `updated_date_unix`,`organisation`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`organisation`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`organisation`.`freigabe_datum_unix` AS `freigabe_datum_unix`,`organisation`.`branche_ALT` AS `branche_ALT`,`organisation`.`branche_de_ALT` AS `branche_de_ALT`,`organisation`.`branche_fr_ALT` AS `branche_fr_ALT`,`organisation`.`interessengruppe` AS `interessengruppe`,`organisation`.`interessengruppe_de` AS `interessengruppe_de`,`organisation`.`interessengruppe_fr` AS `interessengruppe_fr`,`organisation`.`interessengruppe_branche` AS `interessengruppe_branche`,`organisation`.`interessengruppe_branche_de` AS `interessengruppe_branche_de`,`organisation`.`interessengruppe_branche_fr` AS `interessengruppe_branche_fr`,`organisation`.`interessengruppe_branche_id` AS `interessengruppe_branche_id`,`organisation`.`interessengruppe_branche_kommission1_id` AS `interessengruppe_branche_kommission1_id`,`organisation`.`interessengruppe_branche_kommission1_abkuerzung` AS `interessengruppe_branche_kommission1_abkuerzung`,`organisation`.`interessengruppe_branche_kommission1_abkuerzung_de` AS `interessengruppe_branche_kommission1_abkuerzung_de`,`organisation`.`interessengruppe_branche_kommission1_abkuerzung_fr` AS `interessengruppe_branche_kommission1_abkuerzung_fr`,`organisation`.`interessengruppe_branche_kommission1_name` AS `interessengruppe_branche_kommission1_name`,`organisation`.`interessengruppe_branche_kommission1_name_de` AS `interessengruppe_branche_kommission1_name_de`,`organisation`.`interessengruppe_branche_kommission1_name_fr` AS `interessengruppe_branche_kommission1_name_fr`,`organisation`.`interessengruppe_branche_kommission2_id` AS `interessengruppe_branche_kommission2_id`,`organisation`.`interessengruppe_branche_kommission2_abkuerzung` AS `interessengruppe_branche_kommission2_abkuerzung`,`organisation`.`interessengruppe_branche_kommission2_abkuerzung_de` AS `interessengruppe_branche_kommission2_abkuerzung_de`,`organisation`.`interessengruppe_branche_kommission2_abkuerzung_fr` AS `interessengruppe_branche_kommission2_abkuerzung_fr`,`organisation`.`interessengruppe_branche_kommission2_name` AS `interessengruppe_branche_kommission2_name`,`organisation`.`interessengruppe_branche_kommission2_name_de` AS `interessengruppe_branche_kommission2_name_de`,`organisation`.`interessengruppe_branche_kommission2_name_fr` AS `interessengruppe_branche_kommission2_name_fr`,`organisation`.`interessengruppe1` AS `interessengruppe1`,`organisation`.`interessengruppe1_id` AS `interessengruppe1_id`,`organisation`.`interessengruppe1_de` AS `interessengruppe1_de`,`organisation`.`interessengruppe1_fr` AS `interessengruppe1_fr`,`organisation`.`interessengruppe1_branche` AS `interessengruppe1_branche`,`organisation`.`interessengruppe1_branche_de` AS `interessengruppe1_branche_de`,`organisation`.`interessengruppe1_branche_fr` AS `interessengruppe1_branche_fr`,`organisation`.`interessengruppe1_branche_id` AS `interessengruppe1_branche_id`,`organisation`.`interessengruppe1_branche_kommission_abkuerzung` AS `interessengruppe1_branche_kommission_abkuerzung`,`organisation`.`interessengruppe1_branche_kommission_abkuerzung_de` AS `interessengruppe1_branche_kommission_abkuerzung_de`,`organisation`.`interessengruppe1_branche_kommission_abkuerzung_fr` AS `interessengruppe1_branche_kommission_abkuerzung_fr`,`organisation`.`interessengruppe1_branche_kommissionen_abkuerzung` AS `interessengruppe1_branche_kommissionen_abkuerzung`,`organisation`.`interessengruppe1_branche_kommissionen_abkuerzung_de` AS `interessengruppe1_branche_kommissionen_abkuerzung_de`,`organisation`.`interessengruppe1_branche_kommissionen_abkuerzung_fr` AS `interessengruppe1_branche_kommissionen_abkuerzung_fr`,`organisation`.`interessengruppe1_branche_kommission1_id` AS `interessengruppe1_branche_kommission1_id`,`organisation`.`interessengruppe1_branche_kommission1_abkuerzung` AS `interessengruppe1_branche_kommission1_abkuerzung`,`organisation`.`interessengruppe1_branche_kommission1_abkuerzung_de` AS `interessengruppe1_branche_kommission1_abkuerzung_de`,`organisation`.`interessengruppe1_branche_kommission1_abkuerzung_fr` AS `interessengruppe1_branche_kommission1_abkuerzung_fr`,`organisation`.`interessengruppe1_branche_kommission1_name` AS `interessengruppe1_branche_kommission1_name`,`organisation`.`interessengruppe1_branche_kommission1_name_de` AS `interessengruppe1_branche_kommission1_name_de`,`organisation`.`interessengruppe1_branche_kommission1_name_fr` AS `interessengruppe1_branche_kommission1_name_fr`,`organisation`.`interessengruppe1_branche_kommission2_id` AS `interessengruppe1_branche_kommission2_id`,`organisation`.`interessengruppe1_branche_kommission2_abkuerzung` AS `interessengruppe1_branche_kommission2_abkuerzung`,`organisation`.`interessengruppe1_branche_kommission2_abkuerzung_de` AS `interessengruppe1_branche_kommission2_abkuerzung_de`,`organisation`.`interessengruppe1_branche_kommission2_abkuerzung_fr` AS `interessengruppe1_branche_kommission2_abkuerzung_fr`,`organisation`.`interessengruppe1_branche_kommission2_name` AS `interessengruppe1_branche_kommission2_name`,`organisation`.`interessengruppe1_branche_kommission2_name_de` AS `interessengruppe1_branche_kommission2_name_de`,`organisation`.`interessengruppe1_branche_kommission2_name_fr` AS `interessengruppe1_branche_kommission2_name_fr`,`organisation`.`interessengruppe2` AS `interessengruppe2`,`organisation`.`interessengruppe2_de` AS `interessengruppe2_de`,`organisation`.`interessengruppe2_fr` AS `interessengruppe2_fr`,`organisation`.`interessengruppe2_branche` AS `interessengruppe2_branche`,`organisation`.`interessengruppe2_branche_de` AS `interessengruppe2_branche_de`,`organisation`.`interessengruppe2_branche_fr` AS `interessengruppe2_branche_fr`,`organisation`.`interessengruppe2_branche_id` AS `interessengruppe2_branche_id`,`organisation`.`interessengruppe2_branche_kommission_abkuerzung` AS `interessengruppe2_branche_kommission_abkuerzung`,`organisation`.`interessengruppe2_branche_kommission_abkuerzung_de` AS `interessengruppe2_branche_kommission_abkuerzung_de`,`organisation`.`interessengruppe2_branche_kommission_abkuerzung_fr` AS `interessengruppe2_branche_kommission_abkuerzung_fr`,`organisation`.`interessengruppe2_branche_kommissionen_abkuerzung` AS `interessengruppe2_branche_kommissionen_abkuerzung`,`organisation`.`interessengruppe2_branche_kommissionen_abkuerzung_de` AS `interessengruppe2_branche_kommissionen_abkuerzung_de`,`organisation`.`interessengruppe2_branche_kommissionen_abkuerzung_fr` AS `interessengruppe2_branche_kommissionen_abkuerzung_fr`,`organisation`.`interessengruppe2_branche_kommission1_id` AS `interessengruppe2_branche_kommission1_id`,`organisation`.`interessengruppe2_branche_kommission1_abkuerzung` AS `interessengruppe2_branche_kommission1_abkuerzung`,`organisation`.`interessengruppe2_branche_kommission1_abkuerzung_de` AS `interessengruppe2_branche_kommission1_abkuerzung_de`,`organisation`.`interessengruppe2_branche_kommission1_abkuerzung_fr` AS `interessengruppe2_branche_kommission1_abkuerzung_fr`,`organisation`.`interessengruppe2_branche_kommission1_name` AS `interessengruppe2_branche_kommission1_name`,`organisation`.`interessengruppe2_branche_kommission1_name_de` AS `interessengruppe2_branche_kommission1_name_de`,`organisation`.`interessengruppe2_branche_kommission1_name_fr` AS `interessengruppe2_branche_kommission1_name_fr`,`organisation`.`interessengruppe2_branche_kommission2_id` AS `interessengruppe2_branche_kommission2_id`,`organisation`.`interessengruppe2_branche_kommission2_abkuerzung` AS `interessengruppe2_branche_kommission2_abkuerzung`,`organisation`.`interessengruppe2_branche_kommission2_abkuerzung_de` AS `interessengruppe2_branche_kommission2_abkuerzung_de`,`organisation`.`interessengruppe2_branche_kommission2_abkuerzung_fr` AS `interessengruppe2_branche_kommission2_abkuerzung_fr`,`organisation`.`interessengruppe2_branche_kommission2_name` AS `interessengruppe2_branche_kommission2_name`,`organisation`.`interessengruppe2_branche_kommission2_name_de` AS `interessengruppe2_branche_kommission2_name_de`,`organisation`.`interessengruppe2_branche_kommission2_name_fr` AS `interessengruppe2_branche_kommission2_name_fr`,`organisation`.`interessengruppe3` AS `interessengruppe3`,`organisation`.`interessengruppe3_de` AS `interessengruppe3_de`,`organisation`.`interessengruppe3_fr` AS `interessengruppe3_fr`,`organisation`.`interessengruppe3_branche` AS `interessengruppe3_branche`,`organisation`.`interessengruppe3_branche_de` AS `interessengruppe3_branche_de`,`organisation`.`interessengruppe3_branche_fr` AS `interessengruppe3_branche_fr`,`organisation`.`interessengruppe3_branche_id` AS `interessengruppe3_branche_id`,`organisation`.`interessengruppe3_branche_kommission_abkuerzung` AS `interessengruppe3_branche_kommission_abkuerzung`,`organisation`.`interessengruppe3_branche_kommission_abkuerzung_de` AS `interessengruppe3_branche_kommission_abkuerzung_de`,`organisation`.`interessengruppe3_branche_kommission_abkuerzung_fr` AS `interessengruppe3_branche_kommission_abkuerzung_fr`,`organisation`.`interessengruppe3_branche_kommissionen_abkuerzung` AS `interessengruppe3_branche_kommissionen_abkuerzung`,`organisation`.`interessengruppe3_branche_kommissionen_abkuerzung_de` AS `interessengruppe3_branche_kommissionen_abkuerzung_de`,`organisation`.`interessengruppe3_branche_kommissionen_abkuerzung_fr` AS `interessengruppe3_branche_kommissionen_abkuerzung_fr`,`organisation`.`interessengruppe3_branche_kommission1_id` AS `interessengruppe3_branche_kommission1_id`,`organisation`.`interessengruppe3_branche_kommission1_abkuerzung` AS `interessengruppe3_branche_kommission1_abkuerzung`,`organisation`.`interessengruppe3_branche_kommission1_abkuerzung_de` AS `interessengruppe3_branche_kommission1_abkuerzung_de`,`organisation`.`interessengruppe3_branche_kommission1_abkuerzung_fr` AS `interessengruppe3_branche_kommission1_abkuerzung_fr`,`organisation`.`interessengruppe3_branche_kommission1_name` AS `interessengruppe3_branche_kommission1_name`,`organisation`.`interessengruppe3_branche_kommission1_name_de` AS `interessengruppe3_branche_kommission1_name_de`,`organisation`.`interessengruppe3_branche_kommission1_name_fr` AS `interessengruppe3_branche_kommission1_name_fr`,`organisation`.`interessengruppe3_branche_kommission2_id` AS `interessengruppe3_branche_kommission2_id`,`organisation`.`interessengruppe3_branche_kommission2_abkuerzung` AS `interessengruppe3_branche_kommission2_abkuerzung`,`organisation`.`interessengruppe3_branche_kommission2_abkuerzung_de` AS `interessengruppe3_branche_kommission2_abkuerzung_de`,`organisation`.`interessengruppe3_branche_kommission2_abkuerzung_fr` AS `interessengruppe3_branche_kommission2_abkuerzung_fr`,`organisation`.`interessengruppe3_branche_kommission2_name` AS `interessengruppe3_branche_kommission2_name`,`organisation`.`interessengruppe3_branche_kommission2_name_de` AS `interessengruppe3_branche_kommission2_name_de`,`organisation`.`interessengruppe3_branche_kommission2_name_fr` AS `interessengruppe3_branche_kommission2_name_fr`,`organisation`.`refreshed_date` AS `refreshed_date`,`country`.`name_de` AS `land`,`interessenraum`.`anzeige_name` AS `interessenraum`,`interessenraum`.`anzeige_name_de` AS `interessenraum_de`,`interessenraum`.`anzeige_name_fr` AS `interessenraum_fr`,`organisation_jahr`.`id` AS `organisation_jahr_id`,`organisation_jahr`.`jahr` AS `jahr`,`organisation_jahr`.`umsatz` AS `umsatz`,`organisation_jahr`.`gewinn` AS `gewinn`,`organisation_jahr`.`kapital` AS `kapital`,`organisation_jahr`.`mitarbeiter_weltweit` AS `mitarbeiter_weltweit`,`organisation_jahr`.`mitarbeiter_schweiz` AS `mitarbeiter_schweiz`,`organisation_jahr`.`geschaeftsbericht_url` AS `geschaeftsbericht_url`,`organisation_jahr`.`quelle_url` AS `quelle_url`,`lobbyeinfluss`.`anzahl_interessenbindung_tief` AS `anzahl_interessenbindung_tief`,`lobbyeinfluss`.`anzahl_interessenbindung_mittel` AS `anzahl_interessenbindung_mittel`,`lobbyeinfluss`.`anzahl_interessenbindung_hoch` AS `anzahl_interessenbindung_hoch`,`lobbyeinfluss`.`anzahl_interessenbindung_tief_nach_wahl` AS `anzahl_interessenbindung_tief_nach_wahl`,`lobbyeinfluss`.`anzahl_interessenbindung_mittel_nach_wahl` AS `anzahl_interessenbindung_mittel_nach_wahl`,`lobbyeinfluss`.`anzahl_interessenbindung_hoch_nach_wahl` AS `anzahl_interessenbindung_hoch_nach_wahl`,`lobbyeinfluss`.`anzahl_mandat_tief` AS `anzahl_mandat_tief`,`lobbyeinfluss`.`anzahl_mandat_mittel` AS `anzahl_mandat_mittel`,`lobbyeinfluss`.`anzahl_mandat_hoch` AS `anzahl_mandat_hoch`,`lobbyeinfluss`.`lobbyeinfluss` AS `lobbyeinfluss`,(case `lobbyeinfluss`.`lobbyeinfluss` when 'sehr hoch' then 4 when 'hoch' then 3 when 'mittel' then 2 when 'tief' then 1 else 0 end) AS `lobbyeinfluss_index` from ((((`v_organisation_medium_raw` `organisation` left join `v_organisation_lobbyeinfluss_raw` `lobbyeinfluss` on((`lobbyeinfluss`.`id` = `organisation`.`id`))) left join `v_country` `country` on((`country`.`id` = `organisation`.`land_id`))) left join `v_interessenraum` `interessenraum` on((`interessenraum`.`id` = `organisation`.`interessenraum_id`))) left join `v_organisation_jahr_last` `organisation_jahr` on((`organisation_jahr`.`organisation_id` = `organisation`.`id`))) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_parlamentarier_transparenz` AS select `parlamentarier_transparenz`.`id` AS `id`,`parlamentarier_transparenz`.`parlamentarier_id` AS `parlamentarier_id`,`parlamentarier_transparenz`.`stichdatum` AS `stichdatum`,`parlamentarier_transparenz`.`verguetung_transparent` AS `verguetung_transparent`,`parlamentarier_transparenz`.`notizen` AS `notizen`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`parlamentarier_transparenz`.`kontrolliert_visa` AS `kontrolliert_visa`,`parlamentarier_transparenz`.`kontrolliert_datum` AS `kontrolliert_datum`,`parlamentarier_transparenz`.`freigabe_visa` AS `freigabe_visa`,`parlamentarier_transparenz`.`freigabe_datum` AS `freigabe_datum`,`parlamentarier_transparenz`.`created_visa` AS `created_visa`,`parlamentarier_transparenz`.`created_date` AS `created_date`,`parlamentarier_transparenz`.`updated_visa` AS `updated_visa`,`parlamentarier_transparenz`.`updated_date` AS `updated_date`,ifnull((`parlamentarier_transparenz`.`freigabe_datum` <= now()),FALSE) AS `published`,unix_timestamp(`parlamentarier_transparenz`.`created_date`) AS `created_date_unix`,unix_timestamp(`parlamentarier_transparenz`.`updated_date`) AS `updated_date_unix`,unix_timestamp(`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum`) AS `eingabe_abgeschlossen_datum_unix`,unix_timestamp(`parlamentarier_transparenz`.`kontrolliert_datum`) AS `kontrolliert_datum_unix`,unix_timestamp(`parlamentarier_transparenz`.`freigabe_datum`) AS `freigabe_datum_unix` from `parlamentarier_transparenz` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_parlamentarier_transparenz_calculated`
--
...
VIEW `v_parlamentarier_transparenz_calculated` AS select `count_table`.`parlamentarier_id` AS `parlamentarier_id`,`count_table`.`anzahl_interessenbindungen` AS `anzahl_interessenbindungen`,`count_table`.`anzahl_hauptberufliche_interessenbindungen` AS `anzahl_hauptberufliche_interessenbindungen`,`count_table`.`anzahl_nicht_hauptberufliche_interessenbindungen` AS `anzahl_nicht_hauptberufliche_interessenbindungen`,`count_table`.`anzahl_abgelaufene_interessenbindungen` AS `anzahl_abgelaufene_interessenbindungen`,`count_table`.`anzahl_interessenbindungen_alle` AS `anzahl_interessenbindungen_alle`,`count_table`.`anzahl_erfasste_verguetungen` AS `anzahl_erfasste_verguetungen`,`count_table`.`anzahl_erfasste_hauptberufliche_verguetungen` AS `anzahl_erfasste_hauptberufliche_verguetungen`,`count_table`.`anzahl_erfasste_nicht_hauptberufliche_verguetungen` AS `anzahl_erfasste_nicht_hauptberufliche_verguetungen`,if((`count_table`.`anzahl_nicht_hauptberufliche_interessenbindungen` > 0),round((`count_table`.`anzahl_erfasste_verguetungen` / `count_table`.`anzahl_nicht_hauptberufliche_interessenbindungen`),2),1) AS `verguetungstransparenz_berechnet`,if((`count_table`.`anzahl_nicht_hauptberufliche_interessenbindungen` > 0),round((`count_table`.`anzahl_erfasste_nicht_hauptberufliche_verguetungen` / `count_table`.`anzahl_nicht_hauptberufliche_interessenbindungen`),2),1) AS `verguetungstransparenz_berechnet_nicht_beruflich`,if((`count_table`.`anzahl_interessenbindungen` > 0),round((`count_table`.`anzahl_erfasste_verguetungen` / `count_table`.`anzahl_interessenbindungen`),2),1) AS `verguetungstransparenz_berechnet_alle` from (select `interessenbindung`.`parlamentarier_id` AS `parlamentarier_id`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now()))),1,NULL)) AS `anzahl_interessenbindungen`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now())) and `interessenbindung`.`hauptberuflich`),1,NULL)) AS `anzahl_hauptberufliche_interessenbindungen`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now())) and (not(`interessenbindung`.`hauptberuflich`))),1,NULL)) AS `anzahl_nicht_hauptberufliche_interessenbindungen`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (`interessenbindung`.`bis` is not null) and (`interessenbindung`.`bis` < now())),1,NULL)) AS `anzahl_abgelaufene_interessenbindungen`,count(if((`interessenbindung`.`parlamentarier_id` is not null),1,NULL)) AS `anzahl_interessenbindungen_alle`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now())) and (`interessenbindung`.`verguetung` is not null)),1,NULL)) AS `anzahl_erfasste_verguetungen`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now())) and (`interessenbindung`.`verguetung` is not null) and `interessenbindung`.`hauptberuflich`),1,NULL)) AS `anzahl_erfasste_hauptberufliche_verguetungen`,count(if(((`interessenbindung`.`parlamentarier_id` is not null) and (isnull(`interessenbindung`.`bis`) or (`interessenbindung`.`bis` > now())) and (`interessenbindung`.`verguetung` is not null) and (not(`interessenbindung`.`hauptberuflich`))),1,NULL)) AS `anzahl_erfasste_nicht_hauptberufliche_verguetungen` from (`v_parlamentarier_simple` `parlamentarier` left join `v_interessenbindung_jahr_raw` `interessenbindung` on((`interessenbindung`.`parlamentarier_id` = `parlamentarier`.`id`))) group by `interessenbindung`.`parlamentarier_id`) `count_table` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_parlamentarier_transparenz_last_all`
--
...
VIEW `v_parlamentarier_transparenz_last_all` AS select max(`parlamentarier_transparenz`.`stichdatum`) AS `max_stichdatum`,`parlamentarier_transparenz`.`id` AS `id`,`parlamentarier_transparenz`.`parlamentarier_id` AS `parlamentarier_id`,`parlamentarier_transparenz`.`stichdatum` AS `stichdatum`,`parlamentarier_transparenz`.`verguetung_transparent` AS `verguetung_transparent`,`parlamentarier_transparenz`.`notizen` AS `notizen`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`parlamentarier_transparenz`.`kontrolliert_visa` AS `kontrolliert_visa`,`parlamentarier_transparenz`.`kontrolliert_datum` AS `kontrolliert_datum`,`parlamentarier_transparenz`.`freigabe_visa` AS `freigabe_visa`,`parlamentarier_transparenz`.`freigabe_datum` AS `freigabe_datum`,`parlamentarier_transparenz`.`created_visa` AS `created_visa`,`parlamentarier_transparenz`.`created_date` AS `created_date`,`parlamentarier_transparenz`.`updated_visa` AS `updated_visa`,`parlamentarier_transparenz`.`updated_date` AS `updated_date`,`parlamentarier_transparenz`.`published` AS `published`,`parlamentarier_transparenz`.`created_date_unix` AS `created_date_unix`,`parlamentarier_transparenz`.`updated_date_unix` AS `updated_date_unix`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`parlamentarier_transparenz`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`parlamentarier_transparenz`.`freigabe_datum_unix` AS `freigabe_datum_unix` from `v_parlamentarier_transparenz` `parlamentarier_transparenz` group by `parlamentarier_transparenz`.`parlamentarier_id` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_parlamentarier_transparenz_last_published`
--
...
VIEW `v_parlamentarier_transparenz_last_published` AS select max(`parlamentarier_transparenz`.`stichdatum`) AS `max_stichdatum`,`parlamentarier_transparenz`.`id` AS `id`,`parlamentarier_transparenz`.`parlamentarier_id` AS `parlamentarier_id`,`parlamentarier_transparenz`.`stichdatum` AS `stichdatum`,`parlamentarier_transparenz`.`verguetung_transparent` AS `verguetung_transparent`,`parlamentarier_transparenz`.`notizen` AS `notizen`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`parlamentarier_transparenz`.`kontrolliert_visa` AS `kontrolliert_visa`,`parlamentarier_transparenz`.`kontrolliert_datum` AS `kontrolliert_datum`,`parlamentarier_transparenz`.`freigabe_visa` AS `freigabe_visa`,`parlamentarier_transparenz`.`freigabe_datum` AS `freigabe_datum`,`parlamentarier_transparenz`.`created_visa` AS `created_visa`,`parlamentarier_transparenz`.`created_date` AS `created_date`,`parlamentarier_transparenz`.`updated_visa` AS `updated_visa`,`parlamentarier_transparenz`.`updated_date` AS `updated_date`,`parlamentarier_transparenz`.`published` AS `published`,`parlamentarier_transparenz`.`created_date_unix` AS `created_date_unix`,`parlamentarier_transparenz`.`updated_date_unix` AS `updated_date_unix`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`parlamentarier_transparenz`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`parlamentarier_transparenz`.`freigabe_datum_unix` AS `freigabe_datum_unix` from `v_parlamentarier_transparenz` `parlamentarier_transparenz` where (`parlamentarier_transparenz`.`freigabe_datum` <= now()) group by `parlamentarier_transparenz`.`parlamentarier_id` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_parlamentarier_transparenz_last_stichdatum_all`
--
...
VIEW `v_parlamentarier_transparenz_last_stichdatum_all` AS select `parlamentarier_transparenz`.`id` AS `id`,`parlamentarier_transparenz`.`parlamentarier_id` AS `parlamentarier_id`,`parlamentarier_transparenz`.`stichdatum` AS `stichdatum`,`parlamentarier_transparenz`.`verguetung_transparent` AS `verguetung_transparent`,`parlamentarier_transparenz`.`notizen` AS `notizen`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`parlamentarier_transparenz`.`kontrolliert_visa` AS `kontrolliert_visa`,`parlamentarier_transparenz`.`kontrolliert_datum` AS `kontrolliert_datum`,`parlamentarier_transparenz`.`freigabe_visa` AS `freigabe_visa`,`parlamentarier_transparenz`.`freigabe_datum` AS `freigabe_datum`,`parlamentarier_transparenz`.`created_visa` AS `created_visa`,`parlamentarier_transparenz`.`created_date` AS `created_date`,`parlamentarier_transparenz`.`updated_visa` AS `updated_visa`,`parlamentarier_transparenz`.`updated_date` AS `updated_date`,`parlamentarier_transparenz`.`published` AS `published`,`parlamentarier_transparenz`.`created_date_unix` AS `created_date_unix`,`parlamentarier_transparenz`.`updated_date_unix` AS `updated_date_unix`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`parlamentarier_transparenz`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`parlamentarier_transparenz`.`freigabe_datum_unix` AS `freigabe_datum_unix` from `v_parlamentarier_transparenz` `parlamentarier_transparenz` where (`parlamentarier_transparenz`.`stichdatum` = (select max(`tpmax`.`stichdatum`) AS `max_stichdatum` from `parlamentarier_transparenz` `tpmax`)) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;

--
-- Final view structure for view `v_parlamentarier_transparenz_last_stichdatum_published`
--
...
VIEW `v_parlamentarier_transparenz_last_stichdatum_published` AS select `parlamentarier_transparenz`.`id` AS `id`,`parlamentarier_transparenz`.`parlamentarier_id` AS `parlamentarier_id`,`parlamentarier_transparenz`.`stichdatum` AS `stichdatum`,`parlamentarier_transparenz`.`verguetung_transparent` AS `verguetung_transparent`,`parlamentarier_transparenz`.`notizen` AS `notizen`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`parlamentarier_transparenz`.`kontrolliert_visa` AS `kontrolliert_visa`,`parlamentarier_transparenz`.`kontrolliert_datum` AS `kontrolliert_datum`,`parlamentarier_transparenz`.`freigabe_visa` AS `freigabe_visa`,`parlamentarier_transparenz`.`freigabe_datum` AS `freigabe_datum`,`parlamentarier_transparenz`.`created_visa` AS `created_visa`,`parlamentarier_transparenz`.`created_date` AS `created_date`,`parlamentarier_transparenz`.`updated_visa` AS `updated_visa`,`parlamentarier_transparenz`.`updated_date` AS `updated_date`,`parlamentarier_transparenz`.`published` AS `published`,`parlamentarier_transparenz`.`created_date_unix` AS `created_date_unix`,`parlamentarier_transparenz`.`updated_date_unix` AS `updated_date_unix`,`parlamentarier_transparenz`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`parlamentarier_transparenz`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`parlamentarier_transparenz`.`freigabe_datum_unix` AS `freigabe_datum_unix` from `v_parlamentarier_transparenz` `parlamentarier_transparenz` where ((`parlamentarier_transparenz`.`stichdatum` = (select max(`tpmax`.`stichdatum`) AS `max_stichdatum` from `parlamentarier_transparenz` `tpmax` where (`tpmax`.`freigabe_datum` <= now()))) and (`parlamentarier_transparenz`.`freigabe_datum` <= now())) ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_person_mandate` AS select `organisation`.`anzeige_name` AS `organisation_name`,`organisation`.`anzeige_name_de` AS `organisation_name_de`,`organisation`.`anzeige_name_fr` AS `organisation_name_fr`,`organisation`.`name` AS `name`,`organisation`.`name_de` AS `name_de`,`organisation`.`name_fr` AS `name_fr`,`organisation`.`name_it` AS `name_it`,`organisation`.`ort` AS `ort`,`organisation`.`land_id` AS `land_id`,`organisation`.`interessenraum_id` AS `interessenraum_id`,`organisation`.`rechtsform` AS `rechtsform`,`organisation`.`typ` AS `typ`,`organisation`.`vernehmlassung` AS `vernehmlassung`,`organisation`.`interessengruppe_id` AS `interessengruppe_id`,`organisation`.`interessengruppe_id` AS `interessengruppe1_id`,`organisation`.`interessengruppe2_id` AS `interessengruppe2_id`,`organisation`.`interessengruppe3_id` AS `interessengruppe3_id`,`organisation`.`homepage` AS `homepage`,`organisation`.`handelsregister_url` AS `handelsregister_url`,`organisation`.`twitter_name` AS `twitter_name`,`organisation`.`beschreibung` AS `organisation_beschreibung`,`organisation`.`adresse_strasse` AS `adresse_strasse`,`organisation`.`adresse_zusatz` AS `adresse_zusatz`,`organisation`.`adresse_plz` AS `adresse_plz`,`organisation`.`interessengruppe` AS `interessengruppe`,`organisation`.`interessengruppe_fr` AS `interessengruppe_fr`,`organisation`.`interessengruppe_branche` AS `interessengruppe_branche`,`organisation`.`interessengruppe_branche_id` AS `interessengruppe_branche_id`,`organisation`.`interessengruppe` AS `interessengruppe1`,`organisation`.`interessengruppe_fr` AS `interessengruppe1_fr`,`organisation`.`interessengruppe_branche` AS `interessengruppe1_branche`,`organisation`.`interessengruppe_branche_id` AS `interessengruppe1_branche_id`,`organisation`.`interessengruppe2` AS `interessengruppe2`,`organisation`.`interessengruppe2_fr` AS `interessengruppe2_fr`,`organisation`.`interessengruppe2_branche` AS `interessengruppe2_branche`,`organisation`.`interessengruppe2_branche_id` AS `interessengruppe2_branche_id`,`organisation`.`interessengruppe3` AS `interessengruppe3`,`organisation`.`interessengruppe3_fr` AS `interessengruppe3_fr`,`organisation`.`interessengruppe3_branche` AS `interessengruppe3_branche`,`organisation`.`interessengruppe3_branche_id` AS `interessengruppe3_branche_id`,`organisation`.`land` AS `land`,`organisation`.`interessenraum` AS `interessenraum`,`organisation`.`organisation_jahr_id` AS `organisation_jahr_id`,`organisation`.`jahr` AS `jahr`,`organisation`.`umsatz` AS `umsatz`,`organisation`.`gewinn` AS `gewinn`,`organisation`.`kapital` AS `kapital`,`organisation`.`mitarbeiter_weltweit` AS `mitarbeiter_weltweit`,`organisation`.`mitarbeiter_schweiz` AS `mitarbeiter_schweiz`,`organisation`.`geschaeftsbericht_url` AS `geschaeftsbericht_url`,`person`.`anzeige_name` AS `person_name`,`mandat`.`anzeige_name` AS `anzeige_name`,`mandat`.`id` AS `id`,`mandat`.`person_id` AS `person_id`,`mandat`.`organisation_id` AS `organisation_id`,`mandat`.`art` AS `art`,`mandat`.`funktion_im_gremium` AS `funktion_im_gremium`,`mandat`.`hauptberuflich` AS `hauptberuflich`,`mandat`.`beschreibung` AS `beschreibung`,`mandat`.`beschreibung_fr` AS `beschreibung_fr`,`mandat`.`quelle_url` AS `quelle_url`,`mandat`.`quelle_url_gueltig` AS `quelle_url_gueltig`,`mandat`.`quelle` AS `quelle`,`mandat`.`von` AS `von`,`mandat`.`bis` AS `bis`,`mandat`.`notizen` AS `notizen`,`mandat`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`mandat`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`mandat`.`kontrolliert_visa` AS `kontrolliert_visa`,`mandat`.`kontrolliert_datum` AS `kontrolliert_datum`,`mandat`.`autorisiert_visa` AS `autorisiert_visa`,`mandat`.`autorisiert_datum` AS `autorisiert_datum`,`mandat`.`freigabe_visa` AS `freigabe_visa`,`mandat`.`freigabe_datum` AS `freigabe_datum`,`mandat`.`created_visa` AS `created_visa`,`mandat`.`created_date` AS `created_date`,`mandat`.`updated_visa` AS `updated_visa`,`mandat`.`updated_date` AS `updated_date`,`mandat`.`aktiv` AS `aktiv`,`mandat`.`published` AS `published`,`mandat`.`bis_unix` AS `bis_unix`,`mandat`.`von_unix` AS `von_unix`,`mandat`.`created_date_unix` AS `created_date_unix`,`mandat`.`updated_date_unix` AS `updated_date_unix`,`mandat`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`mandat`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`mandat`.`freigabe_datum_unix` AS `freigabe_datum_unix`,`mandat`.`wirksamkeit` AS `wirksamkeit`,`mandat`.`wirksamkeit_index` AS `wirksamkeit_index`,`mandat`.`organisation_lobbyeinfluss` AS `organisation_lobbyeinfluss`,`mandat`.`refreshed_date` AS `refreshed_date`,`mandat_jahr`.`verguetung` AS `verguetung`,`mandat_jahr`.`jahr` AS `verguetung_jahr`,`mandat_jahr`.`beschreibung` AS `verguetung_beschreibung` from (((`v_person` `person` join `v_mandat` `mandat` on((`person`.`id` = `mandat`.`person_id`))) left join `v_mandat_jahr` `mandat_jahr` on((`mandat_jahr`.`id` = (select `mjn`.`id` from `v_mandat_jahr` `mjn` where ((`mjn`.`mandat_id` = `mandat`.`id`) and (`mjn`.`freigabe_datum` <= now())) order by `mjn`.`jahr` desc limit 1)))) join `v_organisation` `organisation` on((`mandat`.`organisation_id` = `organisation`.`id`))) order by `mandat`.`wirksamkeit`,`organisation`.`anzeige_name` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_person_simple` AS select concat(`person`.`nachname`,', ',`person`.`vorname`,ifnull(concat(' (',`person`.`namensunterscheidung`,')'),'')) AS `anzeige_name`,concat(`person`.`nachname`,', ',`person`.`vorname`,ifnull(concat(' (',`person`.`namensunterscheidung`,')'),'')) AS `anzeige_name_de`,concat(`person`.`nachname`,', ',`person`.`vorname`,ifnull(concat(' (',`person`.`namensunterscheidung`,')'),'')) AS `anzeige_name_fr`,concat(`person`.`vorname`,' ',`person`.`nachname`,ifnull(concat(' (',`person`.`namensunterscheidung`,')'),'')) AS `name`,concat(`person`.`vorname`,' ',`person`.`nachname`,ifnull(concat(' (',`person`.`namensunterscheidung`,')'),'')) AS `name_de`,concat(`person`.`vorname`,' ',`person`.`nachname`,ifnull(concat(' (',`person`.`namensunterscheidung`,')'),'')) AS `name_fr`,`person`.`id` AS `id`,`person`.`nachname` AS `nachname`,`person`.`vorname` AS `vorname`,`person`.`zweiter_vorname` AS `zweiter_vorname`,`person`.`namensunterscheidung` AS `namensunterscheidung`,`person`.`beschreibung_de` AS `beschreibung_de`,`person`.`beschreibung_fr` AS `beschreibung_fr`,`person`.`parlamentarier_kommissionen` AS `parlamentarier_kommissionen`,`person`.`beruf` AS `beruf`,`person`.`beruf_fr` AS `beruf_fr`,`person`.`beruf_interessengruppe_id` AS `beruf_interessengruppe_id`,`person`.`partei_id` AS `partei_id`,`person`.`geschlecht` AS `geschlecht`,`person`.`arbeitssprache` AS `arbeitssprache`,`person`.`email` AS `email`,`person`.`homepage` AS `homepage`,`person`.`twitter_name` AS `twitter_name`,`person`.`linkedin_profil_url` AS `linkedin_profil_url`,`person`.`xing_profil_name` AS `xing_profil_name`,`person`.`facebook_name` AS `facebook_name`,`person`.`telephon_1` AS `telephon_1`,`person`.`telephon_2` AS `telephon_2`,`person`.`erfasst` AS `erfasst`,`person`.`notizen` AS `notizen`,`person`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`person`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`person`.`kontrolliert_visa` AS `kontrolliert_visa`,`person`.`kontrolliert_datum` AS `kontrolliert_datum`,`person`.`autorisierung_verschickt_visa` AS `autorisierung_verschickt_visa`,`person`.`autorisierung_verschickt_datum` AS `autorisierung_verschickt_datum`,`person`.`autorisiert_visa` AS `autorisiert_visa`,`person`.`autorisiert_datum` AS `autorisiert_datum`,`person`.`freigabe_visa` AS `freigabe_visa`,`person`.`freigabe_datum` AS `freigabe_datum`,`person`.`created_visa` AS `created_visa`,`person`.`created_date` AS `created_date`,`person`.`updated_visa` AS `updated_visa`,`person`.`updated_date` AS `updated_date`,ifnull((`person`.`freigabe_datum` <= now()),FALSE) AS `published`,unix_timestamp(`person`.`created_date`) AS `created_date_unix`,unix_timestamp(`person`.`updated_date`) AS `updated_date_unix`,unix_timestamp(`person`.`eingabe_abgeschlossen_datum`) AS `eingabe_abgeschlossen_datum_unix`,unix_timestamp(`person`.`kontrolliert_datum`) AS `kontrolliert_datum_unix`,unix_timestamp(`person`.`freigabe_datum`) AS `freigabe_datum_unix` from `person` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
...
VIEW `v_zutrittsberechtigung_mandate` AS select `zutrittsberechtigung`.`parlamentarier_id` AS `parlamentarier_id`,`organisation`.`anzeige_name` AS `organisation_name`,`organisation`.`anzeige_name_de` AS `organisation_name_de`,`organisation`.`anzeige_name_fr` AS `organisation_name_fr`,`organisation`.`name` AS `name`,`organisation`.`name_de` AS `name_de`,`organisation`.`name_fr` AS `name_fr`,`organisation`.`name_it` AS `name_it`,`organisation`.`ort` AS `ort`,`organisation`.`land_id` AS `land_id`,`organisation`.`interessenraum_id` AS `interessenraum_id`,`organisation`.`rechtsform` AS `rechtsform`,`organisation`.`typ` AS `typ`,`organisation`.`vernehmlassung` AS `vernehmlassung`,`organisation`.`interessengruppe_id` AS `interessengruppe_id`,`organisation`.`interessengruppe_id` AS `interessengruppe1_id`,`organisation`.`interessengruppe2_id` AS `interessengruppe2_id`,`organisation`.`interessengruppe3_id` AS `interessengruppe3_id`,`organisation`.`homepage` AS `homepage`,`organisation`.`handelsregister_url` AS `handelsregister_url`,`organisation`.`twitter_name` AS `twitter_name`,`organisation`.`beschreibung` AS `organisation_beschreibung`,`organisation`.`adresse_strasse` AS `adresse_strasse`,`organisation`.`adresse_zusatz` AS `adresse_zusatz`,`organisation`.`adresse_plz` AS `adresse_plz`,`organisation`.`interessengruppe` AS `interessengruppe`,`organisation`.`interessengruppe_branche` AS `interessengruppe_branche`,`organisation`.`interessengruppe_branche_id` AS `interessengruppe_branche_id`,`organisation`.`interessengruppe` AS `interessengruppe1`,`organisation`.`interessengruppe_branche` AS `interessengruppe1_branche`,`organisation`.`interessengruppe_branche_id` AS `interessengruppe1_branche_id`,`organisation`.`interessengruppe2` AS `interessengruppe2`,`organisation`.`interessengruppe2_branche` AS `interessengruppe2_branche`,`organisation`.`interessengruppe2_branche_id` AS `interessengruppe2_branche_id`,`organisation`.`interessengruppe3` AS `interessengruppe3`,`organisation`.`interessengruppe3_branche` AS `interessengruppe3_branche`,`organisation`.`interessengruppe3_branche_id` AS `interessengruppe3_branche_id`,`organisation`.`land` AS `land`,`organisation`.`interessenraum` AS `interessenraum`,`organisation`.`organisation_jahr_id` AS `organisation_jahr_id`,`organisation`.`jahr` AS `jahr`,`organisation`.`umsatz` AS `umsatz`,`organisation`.`gewinn` AS `gewinn`,`organisation`.`kapital` AS `kapital`,`organisation`.`mitarbeiter_weltweit` AS `mitarbeiter_weltweit`,`organisation`.`mitarbeiter_schweiz` AS `mitarbeiter_schweiz`,`organisation`.`geschaeftsbericht_url` AS `geschaeftsbericht_url`,`person`.`anzeige_name` AS `zutrittsberechtigung_name`,`zutrittsberechtigung`.`funktion` AS `funktion`,`zutrittsberechtigung`.`funktion_fr` AS `funktion_fr`,`mandat`.`anzeige_name` AS `anzeige_name`,`mandat`.`id` AS `id`,`mandat`.`person_id` AS `person_id`,`mandat`.`organisation_id` AS `organisation_id`,`mandat`.`art` AS `art`,`mandat`.`funktion_im_gremium` AS `funktion_im_gremium`,`mandat`.`hauptberuflich` AS `hauptberuflich`,`mandat`.`beschreibung` AS `beschreibung`,`mandat`.`beschreibung_fr` AS `beschreibung_fr`,`mandat`.`quelle_url` AS `quelle_url`,`mandat`.`quelle_url_gueltig` AS `quelle_url_gueltig`,`mandat`.`quelle` AS `quelle`,`mandat`.`von` AS `von`,`mandat`.`bis` AS `bis`,`mandat`.`notizen` AS `notizen`,`mandat`.`eingabe_abgeschlossen_visa` AS `eingabe_abgeschlossen_visa`,`mandat`.`eingabe_abgeschlossen_datum` AS `eingabe_abgeschlossen_datum`,`mandat`.`kontrolliert_visa` AS `kontrolliert_visa`,`mandat`.`kontrolliert_datum` AS `kontrolliert_datum`,`mandat`.`autorisiert_visa` AS `autorisiert_visa`,`mandat`.`autorisiert_datum` AS `autorisiert_datum`,`mandat`.`freigabe_visa` AS `freigabe_visa`,`mandat`.`freigabe_datum` AS `freigabe_datum`,`mandat`.`created_visa` AS `created_visa`,`mandat`.`created_date` AS `created_date`,`mandat`.`updated_visa` AS `updated_visa`,`mandat`.`updated_date` AS `updated_date`,`mandat`.`aktiv` AS `aktiv`,`mandat`.`published` AS `published`,`mandat`.`bis_unix` AS `bis_unix`,`mandat`.`von_unix` AS `von_unix`,`mandat`.`created_date_unix` AS `created_date_unix`,`mandat`.`updated_date_unix` AS `updated_date_unix`,`mandat`.`eingabe_abgeschlossen_datum_unix` AS `eingabe_abgeschlossen_datum_unix`,`mandat`.`kontrolliert_datum_unix` AS `kontrolliert_datum_unix`,`mandat`.`freigabe_datum_unix` AS `freigabe_datum_unix`,`mandat`.`wirksamkeit` AS `wirksamkeit`,`mandat`.`wirksamkeit_index` AS `wirksamkeit_index`,`mandat`.`organisation_lobbyeinfluss` AS `organisation_lobbyeinfluss`,`mandat`.`refreshed_date` AS `refreshed_date`,`mandat_jahr`.`verguetung` AS `verguetung`,`mandat_jahr`.`jahr` AS `verguetung_jahr`,`mandat_jahr`.`beschreibung` AS `verguetung_beschreibung` from ((((`v_zutrittsberechtigung_simple` `zutrittsberechtigung` join `v_mandat` `mandat` on((`zutrittsberechtigung`.`person_id` = `mandat`.`person_id`))) left join `v_mandat_jahr` `mandat_jahr` on((`mandat_jahr`.`id` = (select `mjn`.`id` from `v_mandat_jahr` `mjn` where ((`mjn`.`mandat_id` = `mandat`.`id`) and (`mjn`.`freigabe_datum` <= now())) order by `mjn`.`jahr` desc limit 1)))) join `v_organisation` `organisation` on((`mandat`.`organisation_id` = `organisation`.`id`))) join `v_person` `person` on((`person`.`id` = `zutrittsberechtigung`.`person_id`))) order by `mandat`.`wirksamkeit`,`organisation`.`anzeige_name` ;
SET character_set_client      = @saved_cs_client ;
SET character_set_results     = @saved_cs_results ;
SET collation_connection      = @saved_col_connection ;
