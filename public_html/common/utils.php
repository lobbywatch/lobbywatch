...
//       print_r($object);
    ...
    // TODO 'name_fr' => $ot->organisation->organisationIdentification->organisationName,
        ...
        'bfs_gemeinde_id' => !empty($address->municipalityId) && is_numeric($address->municipalityId) ? +$address->municipalityId : null,
...
//       print_r($object);
    ...
    // TODO 'name_fr' => $ot->organisation->organisationIdentification->organisationName, TODO
        ...
        'bfs_gemeinde_id' => !empty($ot->legalSeatId) && is_numeric($ot->legalSeatId) ? +$ot->legalSeatId : null,
        'land_iso2' => 'CH' ?? null,
