 ...
 */
    ...
    class zugangsberechtigungPage extends Page
    {
        ...
        public function zugangsberechtigungGrid_OnGetCustomTemplate($part, $mode, &$result)
        {
        ...
        protected function CreateGrid()
        {
            ...
            $result->SetHighlightRowAtHover(false);
            $result->SetWidth('');
            $this->OnGetCustomTemplate->AddListener('zugangsberechtigungGrid' . '_OnGetCustomTemplate', $this);
            $this->CreateGridSearchControl($result);
            $this->CreateGridAdvancedSearchControl($result);
            $this->AddOperationsColumns($result);
            $this->AddFieldColumns($result);
