 ...
 */
    ...
    class fraktion_fraktion_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Fraktion Log');
            $this->SetMenuLabel('Fraktion Log');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_fraktion_fraktion_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_fraktion_fraktion_log_snapshot_id_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_fraktion_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
        ...
        {
            logTableExtendedDrawRow('fraktion_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class fraktion_parteiPage extends DetailPage
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('abkuerzung', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_partei_fraktion_id_search', 'id', 'abkuerzung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class fraktion_parlamentarierPage extends DetailPage
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('abkuerzung', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_parlamentarier_rat_id_search', 'id', 'abkuerzung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('abkuerzung', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_parlamentarier_kanton_id_search', 'id', 'abkuerzung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('abkuerzung', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_parlamentarier_partei_id_search', 'id', 'abkuerzung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('abkuerzung', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_parlamentarier_fraktion_id_search', 'id', 'abkuerzung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_parlamentarier_beruf_interessengruppe_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_fraktion_parlamentarier_militaerischer_grad_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class fraktionPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('fraktion.fraktion_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for fraktion_fraktion_log detail
            //
            $column = new DetailColumn(array('id'), 'fraktion.fraktion_log', 'fraktion_fraktion_log_handler', $this->dataset, 'Fraktion Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserPermissionsForPage('fraktion.partei')->HasViewGrant() && $withDetails)
            {
            //
            ...
            if (GetCurrentUserPermissionsForPage('fraktion.parlamentarier')->HasViewGrant() && $withDetails)
            {
            //
        ...
        protected function doRegisterHandlers() {
            $detailPage = new fraktion_fraktion_logPage('fraktion_fraktion_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('fraktion.fraktion_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('fraktion.fraktion_log'));
            $detailPage->SetHttpHandlerName('fraktion_fraktion_log_handler');
            $handler = new PageHTTPHandler('fraktion_fraktion_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            
            $detailPage = new fraktion_parteiPage('fraktion_partei', $this, array('fraktion_id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('fraktion.partei'), 'UTF-8');
            ...
            $detailPage = new fraktion_parlamentarierPage('fraktion_parlamentarier', $this, array('fraktion_id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('fraktion.parlamentarier'), 'UTF-8');
    ...
    try
    {
        $Page = new fraktionPage("fraktion", "fraktion.php", GetCurrentUserPermissionsForPage("fraktion"), 'UTF-8');
