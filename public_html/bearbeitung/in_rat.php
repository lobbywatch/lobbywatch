 ...
 */
    ...
    class in_rat_in_rat_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('In Rat Log');
            $this->SetMenuLabel('In Rat Log');
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new IntegerField('vorgaenger_parlamentarier_id'),
                    ...
                    new StringField('in_rat_parlamentarier_rat_unique'),
            ...
            $this->dataset->AddLookupField('vorgaenger_parlamentarier_id', 'v_parlamentarier_simple', new IntegerField('id'), new StringField('anzeige_name', false, false, false, false, 'vorgaenger_parlamentarier_id_anzeige_name', 'vorgaenger_parlamentarier_id_anzeige_name_v_parlamentarier_simple'), 'vorgaenger_parlamentarier_id_anzeige_name_v_parlamentarier_simple');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'vorgaenger_parlamentarier_id', 'vorgaenger_parlamentarier_id_anzeige_name', 'Vorgaenger Parlamentarier Id'),
                ...
                new FilterColumn($this->dataset, 'in_rat_parlamentarier_rat_unique', 'in_rat_parlamentarier_rat_unique', 'In Rat Parlamentarier Rat Unique'),
        ...
        protected function setupColumnFilter(ColumnFilter $columnFilter)
        {
            $columnFilter
                ...
                ->setOptionsFor('vorgaenger_parlamentarier_id')
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_parlamentarier_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('parlamentarier_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_parlamentarier_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_rat_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('rat_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_rat_id_search');
            ...
            $main_editor = new DynamicCombobox('vorgaenger_parlamentarier_id_edit', $this->CreateLinkBuilder());
            $main_editor->setAllowClear(true);
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_vorgaenger_parlamentarier_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('vorgaenger_parlamentarier_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_vorgaenger_parlamentarier_id_search');
            
            $filterBuilder->addColumn(
                $columns['vorgaenger_parlamentarier_id'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_in_rat_log_snapshot_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Fremdschlüssel des Rates');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            // View column for anzeige_name field
            //
            $column = new TextViewColumn('vorgaenger_parlamentarier_id', 'vorgaenger_parlamentarier_id_anzeige_name', 'Vorgaenger Parlamentarier Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Vorgänger des Parlamentariers bei Nachgerutschten (Fremdschlüssel)');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Funktion des Parlamentariers im Rat');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Beginn der Ratszugehörigkeit, leer (NULL) = unbekannt');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetDateTimeFormat('d.m.Y');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Ende der Ratszugehörigkeit, leer (NULL) = aktuell gültig, nicht leer = historischer Eintrag');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('log_id', 'ASC');
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_in_rat_log_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_in_rat_log_rat_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_in_rat_log_vorgaenger_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_in_rat_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        {
            logTableExtendedDrawRow('in_rat_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class in_ratPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('In Rat');
            $this->SetMenuLabel('<span class="relation">In Rat</span>');
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('updated_visa'),
                    new DateTimeField('updated_date', true),
                    new StringField('in_rat_parlamentarier_rat_unique', true)
                )
            );
            $this->dataset->AddLookupField('parlamentarier_id', 'v_parlamentarier_simple', new IntegerField('id'), new StringField('anzeige_name', false, false, false, false, 'parlamentarier_id_anzeige_name', 'parlamentarier_id_anzeige_name_v_parlamentarier_simple'), 'parlamentarier_id_anzeige_name_v_parlamentarier_simple');
            $this->dataset->AddLookupField('rat_id', 'v_rat', new IntegerField('id'), new StringField('anzeige_name', false, false, false, false, 'rat_id_anzeige_name', 'rat_id_anzeige_name_v_rat'), 'rat_id_anzeige_name_v_rat');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_rat_parlamentarier_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('parlamentarier_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_parlamentarier_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_rat_rat_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('rat_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_rat_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_rat_vorgaenger_parlamentarier_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('vorgaenger_parlamentarier_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_rat_vorgaenger_parlamentarier_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('in_rat.in_rat_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for in_rat_in_rat_log detail
            //
            $column = new DetailColumn(array('id'), 'in_rat.in_rat_log', 'in_rat_in_rat_log_handler', $this->dataset, 'In Rat Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            $column = new TextViewColumn('rat_id', 'rat_id_anzeige_name', 'Rat Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setHrefTemplate('rat.php?operation=view&pk0=%rat_id%');
            $column->setTarget('_self');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Fremdschlüssel des Rates');
            $column->SetFixedWidth(null);
            ...
            $column = new TextViewColumn('vorgaenger_parlamentarier_id', 'vorgaenger_parlamentarier_id_anzeige_name', 'Vorgaenger Parlamentarier Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setHrefTemplate('parlamentarier.php?operation=view&pk0=%vorgaenger_parlamentarier_id%');
            $column->setTarget('');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Vorgänger des Parlamentariers bei Nachgerutschten (Fremdschlüssel)');
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Parlamentarier Id', 'parlamentarier_id', 'parlamentarier_id_anzeige_name', 'edit_in_rat_parlamentarier_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Rat Id', 'rat_id', 'rat_id_anzeige_name', 'edit_in_rat_rat_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for vorgaenger_parlamentarier_id field
            //
            $editor = new DynamicCombobox('vorgaenger_parlamentarier_id_edit', $this->CreateLinkBuilder());
            $editor->setAllowClear(true);
            $editor->setMinimumInputLength(0);
            $lookupDataset = new TableDataset(
                MyPDOConnectionFactory::getInstance(),
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Vorgaenger Parlamentarier Id', 'vorgaenger_parlamentarier_id', 'vorgaenger_parlamentarier_id_anzeige_name', 'edit_in_rat_vorgaenger_parlamentarier_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Parlamentarier Id', 'parlamentarier_id', 'parlamentarier_id_anzeige_name', 'multi_edit_in_rat_parlamentarier_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Rat Id', 'rat_id', 'rat_id_anzeige_name', 'multi_edit_in_rat_rat_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Vorgaenger Parlamentarier Id', 'vorgaenger_parlamentarier_id', 'vorgaenger_parlamentarier_id_anzeige_name', 'multi_edit_in_rat_vorgaenger_parlamentarier_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Parlamentarier Id', 'parlamentarier_id', 'parlamentarier_id_anzeige_name', 'insert_in_rat_parlamentarier_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Rat Id', 'rat_id', 'rat_id_anzeige_name', 'insert_in_rat_rat_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Vorgaenger Parlamentarier Id', 'vorgaenger_parlamentarier_id', 'vorgaenger_parlamentarier_id_anzeige_name', 'insert_in_rat_vorgaenger_parlamentarier_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'anzeige_name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new in_rat_in_rat_logPage('in_rat_in_rat_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('in_rat.in_rat_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('in_rat.in_rat_log'));
            $detailPage->SetHttpHandlerName('in_rat_in_rat_log_handler');
            $handler = new PageHTTPHandler('in_rat_in_rat_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_in_rat_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_in_rat_rat_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_in_rat_vorgaenger_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_rat_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_in_rat_vorgaenger_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_in_rat_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_in_rat_rat_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_in_rat_vorgaenger_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_in_rat_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_in_rat_rat_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_in_rat_vorgaenger_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
       
        protected function doCustomRenderColumn($fieldName, $fieldData, $rowData, &$customText, &$handled)
        { 
            customOnCustomRenderColumn('in_rat', $fieldName, $fieldData, $rowData, $customText, $handled);
        }
        ...
        protected function doExtendedCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles, &$rowClasses, &$cellClasses)
        {
            customDrawRow('in_rat', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    try
    {
        $Page = new in_ratPage("in_rat", "in_rat.php", GetCurrentUserPermissionsForPage("in_rat"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("in_rat"));
