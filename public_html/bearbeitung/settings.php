 ...
 */
    ...
    class settings_settings_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Settings Log');
            $this->SetMenuLabel('Settings Log');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'category_id', 'category_id', 'Category Id'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('category_id_edit');
            ...
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_settings_settings_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_settings_settings_log_snapshot_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('category_id', 'category_id', 'Category Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator('\'');
            $column->setDecimalSeparator('');
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_settings_settings_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
        ...
        {
            logTableExtendedDrawRow('settings_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class settingsPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('settings.settings_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for settings_settings_log detail
            //
            $column = new DetailColumn(array('id'), 'settings.settings_log', 'settings_settings_log_handler', $this->dataset, 'Settings Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new settings_settings_logPage('settings_settings_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('settings.settings_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('settings.settings_log'));
            $detailPage->SetHttpHandlerName('settings_settings_log_handler');
            $handler = new PageHTTPHandler('settings_settings_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new settingsPage("settings", "settings.php", GetCurrentUserPermissionsForPage("settings"), 'UTF-8');
