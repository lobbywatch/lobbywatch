 ...
 */
    ...
    class settingsPage extends Page
    {
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('category_id', $this->RenderText('Category'), $lookupDataset, 'id', 'name', false, 8));
