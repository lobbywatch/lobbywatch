 ...
 */
    ...
    class in_kommission_in_kommission_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('In Kommission Log');
            $this->SetMenuLabel('In Kommission Log');
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('in_kommission_parlamentarier_kommission_funktion_unique'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_in_kommission_in_kommission_log_parlamentarier_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('parlamentarier_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_kommission_in_kommission_log_parlamentarier_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_kommission_in_kommission_log_kommission_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('kommission_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_kommission_in_kommission_log_kommission_id_search');
            ...
            $main_editor->addChoice('co-praesident', 'co-praesident');
            $main_editor->SetAllowNullValue(false);
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_in_kommission_in_kommission_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_in_kommission_in_kommission_log_snapshot_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('committeeFunctionName von ws.parlament.ch');
            $grid->AddViewColumn($column);
            //
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_in_kommission_in_kommission_log_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_in_kommission_in_kommission_log_kommission_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_in_kommission_in_kommission_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        {
            logTableExtendedDrawRow('in_kommission_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class in_kommissionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('updated_visa'),
                    new DateTimeField('updated_date', true),
                    new StringField('in_kommission_parlamentarier_kommission_funktion_unique', true)
                )
            );
            $this->dataset->AddLookupField('parlamentarier_id', 'v_parlamentarier_simple', new IntegerField('id'), new StringField('anzeige_name', false, false, false, false, 'parlamentarier_id_anzeige_name', 'parlamentarier_id_anzeige_name_v_parlamentarier_simple'), 'parlamentarier_id_anzeige_name_v_parlamentarier_simple');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('in_kommission.in_kommission_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for in_kommission_in_kommission_log detail
            //
            $column = new DetailColumn(array('id'), 'in_kommission.in_kommission_log', 'in_kommission_in_kommission_log_handler', $this->dataset, 'In Kommission Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new in_kommission_in_kommission_logPage('in_kommission_in_kommission_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('in_kommission.in_kommission_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('in_kommission.in_kommission_log'));
            $detailPage->SetHttpHandlerName('in_kommission_in_kommission_log_handler');
            $handler = new PageHTTPHandler('in_kommission_in_kommission_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_in_kommission_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_in_kommission_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name_mixed', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_in_kommission_kommission_id_search', 'id', 'anzeige_name_mixed', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_in_kommission_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_in_kommission_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
