    ...
    class interessenbindungPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('interessenbindungssearch', $this->dataset,
                array('id', 'beschreibung', 'status', 'parlamentarier_id_nachname', 'branche_id_name', 'interessengruppe_id_bezeichnung', 'lobbyorganisation_id_name', 'created_visa', 'created_date', 'updated_visa', 'updated_date'),
                array($this->RenderText('Id'), $this->RenderText('Beschreibung'), $this->RenderText('Status'), $this->RenderText('Parlamentarier Id'), $this->RenderText('Branche Id'), $this->RenderText('Interessengruppe Id'), $this->RenderText('Lobbyorganisation Id'), $this->RenderText('Created Visa'), $this->RenderText('Created Date'), $this->RenderText('Updated Visa'), $this->RenderText('Updated Date')),
                array(
        ...
        public function GetModalGridEditingHandler() { return 'interessenbindung_inline_edit'; }
        ...
        public function GetModalGridCopyHandler() { return 'interessenbindung_inline_edit'; }
