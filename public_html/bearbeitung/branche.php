 ...
 */
    ...
    class branche_interessengruppePage extends DetailPage
    {
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_branche_interessengruppe_branche_id_search', 'id', 'name', null, 20);
    ...
    class branche_branche_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Branche Log');
            $this->SetMenuLabel('Branche Log');
            ...
            $this->dataset->AddLookupField('kommission2_id', 'v_kommission', new IntegerField('id'), new StringField('anzeige_name', false, false, false, false, 'kommission2_id_anzeige_name', 'kommission2_id_anzeige_name_v_kommission'), 'kommission2_id_anzeige_name_v_kommission');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'name', 'name', 'Name'),
                new FilterColumn($this->dataset, 'name_fr', 'name_fr', 'Name Fr'),
                new FilterColumn($this->dataset, 'kommission_id', 'kommission_id_anzeige_name', 'Kommission Id'),
                new FilterColumn($this->dataset, 'kommission2_id', 'kommission2_id_anzeige_name', 'Kommission2 Id'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['symbol_abs'])
                ->addColumn($columns['symbol_rel'])
                ->addColumn($columns['symbol_klein_rel'])
                ->addColumn($columns['symbol_dateiname_wo_ext'])
                ->addColumn($columns['symbol_dateierweiterung'])
                ->addColumn($columns['symbol_dateiname'])
                ->addColumn($columns['symbol_mime_type'])
                ->addColumn($columns['wikipedia'])
                ->addColumn($columns['wikidata_qid'])
                ->addColumn($columns['notizen'])
                ->addColumn($columns['eingabe_abgeschlossen_visa'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_branche_branche_log_kommission_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('kommission_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_branche_branche_log_kommission_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_branche_branche_log_kommission2_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('kommission2_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_branche_branche_log_kommission2_id_search');
            ...
            $main_editor = new TextEdit('symbol_abs');
            ...
            $main_editor = new TextEdit('symbol_rel');
            ...
            $main_editor = new TextEdit('symbol_klein_rel');
            
            $filterBuilder->addColumn(
                $columns['symbol_klein_rel'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('symbol_dateiname_wo_ext');
            
            $filterBuilder->addColumn(
                $columns['symbol_dateiname_wo_ext'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('symbol_dateierweiterung_edit');
            $main_editor->SetMaxLength(15);
            
            $filterBuilder->addColumn(
                $columns['symbol_dateierweiterung'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('symbol_dateiname');
            
            $filterBuilder->addColumn(
                $columns['symbol_dateiname'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('symbol_mime_type_edit');
            $main_editor->SetMaxLength(100);
            
            $filterBuilder->addColumn(
                $columns['symbol_mime_type'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_branche_branche_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_branche_branche_log_snapshot_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('kommission_id', 'kommission_id_anzeige_name', 'Kommission Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            ...
            // View column for anzeige_name field
            //
            $column = new TextViewColumn('kommission2_id', 'kommission2_id_anzeige_name', 'Kommission2 Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('Technischer Name für Branche. Keine Sonderzeichen sind erlaubt. Wird z.B. für das finden des Branchensymboles gebraucht.');
            $grid->AddViewColumn($column);
            //
            // View column for beschreibung field
            //
            ...
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('Symbolbild (Icon) der Branche, absoluter Pfad');
            $grid->AddViewColumn($column);
            //
            ...
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('Symbolbilddateiname ohne Erweiterung');
            $grid->AddViewColumn($column);
            //
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('Dateierweiterung des Symbolbildes');
            $grid->AddViewColumn($column);
            //
            ...
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('Symbolbilddateiname mit Erweiterung');
            $grid->AddViewColumn($column);
            //
            ...
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('MIME Type des Symbolbildes');
            $grid->AddViewColumn($column);
            //
            // View column for wikipedia field
            //
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_branche_branche_log_kommission_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_branche_branche_log_kommission2_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_branche_branche_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        protected function doExtendedCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles, &$rowClasses, &$cellClasses)
        {
            logTableExtendedDrawRow('branche_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class branchePage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('branche.interessengruppe')->HasViewGrant() && $withDetails)
            {
            //
            ...
            $grid->AddViewColumn($column);
            if (GetCurrentUserPermissionsForPage('branche.branche_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for branche_branche_log detail
            //
            $column = new DetailColumn(array('id'), 'branche.branche_log', 'branche_branche_log_handler', $this->dataset, 'Branche Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new branche_interessengruppePage('branche_interessengruppe', $this, array('branche_id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('branche.interessengruppe'), 'UTF-8');
            ...
            $detailPage = new branche_branche_logPage('branche_branche_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('branche.branche_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('branche.branche_log'));
            $detailPage->SetHttpHandlerName('branche_branche_log_handler');
            $handler = new PageHTTPHandler('branche_branche_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name_mixed', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_branche_kommission_id_search', 'id', 'anzeige_name_mixed', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name_mixed', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_branche_kommission2_id_search', 'id', 'anzeige_name_mixed', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new branchePage("branche", "branche.php", GetCurrentUserPermissionsForPage("branche"), 'UTF-8');
