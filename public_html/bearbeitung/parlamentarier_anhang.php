 ...
 */
    ...
    class parlamentarier_anhangPage extends Page
    {
        ...
        public function GetPageList()
        {
            ...
            if (GetCurrentUserGrantForDataSource('parlamentarier_anhang')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('Parlamentarier Anhang'), 'parlamentarier_anhang.php', $this->RenderText('Parlamentarier Anhang'), $currentPageCaption == $this->RenderText('Parlamentarier Anhang')));
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('parlamentarier_anhangssearch', $this->dataset,
                array('id', 'parlamentarier_id', 'datei', 'beschreibung', 'created_visa', 'created_date', 'updated_visa', 'updated_date'),
                array($this->RenderText('Id'), $this->RenderText('Parlamentarier Id'), $this->RenderText('Datei'), $this->RenderText('Beschreibung'), $this->RenderText('Created Visa'), $this->RenderText('Created Date'), $this->RenderText('Updated Visa'), $this->RenderText('Updated Date')),
                array(
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('datei_handler');
        ...
        public function GetModalGridDeleteHandler() { return 'parlamentarier_anhang_modal_delete'; }
        ...
        protected function CreateGrid()
        {
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'datei_handler', $column);
