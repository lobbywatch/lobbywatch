...
function fillZutrittsberechtigterEmail($i) {
  ...
  if (isset($zbList[$i])) {
    ...
    $res = array(
        ...
        'EmailText' => $state . '<p>' . $zbList[$i]['anrede'] . '</p>' .  $emailIntroZb[$i] . '<p>' . (isset($zbList[$i]['funktion']) ? '<br><b>Funktion</b>: ' . $zbList[$i]['funktion'] . '' : '') . (isset($zbList[$i]['beruf']) ? '<br><b>Beruf</b>: ' . $zbList[$i]['beruf'] . '' : ''). '</p><p><b>Ihre Mandate</b>:</p><ul>' . $zbList[$i]['mandate'] . '</ul>' .
        $emailEndZb[$i],
    ...
    DisplayTemplateSimple('custom_templates/parlamentarier_preview_page.tpl',
      ...
      array(
        ...
        'Parlamentarier' => array(
          ...
          'EmailText' => $state . '<p>' . $rowData['anrede'] . '</p>' . $emailIntroParlam . (isset($rowData['beruf']) ? '<p><b>Beruf</b>: ' . $rowData['beruf'] . '</p>' : '') . '<p><b>Ihre Interessenbindungen</b>:</p><ul>' . $rowData['interessenbindungen_for_email'] . '</ul>' .
