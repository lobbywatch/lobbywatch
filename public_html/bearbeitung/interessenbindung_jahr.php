 ...
 */
    ...
    class uv_interessenbindung_jahr_interessenbindung_jahr_logPage extends DetailPage
    {
        ...
        {
            $this->SetTitle('Interessenbindungsvergütungen Log');
            $this->SetMenuLabel('Interessenbindungsvergütungen Log');
    ...
    class uv_interessenbindung_jahrPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new DetailColumn(array('id'), 'uv_interessenbindung_jahr.interessenbindung_jahr_log', 'uv_interessenbindung_jahr_interessenbindung_jahr_log_handler', $this->dataset, 'Interessenbindungsvergütungen Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_uv_interessenbindung_jahr_interessenbindung_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_uv_interessenbindung_jahr_interessenbindung_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_uv_interessenbindung_jahr_interessenbindung_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_mixed', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_uv_interessenbindung_jahr_interessenbindung_organisation_id_search', 'id', 'anzeige_mixed', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_uv_interessenbindung_jahr_interessenbindung_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_uv_interessenbindung_jahr_interessenbindung_parlamentarier_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_mixed', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_uv_interessenbindung_jahr_interessenbindung_organisation_id_search', 'id', 'anzeige_mixed', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_uv_interessenbindung_jahr_interessenbindung_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
