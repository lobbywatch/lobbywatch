...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => '<span class="relation">Interessenbindung (Parlam.)</span>', 'short_caption' => 'Interessenbindung', 'filename' => 'interessenbindung.php', 'name' => 'interessenbindung');
    $result[] = array('caption' => '<span class="relation">Mandat (Zutrittsbe.)</span>', 'short_caption' => 'Mandat', 'filename' => 'mandat.php', 'name' => 'mandat');
