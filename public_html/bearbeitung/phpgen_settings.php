...
function generatedGetPageInfos() // Afterburned
{
    ...
    $result[] = array('caption' => '<span class="relation" title="Interessenbindungen der Parlamentarier">Parlamentarier Vergütungstransparenz</span>', 'short_caption' => 'Parlamentarier Vergütungstransparenz', 'filename' => 'parlamentarier_transparenz.php', 'name' => 'parlamentarier_transparenz', 'group_name' => '<span class="entity-menu important-entity-menu">Subjekte</span>', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => '<span class="relation" title="Interessenbindungen der Parlamentarier">Intereressenbindungen von NR/SR</span>', 'short_caption' => 'Interessenbindung', 'filename' => 'interessenbindung.php', 'name' => 'uv_interessenbindung', 'group_name' => '<span class="releation-menu important-relation-menu">Verbindungen</span>', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Interessenbindungsvergütungen', 'short_caption' => 'Interessenbindungsvergütungen', 'filename' => 'interessenbindung_jahr.php', 'name' => 'uv_interessenbindung_jahr', 'group_name' => '<span class="releation-menu important-relation-menu">Verbindungen</span>', 'add_separator' => false, 'description' => '');
