...
function generatedGetPageInfos() // Afterburned
{
    ...
    $result[] = array('caption' => 'Interessenbindungsvergütungen', 'short_caption' => 'Interessenbindungsvergütungen', 'filename' => 'interessenbindung_jahr.php', 'name' => 'interessenbindung_jahr', 'group_name' => '<span class="releation-menu important-relation-menu">Verbindungen</span>', 'add_separator' => false, 'description' => '');
