...
function generatedGetPageInfos() // Afterburned
{
    ...
    $result[] = array('caption' => '<span class="entity important-entity">Person</span>', 'short_caption' => 'Person (Lobbyist)', 'filename' => 'person.php', 'name' => 'person', 'group_name' => '<span class="entity-menu important-entity-menu">Subjekte</span>', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => '<span class="relation">In Rat</span>', 'short_caption' => 'In Rat', 'filename' => 'in_rat.php', 'name' => 'in_rat', 'group_name' => '<span class="releation-menu important-relation-menu">Verbindungen</span>', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => '<span class="relation">In Fraktion</span>', 'short_caption' => 'In Fraktion', 'filename' => 'in_fraktion.php', 'name' => 'in_fraktion', 'group_name' => '<span class="releation-menu important-relation-menu">Verbindungen</span>', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => '<span class="relation">In Partei</span>', 'short_caption' => 'In Partei', 'filename' => 'in_partei.php', 'name' => 'in_partei', 'group_name' => '<span class="releation-menu important-relation-menu">Verbindungen</span>', 'add_separator' => false, 'description' => '');
