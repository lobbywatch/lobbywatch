...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => '<span class="view">Settings</span>', 'short_caption' => 'Settings', 'filename' => 'settings.php', 'name' => 'settings');
    $result[] = array('caption' => '<span class="view">Settings Category</span>', 'short_caption' => 'Settings Category', 'filename' => 'settings_category.php', 'name' => 'settings_category');
