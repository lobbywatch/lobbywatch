 ...
 */
    ...
    class Parlamentarier_photo_fehltPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $selectQuery = 'select * from parlamentarier where photo is null';
            $insertQuery = array();
            $updateQuery = array();
            $deleteQuery = array();
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'Parlamentarier_photo_fehlt');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('Parlamentarier_photo_fehltssearch', $this->dataset,
                array('id', 'nachname', 'vorname', 'zweiter_vorname', 'ratstyp', 'kanton', 'partei_id', 'parteifunktion', 'im_rat_seit', 'beruf', 'beruf_interessengruppe_id', 'photo', 'kleinbild', 'sitzplatz', 'email', 'homepage', 'ALT_kommission', 'notizen', 'freigabe_von', 'freigabe_datum', 'created_visa', 'created_date', 'updated_visa', 'updated_date', 'geburtstag'),
                array($this->RenderText('Id'), $this->RenderText('Nachname'), $this->RenderText('Vorname'), $this->RenderText('Zweiter Vorname'), $this->RenderText('Ratstyp'), $this->RenderText('Kanton'), $this->RenderText('Partei Id'), $this->RenderText('Parteifunktion'), $this->RenderText('Im Rat Seit'), $this->RenderText('Beruf'), $this->RenderText('Beruf Interessengruppe Id'), $this->RenderText('Photo'), $this->RenderText('Kleinbild'), $this->RenderText('Sitzplatz'), $this->RenderText('Email'), $this->RenderText('Homepage'), $this->RenderText('ALT Kommission'), $this->RenderText('Notizen'), $this->RenderText('Freigabe Von'), $this->RenderText('Freigabe Datum'), $this->RenderText('Created Visa'), $this->RenderText('Created Date'), $this->RenderText('Updated Visa'), $this->RenderText('Updated Date'), $this->RenderText('Geburtstag')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('Parlamentarier_photo_fehltasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('beruf_interessengruppe_id', $this->RenderText('Beruf Interessengruppe Id')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $column = new ExtendedHyperLinkColumnDecorator($column, $this->dataset, 'parlamentarier.php?operation=edit&pk0=%id%' , '');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $editor = new SpinEdit('partei_id_edit');
            ...
            //
            $editor = new DateTimeEdit('im_rat_seit_edit', false, 'Y-m-d H:i:s', GetFirstDayOfWeek());
            ...
            //
            $column = new TextViewColumn('beruf_interessengruppe_id', 'Beruf Interessengruppe Id', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            $editor = new SpinEdit('beruf_interessengruppe_id_edit');
        ...
        {
            $result = new Grid($this, $this->dataset, 'Parlamentarier_photo_fehltGrid');
        ...
        {
            return 'Auflistung der Parlamentarier, bei denen das Photo fehlt.';
        }
    }
    ...
    try
    {
        $Page = new Parlamentarier_photo_fehltPage("Parlamentarier_photo_fehlt.php", "Parlamentarier_photo_fehlt", GetCurrentUserGrantForDataSource("Parlamentarier_photo_fehlt"), 'UTF-8');
        $Page->SetShortCaption('Parlamentarier Photo Fehlt');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Parlamentarier Photo Fehlt');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Parlamentarier_photo_fehlt"));
