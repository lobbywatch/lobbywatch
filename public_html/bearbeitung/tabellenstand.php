 ...
 */
    ...
    class q_last_updated_tablesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            UNION (SELECT \'parlamentarier_transparenz\' tn, \'Parlamentariertransparenz\' n, (select count(*) from `parlamentarier_transparenz`) ne, t.`updated_visa` AS lv, t.`updated_date` ld, t.id lid FROM  `parlamentarier_transparenz` t ORDER BY t.`updated_date` DESC LIMIT 1)
