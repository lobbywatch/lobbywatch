 ...
 */
    ...
    class q_last_updated_tablesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            UNION (SELECT \'interessenbindung_jahr\' tn, \'Interessenbindungsvergütung\' n, (select count(*) from `interessenbindung_jahr`) ne, t.`updated_visa` AS lv, t.`updated_date` ld, t.id lid FROM  `interessenbindung_jahr` t ORDER BY t.`updated_date` DESC LIMIT 1)
            ...
            UNION (SELECT \'mandat_jahr\' tn, \'Mandatsvergütung\' n, (select count(*) from `mandat_jahr`) ne, t.`updated_visa` AS lv, t.`updated_date` ld, t.id lid FROM  `mandat_jahr` t ORDER BY t.`updated_date` DESC LIMIT 1)
