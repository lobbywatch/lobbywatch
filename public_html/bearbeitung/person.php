 ...
 */
    ...
    class person_person_anhang_person_anhang_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Person Anhang Log');
            $this->SetMenuLabel('Person Anhang Log');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_person_person_anhang_person_anhang_log_person_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('person_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_person_anhang_person_anhang_log_person_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_person_anhang_person_anhang_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_person_anhang_person_anhang_log_snapshot_id_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_person_person_anhang_person_anhang_log_person_id_search', 'id', 'anzeige_name', null, 20);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_person_person_anhang_person_anhang_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        {
            logTableExtendedDrawRow('person_anhang_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class person_person_anhangPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_person_anhang_person_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('person_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_person_anhang_person_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('person.person_anhang.person_anhang_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for person_person_anhang_person_anhang_log detail
            //
            $column = new DetailColumn(array('id'), 'person.person_anhang.person_anhang_log', 'person_person_anhang_person_anhang_log_handler', $this->dataset, 'Person Anhang Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new person_person_anhang_person_anhang_logPage('person_person_anhang_person_anhang_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('person.person_anhang.person_anhang_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('person.person_anhang.person_anhang_log'));
            $detailPage->SetHttpHandlerName('person_person_anhang_person_anhang_log_handler');
            $handler = new PageHTTPHandler('person_person_anhang_person_anhang_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_person_person_anhang_person_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    class person_v_zutrittsberechtigung_mandatePage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_v_zutrittsberechtigung_mandate_parlamentarier_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('parlamentarier_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_v_zutrittsberechtigung_mandate_parlamentarier_id_search');
    ...
    class person_mandatPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_mandat_person_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('person_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_mandat_person_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_mandat_organisation_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('organisation_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_mandat_organisation_id_search');
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_person_mandat_person_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    class personPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('beschreibung_fr'),
                    new StringField('parlamentarier_kommissionen'),
                    new StringField('zutrittsberechtigung_von'),
                    new StringField('beruf'),
                    new StringField('beruf_fr'),
                    new StringField('titel'),
                    new IntegerField('beruf_interessengruppe_id'),
        ...
        protected function CreatePageNavigator()
        {
            ...
            $partitionNavigator = new CustomPageNavigator('partition', $this, $this->GetDataset(), 'Nachname beginnt mit', $result, 'partition');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'beruf_interessengruppe_id', 'beruf_interessengruppe_id_name', 'Beruf Lobbygruppe'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_beruf_interessengruppe_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('beruf_interessengruppe_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_beruf_interessengruppe_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_person_partei_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('partei_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_person_partei_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Technischer Schlüssel des Zutrittsberechtigten.  Der Link zeigt auf den Eintrag in der Lobbywatch.ch Webseite.');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Abkürzungen der Kommissionen des zugehörigen Parlamentariers (automatisch erzeugt [in_Kommission Trigger])');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Welcher Parlamentarier gab die Zutrittsberechtigung?');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->setTarget('_self');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Fremdschlüssel zur Interessengruppe für den Beruf');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->setTarget('_self');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Fremdschlüssel Partei. Parteimitgliedschaft der zutrittsberechtigten Person.');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Arbeitssprache des Zutrittsberechtigten');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('Ist die Person erfasst? Falls der zugehörige Parlamentarier beispielsweise nicht mehr zur Wiederwahl antritt und deshalb die Person nicht erfasst wird, kann dieses Feld auf Nein gestellt werden. NULL bedeutet Status unklar.');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $level = $editor->addLevel($dataset1, 'id', 'name', 'Beruf Lobbygruppe', new ForeignKeyInfo('id', 'branche_id'));
        ...
        protected function CreateGrid()
        {
            ...
            $this->SetViewFormTitle('Person "%nachname%"');
            $this->SetEditFormTitle('Edit Person "%nachname%"');
            $this->SetInsertFormTitle('Add new Person');
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_person_beruf_interessengruppe_id_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        ...
        protected function doExtendedCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles, &$rowClasses, &$cellClasses)
        {
            customDrawRow('person', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
