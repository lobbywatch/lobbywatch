 ...
 */
    ...
    class mandatDetailView1personPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(false);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('mandatDetailViewGrid1person_beschreibung_handler_list');
            ...
            $column->SetOrderable(false);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('mandatDetailViewGrid1person_notizen_handler_list');
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'mandatDetailViewGrid1person');
            $result->SetAllowDeleteSelected(false);
            $result->SetUseFixedHeader(true);
            $result->SetShowLineNumbers(true);
            ...
            $column->SetOrderable(false);
            $column->SetReplaceLFByBR(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'mandatDetailViewGrid1person_beschreibung_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for notizen field
            //
            $column = new TextViewColumn('notizen', 'Notizen', $this->dataset);
            $column->SetOrderable(false);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'mandatDetailViewGrid1person_notizen_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    }
    ...
    class mandatDetailEdit1personPage extends DetailPageEdit
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('mandatDetailEdit1personssearch', $this->dataset,
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('mandatDetailEdit1personasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id', $this->RenderText('Id')));
            ...
            $field = new IntegerField('freigabe_datum_unix');
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('person_id', $this->RenderText('Person Id'), $lookupDataset, 'id', 'parlamentarier_id', false));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('mandatDetailEditGrid1person_beschreibung_handler_list');
            $column->SetReplaceLFByBR(true);
            $column->SetDescription($this->RenderText('Umschreibung des Mandates. Beschreibung wird zur Auswertung wahrscheinlich nicht gebraucht.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('mandatDetailEditGrid1person_notizen_handler_list');
            $column->SetDescription($this->RenderText('Interne Notizen zu diesem Eintrag. Einträge am besten mit Datum und Visa versehen.'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('mandatDetailEditGrid1person_beschreibung_handler_view');
            $column->SetReplaceLFByBR(true);
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('mandatDetailEditGrid1person_notizen_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'mandatDetailEditGrid1person');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
                $result->SetAllowDeleteSelected(false);
            else
                $result->SetAllowDeleteSelected(false);
            ...
            $column->SetOrderable(true);
            $column->SetReplaceLFByBR(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'mandatDetailEditGrid1person_beschreibung_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for notizen field
            //
            $column = new TextViewColumn('notizen', 'Notizen', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'mandatDetailEditGrid1person_notizen_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for beschreibung field
            //
            $column = new TextViewColumn('beschreibung', 'Beschreibung', $this->dataset);
            $column->SetOrderable(true);
            $column->SetReplaceLFByBR(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'mandatDetailEditGrid1person_beschreibung_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for notizen field
            //
            $column = new TextViewColumn('notizen', 'Notizen', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'mandatDetailEditGrid1person_notizen_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    class personPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('personssearch', $this->dataset,
                array('id', 'parlamentarier_id_anzeige_name', 'nachname', 'vorname', 'zweiter_vorname', 'parlamentarier_kommissionen', 'beruf', 'beruf_interessengruppe_id_name', 'arbeitssprache', 'email', 'homepage', 'twitter_name', 'linkedin_profil_url', 'xing_profil_name', 'facebook_name', 'telephon_1', 'telephon_2', 'notizen'),
                array($this->RenderText('Id'), $this->RenderText('Parlamentarier'), $this->RenderText('Nachname'), $this->RenderText('Vorname'), $this->RenderText('Zweiter Vorname'), $this->RenderText('Kommissionen des Parlamentariers'), $this->RenderText('Beruf'), $this->RenderText('Beruf Lobbygruppe'), $this->RenderText('Arbeitssprache'), $this->RenderText('Email'), $this->RenderText('Homepage'), $this->RenderText('Twitter Name'), $this->RenderText('Linkedin Profil Url'), $this->RenderText('Xing Profil Name'), $this->RenderText('Facebook Name'), $this->RenderText('Telephon 1'), $this->RenderText('Telephon 2'), $this->RenderText('Notizen')),
                array(
                    '=' => $this->GetLocalizerCaptions()->GetMessageString('equals'),
                    '<>' => $this->GetLocalizerCaptions()->GetMessageString('doesNotEquals'),
                    '<' => $this->GetLocalizerCaptions()->GetMessageString('isLessThan'),
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            {
              //
            // View column for mandatDetailView1person detail
            //
            $column = new DetailColumn(array('id'), 'detail1person', 'mandatDetailEdit1person_handler', 'mandatDetailView1person_handler', $this->dataset, '<s>Mandat</s>', $this->RenderText('<s>Mandat</s>'));
              $grid->AddViewColumn($column);
            }
        ...
        function CreateMasterDetailRecordGridFormandatDetailEdit1personGrid()
        {
            $result = new Grid($this, $this->dataset, 'MasterDetailRecordGridFormandatDetailEdit1person');
            $result->SetAllowDeleteSelected(false);
            $result->OnCustomDrawCell->AddListener('MasterDetailRecordGridFormandatDetailEdit1person' . '_OnCustomDrawRow', $this);
            $result->SetShowFilterBuilder(false);
            $result->SetAdvancedSearchAvailable(false);
            $result->SetFilterRowAvailable(false);
            $result->SetShowUpdateLink(false);
        ...
        public function MasterDetailRecordGridFormandatDetailEdit1person_OnCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles)
        {
        customDrawRow('person', $rowData, $rowCellStyles, $rowStyles);
        }
        ...
        protected function CreateGrid()
        {
            ...
            GetApplication()->RegisterHTTPHandler($handler);
            $pageView = new mandatDetailView1personPage($this, '<s>Mandat</s>', '<s>Mandat</s>', array('person_id'), GetCurrentUserGrantForDataSource('person.mandat'), 'UTF-8', 20, 'mandatDetailEdit1person_handler');
            
            $pageView->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('person.mandat'));
            $handler = new PageHTTPHandler('mandatDetailView1person_handler', $pageView);
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new mandatDetailEdit1personPage($this, array('person_id'), array('id'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridFormandatDetailEdit1personGrid(), $this->dataset, GetCurrentUserGrantForDataSource('person.mandat'), 'UTF-8');
            ...
            $pageEdit->SetHttpHandlerName('mandatDetailEdit1person_handler');
            $handler = new PageHTTPHandler('mandatDetailEdit1person_handler', $pageEdit);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for nachname field
            //
    ...
    try
    {
        ...
        $Page->SetShortCaption('<span class="entity">Person</span>');
