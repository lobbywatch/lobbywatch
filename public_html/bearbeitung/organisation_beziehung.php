 ...
 */
    ...
    class organisation_beziehung_organisation_beziehung_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Organisation Beziehung Log');
            $this->SetMenuLabel('Organisation Beziehung Log');
    
            $this->dataset = new TableDataset(
                MyPDOConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`organisation_beziehung_log`');
            ...
            $this->dataset->AddLookupField('ziel_organisation_id', 'v_organisation_simple', new IntegerField('id'), new StringField('anzeige_name', false, false, false, false, 'ziel_organisation_id_anzeige_name', 'ziel_organisation_id_anzeige_name_v_organisation_simple'), 'ziel_organisation_id_anzeige_name_v_organisation_simple');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'ziel_organisation_id', 'ziel_organisation_id_anzeige_name', 'Ziel Organisation Id'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_organisation_beziehung_organisation_beziehung_log_organisation_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('organisation_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_organisation_beziehung_organisation_beziehung_log_organisation_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_organisation_beziehung_organisation_beziehung_log_ziel_organisation_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('ziel_organisation_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_organisation_beziehung_organisation_beziehung_log_ziel_organisation_id_search');
            ...
            $main_editor->addChoice('tochtergesellschaft von', 'tochtergesellschaft von');
            $main_editor->addChoice('partner von', 'partner von');
            $main_editor->addChoice('beteiligt an', 'beteiligt an');
            $main_editor->SetAllowNullValue(false);
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_organisation_beziehung_organisation_beziehung_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_organisation_beziehung_organisation_beziehung_log_snapshot_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            // View column for anzeige_name field
            //
            $column = new TextViewColumn('ziel_organisation_id', 'ziel_organisation_id_anzeige_name', 'Ziel Organisation Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            ...
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->setDescription('Beschreibt die Beziehung einer Organisation zu einer Zielorgansation');
            $grid->AddViewColumn($column);
            //
        ...
        protected function doRegisterHandlers() {
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_organisation_beziehung_organisation_beziehung_log_organisation_id_search', 'id', 'anzeige_name', null, 20);
            ...
            $lookupDataset->setOrderByField('anzeige_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_organisation_beziehung_organisation_beziehung_log_ziel_organisation_id_search', 'id', 'anzeige_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_organisation_beziehung_organisation_beziehung_log_snapshot_id_search', 'id', 'beschreibung', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        {
            logTableExtendedDrawRow('organisation_beziehung_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class organisation_beziehungPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('organisation_beziehung.organisation_beziehung_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for organisation_beziehung_organisation_beziehung_log detail
            //
            $column = new DetailColumn(array('id'), 'organisation_beziehung.organisation_beziehung_log', 'organisation_beziehung_organisation_beziehung_log_handler', $this->dataset, 'Organisation Beziehung Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new organisation_beziehung_organisation_beziehung_logPage('organisation_beziehung_organisation_beziehung_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('organisation_beziehung.organisation_beziehung_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('organisation_beziehung.organisation_beziehung_log'));
            $detailPage->SetHttpHandlerName('organisation_beziehung_organisation_beziehung_log_handler');
            $handler = new PageHTTPHandler('organisation_beziehung_organisation_beziehung_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_organisation_beziehung_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'insert_organisation_beziehung_ziel_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_organisation_beziehung_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'filter_builder_organisation_beziehung_ziel_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_organisation_beziehung_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'edit_organisation_beziehung_ziel_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_organisation_beziehung_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, 'multi_edit_organisation_beziehung_ziel_organisation_id_search', 'id', 'searchable_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
        ...
        protected function doExtendedCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles, &$rowClasses, &$cellClasses)
        {
            customDrawRow('organisation_beziehung', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
