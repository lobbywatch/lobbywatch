 ...
 */
    ...
    class organisation_beziehungPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('ziel_organisation_id', 'v_organisation_simple', new IntegerField('id'), new StringField('searchable_name', 'ziel_organisation_id_searchable_name', 'ziel_organisation_id_searchable_name_v_organisation_simple'), 'ziel_organisation_id_searchable_name_v_organisation_simple');
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'ziel_organisation_id', 'ziel_organisation_id_searchable_name', $this->RenderText('Ziel Organisation')),
        ...
        protected function setupColumnFilter(ColumnFilter $columnFilter)
        {
            ...
            $columnFilter
                ...
                ->enableSearchFor('ziel_organisation_id', true);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->addChoice($this->RenderText('mitglied von'), $this->RenderText('Mitglied von / Membre de'));
            $main_editor->addChoice($this->RenderText('arbeitet fuer'), $this->RenderText('Arbeitet für / Travail pour'));
            $main_editor->addChoice($this->RenderText('tochtergesellschaft von'), $this->RenderText('Suborganisation von (Tochtergesellschaft, Zweigstelle) / Sous organisation de (filiale, succursale)'));
            $main_editor->addChoice($this->RenderText('partner von'), $this->RenderText('Partner von / Partenaire de'));
            $main_editor->addChoice($this->RenderText('beteiligt an'), $this->RenderText('Beteiligt an / Associé'));
            $main_editor->SetAllowNullValue(false);
            ...
            $main_editor = new AutocompleteComboBox('ziel_organisation_id_edit', $this->CreateLinkBuilder());
            $main_editor->setAllowClear(true);
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editor->addChoice($this->RenderText('mitglied von'), $this->RenderText('Mitglied von / Membre de'));
            $editor->addChoice($this->RenderText('arbeitet fuer'), $this->RenderText('Arbeitet für / Travail pour'));
            $editor->addChoice($this->RenderText('tochtergesellschaft von'), $this->RenderText('Suborganisation von (Tochtergesellschaft, Zweigstelle) / Sous organisation de (filiale, succursale)'));
            $editor->addChoice($this->RenderText('partner von'), $this->RenderText('Partner von / Partenaire de'));
            $editor->addChoice($this->RenderText('beteiligt an'), $this->RenderText('Beteiligt an / Associé'));
            ...
            //
            $editor = new AutocompleteComboBox('ziel_organisation_id_edit', $this->CreateLinkBuilder());
            $editor->setAllowClear(true);
            $editor->setMinimumInputLength(0);
            $lookupDataset = new TableDataset(
                MyPDOConnectionFactory::getInstance(),
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('searchable_name', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_ziel_organisation_id_searchable_name_search', 'id', 'searchable_name', null);
            GetApplication()->RegisterHTTPHandler($handler);
            $lookupDataset = new TableDataset(
                MyPDOConnectionFactory::getInstance(),
                GetConnectionOptions(),
            ...
            $lookupDataset->setOrderByField('searchable_name', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_ziel_organisation_id_searchable_name_search', 'id', 'searchable_name', null);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('searchable_name', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_ziel_organisation_id_searchable_name_search', 'id', 'searchable_name', null);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new organisation_beziehungPage("organisation_beziehung", "organisation_beziehung.php", GetCurrentUserGrantForDataSource("organisation_beziehung"), 'UTF-8');
