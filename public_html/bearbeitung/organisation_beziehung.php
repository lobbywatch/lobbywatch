    ...
    class organisation_beziehungPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('organisation_beziehungssearch', $this->dataset,
                array('id', 'organisation_id_searchable_name', 'art', 'ziel_organisation_id_searchable_name', 'quelle_url', 'quelle', 'notizen'),
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('searchable_name', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('ziel_organisation_id', $this->RenderText('Ziel Organisation'), $lookupDataset, 'id', 'searchable_name', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            // View column for searchable_name field
            //
            $column = new TextViewColumn('ziel_organisation_id_searchable_name', 'Ziel Organisation', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function CreateGrid()
        {
            ...
            $result->SetDefaultOrdering('organisation_id_searchable_name', otAscending);
