 ...
 */
    ...
    class lobbyorganisationPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('lobbyorganisationssearch', $this->dataset,
                array('id', 'name', 'beschreibung', 'typ', 'url', 'vernehmlassung', 'parlam_verbindung', 'branche_id_name', 'interessengruppe_id_bezeichnung', 'created_visa', 'created_date', 'updated_visa', 'updated_date'),
                array($this->RenderText('Id'), $this->RenderText('Name'), $this->RenderText('Beschreibung'), $this->RenderText('Typ'), $this->RenderText('Url'), $this->RenderText('Vernehmlassung'), $this->RenderText('Parlam Verbindung'), $this->RenderText('Branche Id'), $this->RenderText('Interessengruppe Id'), $this->RenderText('Created Visa'), $this->RenderText('Created Date'), $this->RenderText('Updated Visa'), $this->RenderText('Updated Date')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('lobbyorganisationasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridEditingHandler() { return 'lobbyorganisation_inline_edit'; }
        ...
        public function GetModalGridDeleteHandler() { return 'lobbyorganisation_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
        
        public function GetModalGridCopyHandler() { return 'lobbyorganisation_inline_edit'; }
        protected function GetEnableModalGridCopy() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'lobbyorganisationGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new lobbyorganisationPage("lobbyorganisation.php", "lobbyorganisation", GetCurrentUserGrantForDataSource("lobbyorganisation"), 'UTF-8');
        $Page->SetShortCaption('Lobbyorganisation');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Lobbyorganisation');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("lobbyorganisation"));
