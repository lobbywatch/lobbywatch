 ...
 */
    ...
    class translation_targetDetailEdit0translation_sourcePage extends DetailPageEdit
    {
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('translation_source_id', $this->RenderText('Translation Source Id'), $lookupDataset, 'id', 'source', false, 8));
            ...
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('source', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('plural_translation_source_id', $this->RenderText('Plural Translation Source Id'), $lookupDataset, 'id', 'source', false, 8));
