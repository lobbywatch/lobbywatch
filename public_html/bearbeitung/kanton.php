 ...
 */
    ...
    class kanton_parlamentarierPage extends DetailPage
    {
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('bfs_gemeinde_id_edit');
    ...
    class kanton_kanton_logPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Kanton Log');
            $this->SetMenuLabel('Kanton Log');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'flaeche_km2', 'flaeche_km2', 'Flaeche Km2'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['amtssprache'])
                ->addColumn($columns['hauptort_de'])
                ->addColumn($columns['hauptort_fr'])
                ->addColumn($columns['hauptort_it'])
                ->addColumn($columns['flaeche_km2'])
                ->addColumn($columns['beitrittsjahr'])
                ->addColumn($columns['wappen_svg'])
                ->addColumn($columns['wappen_svg_pfad'])
                ->addColumn($columns['wappen_klein'])
                ->addColumn($columns['wappen'])
                ->addColumn($columns['lagebild'])
                ->addColumn($columns['homepage'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('romandie_edit');
            ...
            $main_editor = new MultiValueSelect('amtssprache');
            $main_editor->addChoice('de', 'de');
            $main_editor->addChoice('fr', 'fr');
            $main_editor->addChoice('it', 'it');
            $main_editor->addChoice('rm', 'rm');
            ...
            $main_editor = new TextEdit('wappen_svg_pfad');
            ...
            $main_editor = new TextEdit('wappen_klein');
            ...
            $main_editor = new TextEdit('wappen');
            ...
            $main_editor = new TextEdit('lagebild');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_kanton_kanton_log_snapshot_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('snapshot_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_kanton_kanton_log_snapshot_id_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('kantonsnr', 'kantonsnr', 'Kantonsnr', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator('\'');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new NumberViewColumn('romandie', 'romandie', 'Romandie', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator('\'');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new NumberViewColumn('flaeche_km2', 'flaeche_km2', 'Flaeche Km2', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator('\'');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new NumberViewColumn('beitrittsjahr', 'beitrittsjahr', 'Beitrittsjahr', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator('\'');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new TextViewColumn('wappen_svg_pfad', 'wappen_svg_pfad', 'Wappen Svg Pfad', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            ...
            //
            $column = new TextViewColumn('wappen_klein', 'wappen_klein', 'Wappen Klein', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            ...
            //
            $column = new TextViewColumn('wappen', 'wappen', 'Wappen', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            ...
            //
            $column = new TextViewColumn('lagebild', 'lagebild', 'Lagebild', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function doExtendedCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles, &$rowClasses, &$cellClasses)
        {
            logTableExtendedDrawRow('kanton_log', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    class kantonPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('kanton.kanton_jahr')->HasViewGrant() && $withDetails)
            {
            //
            ...
            if (GetCurrentUserPermissionsForPage('kanton.parlamentarier')->HasViewGrant() && $withDetails)
            {
            //
            ...
            if (GetCurrentUserPermissionsForPage('kanton.kanton_log')->HasViewGrant() && $withDetails)
            {
            //
            // View column for kanton_kanton_log detail
            //
            $column = new DetailColumn(array('id'), 'kanton.kanton_log', 'kanton_kanton_log_handler', $this->dataset, 'Kanton Log');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new kanton_kanton_jahrPage('kanton_kanton_jahr', $this, array('kanton_id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('kanton.kanton_jahr'), 'UTF-8');
            ...
            $detailPage = new kanton_parlamentarierPage('kanton_parlamentarier', $this, array('kanton_id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('kanton.parlamentarier'), 'UTF-8');
            ...
            $detailPage = new kanton_kanton_logPage('kanton_kanton_log', $this, array('id'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('kanton.kanton_log'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('kanton.kanton_log'));
            $detailPage->SetHttpHandlerName('kanton_kanton_log_handler');
            $handler = new PageHTTPHandler('kanton_kanton_log_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
        ...
        protected function doExtendedCustomDrawRow($rowData, &$rowCellStyles, &$rowStyles, &$rowClasses, &$cellClasses)
        {
            customDrawRow('kanton', $rowData, $rowCellStyles, $rowStyles, $rowClasses, $cellClasses);
        }
    ...
    try
    {
        $Page = new kantonPage("kanton", "kanton.php", GetCurrentUserPermissionsForPage("kanton"), 'UTF-8');
