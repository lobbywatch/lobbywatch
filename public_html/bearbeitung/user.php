 ...
 */
    ...
    class userPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetDescription($this->RenderText('Technischer Schlüssel User'));
            ...
            $column->SetDescription($this->RenderText('Nachname des Benutzers'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        public function userGrid_OnGetCustomTemplate($part, $mode, &$result, &$params)
        {
        ...
        protected function CreateGrid()
        {
            ...
            $result->SetWidth('');
            $this->OnGetCustomTemplate->AddListener('userGrid' . '_OnGetCustomTemplate', $this);
            $result->OnCustomDrawCell->AddListener('userGrid' . '_OnCustomDrawRow', $this);
    ...
    try
    {
        ...
        $Page->SetShortCaption('<span class="settings">User</span>');
