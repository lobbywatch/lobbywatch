 ...
 */
    ...
    class interessenbindungenPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`interessenbindungen`');
            $field = new IntegerField('id_interessen', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('ib_description');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('ib_status');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('interessenbindungenssearch', $this->dataset,
                array('id_interessen', 'ib_description', 'ib_status', 'id_parlam_name', 'id_lobbytyp_lt_kategorie', 'id_lobbygroup_lg_bezeichnung', 'id_lobbyorg_lobbyname'),
                array($this->RenderText('Id Interessen'), $this->RenderText('Ib Description'), $this->RenderText('Ib Status'), $this->RenderText('Id Parlam'), $this->RenderText('Id Lobbytyp'), $this->RenderText('Id Lobbygroup'), $this->RenderText('Id Lobbyorg')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('interessenbindungenasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id_interessen', $this->RenderText('Id Interessen')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('ib_description', $this->RenderText('Ib Description')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('ib_status', $this->RenderText('Ib Status')));
        ...
        {
            //
            // View column for id_interessen field
            //
            $column = new TextViewColumn('id_interessen', 'Id Interessen', $this->dataset);
            ...
            //
            // View column for ib_description field
            //
            $column = new TextViewColumn('ib_description', 'Ib Description', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('ib_description_handler');
            
            /* <inline edit column> */
            //
            // Edit column for ib_description field
            //
            $editor = new TextAreaEdit('ib_description_edit', 50, 8);
            $editColumn = new CustomEditColumn('Ib Description', 'ib_description', $editor, $this->dataset);
            ...
            //
            // View column for ib_status field
            //
            $column = new TextViewColumn('ib_status', 'Ib Status', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for ib_status field
            //
            $editor = new ComboBox('ib_status_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $editor->AddValue('d', $this->RenderText('d'));
            $editor->AddValue('n', $this->RenderText('n'));
            $editor->AddValue('g', $this->RenderText('g'));
            $editColumn = new CustomEditColumn('Ib Status', 'ib_status', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $column->SetDescription($this->RenderText('d=deklariert, n=nicht-deklariert,g=zutrittsberechtigung'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $column->SetDescription($this->RenderText('FK lobbygruppen'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $column->SetDescription($this->RenderText('FK lobbyorganisationen'));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        public function GetModalGridEditingHandler() { return 'interessenbindungen_inline_edit'; }
        ...
        public function GetModalGridDeleteHandler() { return 'interessenbindungen_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
        
        public function GetModalGridCopyHandler() { return 'interessenbindungen_inline_edit'; }
        protected function GetEnableModalGridCopy() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'interessenbindungenGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'ib_description_handler', $column);
    ...
    try
    {
        $Page = new interessenbindungenPage("interessenbindungen.php", "interessenbindungen", GetCurrentUserGrantForDataSource("interessenbindungen"), 'UTF-8');
        $Page->SetShortCaption('Interessenbindungen');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Interessenbindungen');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("interessenbindungen"));
