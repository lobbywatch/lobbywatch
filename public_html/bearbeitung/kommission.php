 ...
 */
    ...
    class brancheDetailView0kommissionPage extends DetailPage
    {
        ...
        {
            $result = new Grid($this, $this->dataset, 'brancheDetailViewGrid0kommission');
    ...
    class brancheDetailEdit0kommissionPage extends DetailPageEdit
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('brancheDetailEdit0kommissionssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('brancheDetailEdit0kommissionasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'brancheDetailEdit0kommission_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'brancheDetailEditGrid0kommission');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    class in_kommissionDetailView1kommissionPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'in_kommissionDetailViewGrid1kommission');
            $result->SetAllowDeleteSelected(false);
            $result->SetUseFixedHeader(false);
    ...
    class in_kommissionDetailEdit1kommissionPage extends DetailPageEdit
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('in_kommissionDetailEdit1kommissionssearch', $this->dataset,
                array('id', 'parlamentarier_id_nachname', 'kommission_id_abkuerzung', 'funktion', 'notizen', 'freigabe_von', 'freigabe_datum', 'created_visa', 'created_date', 'updated_visa', 'updated_date'),
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('in_kommissionDetailEdit1kommissionasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id', $this->RenderText('Id')));
        ...
        public function GetModalGridDeleteHandler() { return 'in_kommissionDetailEdit1kommission_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'in_kommissionDetailEditGrid1kommission');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
                $result->SetAllowDeleteSelected(true);
            else
                $result->SetAllowDeleteSelected(false);
    ...
    class kommissionPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('kommissionssearch', $this->dataset,
                array('id', 'abkuerzung', 'name', 'typ', 'sachbereiche', 'abkuerung_delegation', 'notizen', 'freigabe_von', 'freigabe_datum', 'created_visa', 'created_date', 'updated_visa', 'updated_date'),
                array($this->RenderText('Id'), $this->RenderText('Abkuerzung'), $this->RenderText('Name'), $this->RenderText('Typ'), $this->RenderText('Sachbereiche'), $this->RenderText('Abkuerung Delegation'), $this->RenderText('Notizen'), $this->RenderText('Freigabe Von'), $this->RenderText('Freigabe Datum'), $this->RenderText('Created Visa'), $this->RenderText('Created Date'), $this->RenderText('Updated Visa'), $this->RenderText('Updated Date')),
                array(
                    '=' => $this->GetLocalizerCaptions()->GetMessageString('equals'),
                    '<>' => $this->GetLocalizerCaptions()->GetMessageString('doesNotEquals'),
                    '<' => $this->GetLocalizerCaptions()->GetMessageString('isLessThan'),
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            {
              //
            // View column for brancheDetailView0kommission detail
            //
            $column = new DetailColumn(array('id'), 'detail0kommission', 'brancheDetailEdit0kommission_handler', 'brancheDetailView0kommission_handler', $this->dataset, 'Branche', $this->RenderText('Branche'));
              $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserGrantForDataSource('kommission.in_kommission')->HasViewGrant())
            {
              //
            // View column for in_kommissionDetailView1kommission detail
            //
            $column = new DetailColumn(array('id'), 'detail1kommission', 'in_kommissionDetailEdit1kommission_handler', 'in_kommissionDetailView1kommission_handler', $this->dataset, 'In Kommission', $this->RenderText('In Kommission'));
              $grid->AddViewColumn($column);
            }
        ...
        function CreateMasterDetailRecordGridForbrancheDetailEdit0kommissionGrid()
        {
            $result = new Grid($this, $this->dataset, 'MasterDetailRecordGridForbrancheDetailEdit0kommission');
            $result->SetAllowDeleteSelected(false);
        ...
        function CreateMasterDetailRecordGridForin_kommissionDetailEdit1kommissionGrid()
        {
            $result = new Grid($this, $this->dataset, 'MasterDetailRecordGridForin_kommissionDetailEdit1kommission');
            $result->SetAllowDeleteSelected(false);
            $result->SetShowFilterBuilder(false);
            $result->SetAdvancedSearchAvailable(false);
            $result->SetFilterRowAvailable(false);
        ...
        protected function CreateGrid()
        {
            ...
            // Http Handlers
            //
            $pageView = new brancheDetailView0kommissionPage($this, 'Branche', 'Branche', array('kommission_id'), GetCurrentUserGrantForDataSource('kommission.branche'), 'UTF-8', 20, 'brancheDetailEdit0kommission_handler');
            
            $pageView->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('kommission.branche'));
            $handler = new PageHTTPHandler('brancheDetailView0kommission_handler', $pageView);
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new brancheDetailEdit0kommissionPage($this, array('kommission_id'), array('id'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForbrancheDetailEdit0kommissionGrid(), $this->dataset, GetCurrentUserGrantForDataSource('kommission.branche'), 'UTF-8');
            ...
            $pageEdit->SetHttpHandlerName('brancheDetailEdit0kommission_handler');
            $handler = new PageHTTPHandler('brancheDetailEdit0kommission_handler', $pageEdit);
            GetApplication()->RegisterHTTPHandler($handler);
            $pageView = new in_kommissionDetailView1kommissionPage($this, 'In Kommission', 'In Kommission', array('kommission_id'), GetCurrentUserGrantForDataSource('kommission.in_kommission'), 'UTF-8', 20, 'in_kommissionDetailEdit1kommission_handler');
            
            $pageView->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('kommission.in_kommission'));
            $handler = new PageHTTPHandler('in_kommissionDetailView1kommission_handler', $pageView);
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new in_kommissionDetailEdit1kommissionPage($this, array('kommission_id'), array('id'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForin_kommissionDetailEdit1kommissionGrid(), $this->dataset, GetCurrentUserGrantForDataSource('kommission.in_kommission'), 'UTF-8');
            
            $pageEdit->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('kommission.in_kommission'));
            $pageEdit->SetShortCaption('In Kommission');
            $pageEdit->SetHeader(GetPagesHeader());
            $pageEdit->SetFooter(GetPagesFooter());
            $pageEdit->SetCaption('In Kommission');
            $pageEdit->SetHttpHandlerName('in_kommissionDetailEdit1kommission_handler');
            $handler = new PageHTTPHandler('in_kommissionDetailEdit1kommission_handler', $pageEdit);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for name field
            //
    ...
    try
    {
        ...
        $Page->SetShortCaption('Kommission');
