  ...
  $(document)
      .ready(
          function() {
            ...
            $(
                '.interessenbindung li,.zugangsberechtigung li,.interessenbindungensitz li,.zugangsberechtigungensitz li')
                .live(
                    'click',
                    function(event) {
                      var pos = $(this).offset();
            ...
            $('#dialog div span,#platzinfo div span')
                .live(
                    ...
                    function() {
                      ...
                      $(
                          '.interessenbindung li,.parlamlink,.zugangsberechtigung li')
                          .css('background', '#fff');
                    });
