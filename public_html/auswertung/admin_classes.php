...
class Parlamentarier {
  ...
  function sitzplatz($ratstyp, $sitzplatz) {
    $sql = "SELECT parlamentarier.id,nachname,vorname,beruf,ratstyp,kanton,p.abkuerzung as partei,parteifunktion,im_rat_seit,GROUP_CONCAT(CONCAT(k.name, ' (', k.abkuerzung, ')') SEPARATOR ', ') as kommission,kleinbild FROM parlamentarier LEFT JOIN partei p ON parlamentarier.partei_id =p.id LEFT JOIN in_kommission ik ON parlamentarier.id = ik.parlamentarier_id INNER JOIN kommission k ON k.id = ik.kommission_id WHERE ratstyp='$ratstyp' AND sitzplatz='$sitzplatz' GROUP BY parlamentarier.id";
    dtXXX($sql);
  ...
  function gruppenParlamentarier($partei, $kanton, $ratstyp, $komm) {
    ...
    if ($partei != 'alleparteien' and $kanton == 'allekantone' and $ratstyp == 'alleraete') {
      ...
      $sql = "SELECT a.id,a.nachname,a.vorname,a.beruf,a.ratstyp,a.kanton,p.abkuerzung as partei,a.parteifunktion,a.im_rat_seit,GROUP_CONCAT(CONCAT(k.name, ' (', k.abkuerzung, ')') SEPARATOR ', ') as kommission,a.kleinbild,a.sitzplatz FROM parlamentarier a LEFT JOIN partei p ON a.partei_id = p.id INNER JOIN in_kommission ik ON a.id = ik.parlamentarier_id INNER JOIN kommission k ON ik.kommission_id = k.id  WHERE a.kanton = '$kanton' GROUP BY a.id ORDER BY p.abkuerzung,a.nachname";
      // 001
    } else if ($partei == 'alleparteien' and $kanton == 'allekantone' and $ratstyp != 'alleraete') {
      $sql = "SELECT a.id,a.nachname,a.vorname,a.beruf,a.ratstyp,a.kanton,p.abkuerzung as partei,a.parteifunktion,a.im_rat_seit,GROUP_CONCAT(CONCAT(k.name, ' (', k.abkuerzung, ')') SEPARATOR ', ') as kommission,a.kleinbild,a.sitzplatz FROM parlamentarier a LEFT JOIN partei p ON a.partei_id = p.id INNER JOIN in_kommission ik ON a.id = ik.parlamentarier_id INNER JOIN kommission k ON ik.kommission_id = k.id  WHERE  a.ratstyp = '$ratstyp' GROUP BY a.id ORDER BY  p.abkuerzung,a.nachname";
      // 110
    } else if ($partei != 'alleparteien' and $kanton != 'allekantone' and $ratstyp == 'alleraete') {
      ...
      $sql = "SELECT a.id,a.nachname,a.vorname,a.beruf,a.ratstyp,a.kanton,p.abkuerzung as partei,a.parteifunktion,a.im_rat_seit,GROUP_CONCAT(CONCAT(k.name, ' (', k.abkuerzung, ')') SEPARATOR ', ') as kommission,a.kleinbild,a.sitzplatz  FROM parlamentarier a LEFT JOIN partei p ON a.partei_id = p.id INNER JOIN in_kommission ik ON a.id = ik.parlamentarier_id INNER JOIN kommission k ON ik.kommission_id = k.id WHERE  a.kanton = '$kanton' AND a.ratstyp='$ratstyp' GROUP BY a.id ORDER BY  a.ratstyp,a.kanton";
      // 111
    } else if ($partei != 'alleparteien' and $kanton != 'allekantone' and $ratstyp != 'alleraete') {
      ...
      $sql = "SELECT a.id,a.nachname,a.vorname,a.beruf,a.ratstyp,a.kanton,p.abkuerzung as partei,a.parteifunktion,a.im_rat_seit,GROUP_CONCAT(CONCAT(k.name, ' (', k.abkuerzung, ')') SEPARATOR ', ') as kommission,a.kleinbild,a.sitzplatz  FROM parlamentarier a LEFT JOIN partei p ON a.partei_id = p.id INNER JOIN in_kommission ik ON a.id = ik.parlamentarier_id INNER JOIN kommission k ON ik.kommission_id = k.id GROUP BY a.id ORDER BY a.ratstyp,a.nachname";
    }
