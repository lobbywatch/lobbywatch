 ...
 */
    ...
    class lobbygruppenPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('lobbygruppenssearch', $this->dataset,
                array('id_lobbygroup', 'lg_bezeichnung', 'lg_description', 'id_lobbytyp_lt_kategorie'),
                array($this->RenderText('Id Lobbygroup'), $this->RenderText('Lg Bezeichnung'), $this->RenderText('Lg Description'), $this->RenderText('Id Lobbytyp')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('lobbygruppenasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id_lobbygroup', $this->RenderText('Id Lobbygroup')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('lg_bezeichnung', $this->RenderText('Lg Bezeichnung')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('lg_description', $this->RenderText('Lg Description')));
        ...
        {
            //
            // View column for id_lobbygroup field
            //
            $column = new TextViewColumn('id_lobbygroup', 'Id Lobbygroup', $this->dataset);
            ...
            //
            $column = new TextViewColumn('lg_bezeichnung', 'Lg Bezeichnung', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('lg_bezeichnung_handler');
            
            /* <inline edit column> */
            //
            // Edit column for lg_bezeichnung field
            //
            $editor = new TextAreaEdit('lg_bezeichnung_edit', 50, 8);
            $editColumn = new CustomEditColumn('Lg Bezeichnung', 'lg_bezeichnung', $editor, $this->dataset);
            ...
            //
            // View column for lg_description field
            //
            $column = new TextViewColumn('lg_description', 'Lg Description', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('lg_description_handler');
            
            /* <inline edit column> */
            //
            // Edit column for lg_description field
            //
            $editor = new TextAreaEdit('lg_description_edit', 50, 8);
            $editColumn = new CustomEditColumn('Lg Description', 'lg_description', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
        ...
        public function GetModalGridEditingHandler() { return 'lobbygruppen_inline_edit'; }
        ...
        public function GetModalGridDeleteHandler() { return 'lobbygruppen_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
        
        public function GetModalGridCopyHandler() { return 'lobbygruppen_inline_edit'; }
        protected function GetEnableModalGridCopy() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'lobbygruppenGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'lg_bezeichnung_handler', $column);
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'lg_description_handler', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for lg_bezeichnung field
            //
            $column = new TextViewColumn('lg_bezeichnung', 'Lg Bezeichnung', $this->dataset);
    ...
    try
    {
        $Page = new lobbygruppenPage("lobbygruppen.php", "lobbygruppen", GetCurrentUserGrantForDataSource("lobbygruppen"), 'UTF-8');
        $Page->SetShortCaption('Lobbygruppen');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Lobbygruppen');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("lobbygruppen"));
