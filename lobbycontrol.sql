...
--
-- Host: localhost
-- Erstellungszeit: 10. Nov 2013 um 13:41
...
CREATE TABLE IF NOT EXISTS `branche` (
  ...
  `name` varchar(255) NOT NULL COMMENT 'Energielobby, Gesundheitslobby etc',
...
INSERT INTO `branche` (`id`, `name`, `beschreibung`, `factsheet`, `kommission`) VALUES
...
CREATE TABLE IF NOT EXISTS `interessenbindung` (
  ...
  `status` enum('deklariert','nicht-deklariert','zutrittsberechtigung') NOT NULL DEFAULT 'deklariert' COMMENT 'd=deklariert, n=nicht-deklariert,g=zutrittsberechtigung',
  `parlamentarier_id` int(11) DEFAULT NULL COMMENT 'FK parlamentarier',
  `branche_id` int(11) DEFAULT NULL COMMENT 'FK lobbytypen',
  `interessengruppe_id` int(11) DEFAULT NULL COMMENT 'FK lobbygruppen',
  `lobbyorganisation_id` int(11) DEFAULT NULL COMMENT 'FK lobbyorganisationen',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Deklarierte Interessenbindungen' AUTO_INCREMENT=337 ;
...
--
-- Daten für Tabelle `interessenbindung`
--

INSERT INTO `interessenbindung` (`id`, `bezeichnung`, `status`, `parlamentarier_id`, `branche_id`, `interessengruppe_id`, `lobbyorganisation_id`) VALUES
(1, 'Robinvest AG, Männedorf AG  VR  P', '', 1, 9, NULL, 2),
(2, 'Bächtold Stiftung, Wilchingen  Stift. Sr.  M', '', 1, 8, NULL, 3),
(3, 'Schweizer Musikinsel Rheinau, Männedorf Stift. Sr.   P', '', 1, 8, NULL, 4),
(4, 'Fun & Business AG, Egerkingen ,VR ,Mitglied', '', 2, 12, NULL, 5),
(5, 'Bosec Consulting GmbH, Kestenholz,VR, Präsident', '', 2, 9, NULL, 6),
(6, 'Neu Bechburg, Oensingen, Stift.  SR, Mitglied', '', 2, 7, NULL, 7),
(7, 'Automobil Club der Schweiz (ACS) Mitte, Aarau, V, Mitglied', '', 2, 5, NULL, 8),
(8, 'Industrie- und Handelsverein Thal-Gäu-Bipperamt, Oensingen ,V,M', '', 2, 9, NULL, 9),
(9, 'Groupe de réflexion santé, Groupe Mutuel  , Beirat ,   M', '', 2, 1, 2, 10),
(10, 'Hüppi AG, Zürich,AG ,VR,  M', '', 3, 9, NULL, 11),
(11, 'comparis.ch, Zürich,AG,Bei.,M', '', 3, 9, NULL, 12),
(13, 'Alfred Flury Stiftung, Stift  Sr. P', '', 3, 1, 3, 13),
(14, 'Jugend ohne Drogen Ve.  V P', '', 3, 1, 3, 14),
(15, 'Fondazione per la promozione della formazione in medicina di famiglia Stift. SR P', '', 4, 1, 4, 15),
(16, 'Associazione aiuto medico al Centro America, Giubiasco Assoc. CD Co-pres.', '', 4, 13, NULL, 16),
(17, 'Associazione Scigué Assoc. C M', '', 4, 13, NULL, 348),
(18, 'Associazione Svizzera Inquilini Assoc.  - P', '', 4, 9, NULL, 17),
(19, 'Movimento dei Senza voce Assoc. C   M', '', 4, 2, NULL, 18),
(20, 'Nationale Arbeitsgemeinschaft Suchtpolitik (NAS-CPA), Zofingen Assoc. C P', '', 4, 1, 3, 19),
(21, 'Sindacato svizzero dei servizi pubblici (VPOD) Assoc. C   ', '', 4, 14, NULL, 21),
(22, 'Equam Stiftung Fond. CF   P', '', 5, 1, 4, 20),
(23, 'Forum Managed Care (FMC) Assoc. CD M', '', 5, 1, 3, 23),
(24, 'Fourchette Verte Ticino Assoc. CD P', '', 5, 12, NULL, 24),
(25, 'Public Health Schweiz Assoc. -  M', '', 5, 1, 3, 25),
(26, 'Schweizerischer Verband freier Berufe (SVFB) Assoc. CD VP', '', 5, 9, NULL, 26),
(27, 'Swiss Label   Assoc. CD   M', '', 5, 9, NULL, 27),
(28, 'Verbindung der Schweizer Ärztinnen und Ärzte (FMH) Assoc. CD VP', '', 5, 1, 4, 28),
(29, 'Ente Ospedaliero Cantonale (EOC) - CdA M', '', 5, 1, 5, 30),
(30, 'Swiss eHealth Forum (InfoSocietyDays) - - M', '', 5, 1, 3, 29),
(32, 'Abbundcenter Nordwestschweiz AG (ANW), Gelterkinden AG VR M', '', 6, 9, NULL, 31),
(33, 'Autobus AG Liestal (AAGL), Liestal AG VR M', '', 6, 5, NULL, 32),
(34, 'Elektra Baselland (EBL), Liestal Gen. VR M', '', 6, 3, NULL, 51),
(35, 'Raiffeisenbank Oberbaselbiet, Gelterkinden Gen. VR  P', '', 6, 9, NULL, 52),
(36, 'Erdgas Zürich AG, Altstetten AG VR M', '', 7, 3, NULL, 53),
(37, 'Stiftung Kinderschutz Schweiz Stift. Sr. P', '', 7, 2, NULL, 54),
(38, 'Stiftung Pestalozzianum Zürich Stift. Sr. M', '', 7, 7, NULL, 55),
(39, 'CASTAGNA, Beratungs- und Informationsstelle, Zürich Ve. Bei. M', '', 7, 2, NULL, 56),
(40, 'Pflegekinder-Aktion Schweiz, Zürich Ve. V M', '', 7, 2, NULL, 57),
(41, 'Pro Familia Schweiz, Bern Ve. V VP', '', 7, 2, NULL, 58),
(42, 'Basler Kantonalbank, Basel Anst. Br. M', '', 8, 9, NULL, 59),
(43, 'adoro consulting sa, Basel AG VR M', '', 8, 9, NULL, 60),
(44, 'aspero AG, Basel AG VR  M', '', 8, 9, NULL, 61),
(45, 'Dr. Sebastian Frehner Consulting, Basel EG - Gf.', '', 8, 9, NULL, 62),
(46, 'pro rabais.-, Basel Ve. V   M', '', 8, 9, NULL, 63),
(47, 'xundart AG, Wil (SG) AG   VR M', '', 9, 1, 4, 64),
(48, 'spo Patientenschutz, Zürich Stift. Sr. M', '', 9, 1, 6, 65),
(49, 'Stiftung sexuelle Gesundheit Schweiz  Stift. Sr. P', '', 9, 1, 3, 66),
(50, 'Gesellschaft Schweiz-Albanien Ve. - Bei.', '', 9, 13, NULL, 67),
(51, 'IG öfftentlicher Verkehr Ostschweiz Ve. V M', '', 9, 5, NULL, 68),
(52, 'IG pro Stadtbus, Wil (SG)   Ve. V P', '', 9, 5, NULL, 69),
(53, 'miva transportiert Hilfe Ve. V M', '', 9, 5, NULL, 70),
(54, 'umverkehR   Ve. - Co-Präs.', '', 9, 5, NULL, 71),
(55, 'Albert Grütter-Schlatter-Stiftung, Solothurn Stift. Sr. M', '', 10, 2, NULL, 72),
(56, 'Keradonum Stiftung Hornhautbank, Olten Stift. V M', '', 10, 1, 9, 74),
(57, 'Pro Senectute Kanton Solothurn, Solothurn Stift. Sr.P', '', 10, 2, NULL, 73),
(58, 'IGoeV Schweiz, Interessengemeinschaft öffentlicher Verkehr Ve. V P', '', 10, 5, NULL, 75),
(59, 'Interessengemeinschaft öffentliche Arbeitsplätze (IGöffA), Olten  Ve. V VP', '', 10, 14, NULL, 76),
(60, 'Komitee Pro Eppenberg Ve. ZA Co-Präs', '', 10, 5, NULL, 77),
(61, 'Lehrerinnen- und Lehrerverband Kanton Solothurn (LSO) Ve. - M', '', 10, 7, NULL, 78),
(62, 'Neue Europäische Bewegung Schweiz (nebs) Ve.  - M', '', 10, 13, NULL, 79),
(63, 'Palliative Care Netzwerk Kanton Solothurn, Solothurn Ve. V M', '', 10, 1, 4, 80),
(64, 'Pro Natura Schweiz und Solothurn Ve.  - M', '', 10, 4, NULL, 81),
(65, 'Pro Vebo / Pro Insos Ve. V M', '', 10, 2, NULL, 82),
(66, 'Schweizerischer Eisenbahn- und Verkehrspersonal-Verband (SEV) Ve. - M', '', 10, 5, NULL, 83),
(67, 'Spital Club Solothurn Ve. V P', '', 10, 1, 5, 84),
(68, 'Spitex Verband Kanton Solothurn Ve. V VP', '', 10, 1, 7, 85),
(69, 'Staatspersonalverband Kanton Solothurn Ve. - M', '', 10, 14, NULL, 86),
(70, 'Verband kleiner und mittlerer Bauern (VKMB) Ve. - M', '', 10, 15, NULL, 87),
(71, 'Vereinigung Solothurnischer Musikschulen, Solothurn Ve. - M', '', 10, 8, NULL, 88),
(72, 'Stoll, Hess und Partner AG, Bern AG VR M', '', 11, 9, NULL, 89),
(73, 'Gewa, Stiftung für berufliche Integration, Zollikofen   Stift. Sr. M', '', 11, 2, NULL, 90),
(74, 'Stiftung Wildstation Landshut, Utzenstorf Stift. Sr. M', '', 11, 4, NULL, 91),
(75, 'Berner Jägerverband (BEJV) Ve. V P', '', 11, 4, NULL, 92),
(76, 'Verband Bernischer Gemeinden Ve. V  P', '', 11, 14, NULL, 93),
(77, 'Aktion für vernünftige Energieplitik Schweiz (AVES)   - V M', '', 11, 3, NULL, 94),
(79, 'RehaClinic AG VR  M', '', 12, 1, 5, 96),
(80, 'Aargauische Kantonalbank Anst. Br. M', '', 12, 9, NULL, 95),
(81, 'Pro Senectute Kanton Aargau (Stiftungsversammlung) Stift. - M', '', 12, 2, NULL, 97),
(82, 'Schweizerische Stiftung für Klinische Krebsforschung Stift. Sr. M', '', 12, 1, 4, 98),
(83, 'Stiftung OL-Schweiz Stift. Sr. M', '', 12, 17, NULL, 99),
(84, 'Theraplus, Stiftung für Therapiebegleitung Stift. Sr. M', '', 12, 1, 3, 100),
(85, 'Verein Schweizerisches Netzwerk gesundheitsfördernder Spitäler und Dienste Ve. V P', '', 12, 1, 3, 101),
(86, 'Stiftung Brot für Alle Stift.   Sr. M', '', 13, 13, NULL, 102),
(87, 'Musikkollegium Winterthur   Ve. V P', '', 13, 8, NULL, 103),
(88, 'Vogelschutz / BirdLife Schweiz Ve. V  VP', '', 13, 4, NULL, 104),
(89, 'Pro Infirmis TG/SH  Ve.   V M', '', 14, 2, NULL, 105),
(90, 'Retraites populaires, Lausanne EtabPubl  CA M', '', 15, 9, NULL, 106),
(91, 'Caisse de pensions ECA-RP, Lausanne Fond. CF M', '', 15, 9, NULL, 107),
(92, 'EMS Mont-Calme, Lausanne Fond. CF M', '', 15, 1, 5, 108),
(93, 'Fondation d''Ethique Familiale, Lausanne Fond. CF P', '', 15, 1, 4, 109),
(94, 'ACS Vaud, Lausanne Assoc. C M', '', 15, 5, NULL, 110),
(95, 'Etablissement d''assurance contre l''incendie et le éléments naturels (ECA) du Canton de Vaud EtabPubl CA M', '', 16, 14, NULL, 111),
(96, 'fenaco, fédération de coopératives agricoles, Berne   SCoop CA VP', '', 16, 15, NULL, 113),
(97, 'Société d''agriculture et de laiterie de Bursins-Vinzel, Bursins SCoop C P', '', 16, 15, NULL, 112),
(98, 'Association "Relève PME", Paudex Assoc. C M', '', 16, 9, NULL, 114),
(99, 'Association du Centre Patronal, Paudex Assoc. - M', '', 16, 9, NULL, 115),
(100, 'Fédération Patronale Vaudoise Assoc.   C  M', '', 16, 9, NULL, 116),
(101, 'Union intercantonale de réassurance (UIR), Bern Assoc. CA M', '', 16, 9, NULL, 117),
(102, 'Raiffeisenbank Menzingen-Neuheim, Menzingen Gen. Vw. P', '', 17, 9, NULL, 118),
(103, 'Ausgleichskasse Verom, Schlieren Stift. V VP', '', 17, 9, NULL, 119),
(104, 'Agro-Marketing Suisse (AMS), Bern Ve. V VP', '', 17, 15, NULL, 120),
(105, 'Internetplattform Swissmip, Koppigen Ve. - P', '', 17, 15, NULL, 121),
(106, 'Musée Alpin Suisse, Berne Fond. CF M', '', 18, 8, NULL, 122),
(107, 'Oeuvre suisse d''entraide ouvrière (OSEO) Valais, Sion Assoc. C  P', '', 18, 13, NULL, 123),
(108, 'Pro Mente Sana Suisse romande, Genève Assoc. C   M', '', 18, 1, 3, 124),
(109, 'Universitätsspital Basel, Basel Anst. VR  M', '', 19, 1, 5, 125),
(110, 'Schweizerische Pfadistiftung Stift. Sr.  M', '', 19, 17, NULL, 126),
(111, 'Compasso - Berufliche Eingliederung - Informationsportal für Arbeitgeber Ve. V M', '', 19, 2, NULL, 127),
(112, 'IAMANEH Schweiz Ve. V  P', '', 19, 13, NULL, 128),
(113, 'Schweizerische Gesundheitsligen-Konferenz (GELIKO) Ve. V P', '', 19, 1, 3, 129),
(114, 'Schweizerischer Verband des Personals öffentliche Dienste (VPOD) Ve. - M', '', 19, 14, NULL, 130),
(115, 'WWF Region Basel Ve. V   VP', '', 19, 4, NULL, 131),
(116, 'RadioZürisee AG, Stäfa AG  VR M', '', 20, 18, NULL, 132),
(117, 'TopPharm Apotheke, Zürich AG VR M', '', 20, 1, 1, 133),
(118, 'Schweizerische Greina-Stiftung (SGS) zur erhaltung der alpinen Fliessgewässer, Zürich Stift. Sr. M', '', 20, 4, NULL, 134),
(119, 'Schweizerische Sportmittelschule Engelberg Stift. Bei. M', '', 20, 17, NULL, 135),
(120, 'Gewerbeverband Stadt Zürich Ve. - M', '', 20, 9, NULL, 136),
(121, 'Pro Natura, Basel Ve. - M', '', 20, 4, NULL, 137),
(122, 'Schweizer Polizei Informatik Kongress (SPIK) Ve. Bei. M', '', 20, 9, NULL, 138),
(123, 'Schweizerisches Rotes Kreuz Kanton Zürich Ve. - P', '', 20, 1, 3, 139),
(124, 'Wirtschaftsverband swisscleantech (politischer Beirat) Ve. Bei.  M', '', 20, 4, NULL, 140),
(125, 'Zürcher Frauenzentrale   Ve. -  M', '', 20, 9, NULL, 141),
(126, 'Fritz Heid AG, Thürnen AG  VR M', '', 21, 9, NULL, 142),
(127, 'Kistenfabrik + Holzhandels AG, Thürnen AG VR M', '', 21, 9, NULL, 143),
(128, 'Treff 44 AG, Thürnen AG  VR M', '', 21, 12, NULL, 144),
(129, 'Gewerbeverein Sissach und Umgebung Ve. V P', '', 21, 9, NULL, 145),
(130, 'Hauseigentümerverband (HEV) Sissach/Läufelfingen Ve. V M', '', 21, 9, NULL, 146),
(131, 'Liga Baselbieter Steuerzahler, Liestal  Ve. V  M', '', 21, 14, NULL, 147),
(132, 'KGIV der Wirtschaftskammer Basel-Landschaft, Liestal  - - M', '', 21, 9, NULL, 148),
(133, 'Wirtschaftsrat der Wirtschaftskammer Basel-Landschaft, Liestal   - -  M', '', 21, 9, NULL, 149),
(134, 'LifeWatch AG Neuhausen AG  VR M', '', 22, 1, 9, 150),
(135, 'tracker.ch AG  Bei. M', '', 22, 9, NULL, 151),
(136, 'Vergabungskommission der Young Kickers Foundation (beiratsähnliches Gremium) Komm. - M', '', 22, 17, NULL, 152),
(137, 'Stiftung Sportmuseum Schweiz, Basel  Stift. Sr. M', '', 22, 17, NULL, 153),
(138, 'FH SCHWEIZ – Dachverband Absolventinnen und Absolventen Fachhochschulen Ve. Bei. M', '', 22, 7, NULL, 154),
(139, 'Groupe Mutuel, Martigny  Ve. GL -', '', 22, 1, 2, 155),
(140, 'Schweizerischer Turnverband (STV), Aarau Ve. ZV M', '', 22, 17, NULL, 156),
(141, 'Swiss Olympic Verband, Ittigen (Exekutivrat) Ve. - M', '', 22, 17, NULL, 157),
(142, 'Arbeitsgruppe Gesundheitswesen, VIPS - - M', '', 22, 1, 3, 158),
(143, 'Groupe de réflexion santé, Groupe Mutuel - Bei. M', '', 22, 1, 2, 10),
(144, 'Lions Club, Winterthur - -   M', '', 22, 9, NULL, 159),
(145, 'Swisscup, Aarau - - P', '', 22, 17, NULL, 160),
(146, 'Berner Fachhochschule, Fachbereich Gesundheit Anst. - Bei.', '', 23, 1, NULL, 161),
(147, 'Kompetenzzentrum Sexualpädagogik und Schule Körp. Bei. M', '', 23, 7, NULL, 162),
(148, 'Mobilitäts Akademie AG Bei. M', '', 23, 5, NULL, 163),
(149, 'Centre de formation continue pour adultes handicapés, Fribourg Stift. Sr. P', '', 23, 7, NULL, 164),
(150, 'Fondation Le Tremplin, Fribourg Stift. V   M', '', 23, 1, 3, 165),
(151, 'Fondation Les Buissonnets Stift. Sr. P', '', 23, 1, 3, 166),
(152, 'Forschungsfonds der Universität Freiburg Stift. Sr. M', '', 23, 6, NULL, 167),
(153, 'Schweizerische Greina-Stiftung (SGS) zur Erhaltung der alpinen Fliessgewässer, Zürich Stift. Sr. M', '', 23, 4, NULL, 134),
(154, 'Schweizerisches Alpines Museum, Bern Stift. Pat. M', '', 23, 8, NULL, 122),
(155, 'Stiftung Schweiz Mobil Stift. Pat. M', '', 23, 5, NULL, 168),
(156, 'Stiftung Umweltbildung Schweiz Stift. A P', '', 23, 4, NULL, 169),
(157, 'Association des Amis du Conservatoire de Fribourg Ve. V P', '', 23, 8, NULL, 170),
(158, 'Dachverband Komplementärmedizin Schweiz Ve. V  M', '', 23, 1, 4, 171),
(159, 'Dachverband Schweizerischer Patientenstellen, Zürich Ve. V VP', '', 23, 1, 6, 172),
(160, 'Denknetz Schweiz Ve. V   M', '', 23, 6, NULL, 173),
(161, 'FH Schweiz - Dachverband Absolventinnen und Absolventen Fachhochschulen Ve. Bei. M', '', 23, 7, NULL, 154),
(162, 'Freiburger Gesundheitsligen Ve. V VP', '', 23, 1, 6, 174),
(163, 'Krebsliga des Kantons Freiburg / Ligue fribourgeoise contre le cancer Ve. V P', '', 23, 1, 6, 175),
(164, 'Nationale Informationsstelle für Kulturgüter-Erhaltung NIKE Ve. V M', '', 23, 8, NULL, 176),
(165, 'OUESTRAIL  Ve. A M', '', 23, 5, NULL, 177),
(166, 'Patientenstelle Freiburg-Westschweiz, Freiburg Ve.   V P', '', 23, 1, 6, 178),
(167, 'Pro Velo Schweiz Ve. V   P', '', 23, 5, NULL, 179),
(168, 'Schweizerische Alzheimervereinigung  Ve. V M', '', 23, 1, 3, 180),
(169, 'Schweizerische Gesellschaft für Gesundheitspolitik   Ve. V P', '', 23, 1, 3, 181),
(170, 'Schweizerische Vereinigung Hochspannung unter den Boden (HSUB) Ve. V P', '', 23, 3, NULL, 182),
(171, 'Büro Harmos der schweizerischen Erziehungsdirektorenkonferenz - Bei. M', '', 23, 7, NULL, 183),
(172, 'Kompetenzzentrum Sexualpädagogik der PH Luzern   - Bei. M', '', 23, 7, NULL, 185),
(173, 'Partners in Learning Leadership Forum  - - Bei.', '', 23, 7, NULL, 184),
(174, 'Swiss Cochrane working group - - Bei', '', 23, 1, 3, 186),
(175, 'Alliance "Non au nucléaire" , Zürich Assoc. C VP', '', 24, 3, NULL, 187),
(176, 'Sortir du nucléaire, Lausanne (Porte-parole) Assoc.  C M', '', 24, 3, NULL, 188),
(177, 'Beratende Komm. EAWAG (Eidg. Anstalt für Wasserversorg., Abwasserreinig. und Gewässerschutz) Komm. - M', '', 25, 4, NULL, 189),
(178, 'Allianz "Ja zur Initiative für den OeV" Ve. V M', '', 25, 5, NULL, 190),
(179, 'Aqua Viva, Schweizerische Aktionsgemeinschaft zum Schutze der Flüsse und Seen Ve. V  P', '', 25, 4, NULL, 191),
(180, 'Gesellschaft für das Weinbaumuseum am Zürichsee Ve. V M', '', 25, 8, NULL, 192),
(181, 'Rheinaubund, Schweizerische Arbeitsgemeinschaft für Natur und Heimat Ve. V Co-Präs.', '', 25, 4, NULL, 193),
(182, 'Schweizer Kaderorganisation SKO  Ve. V P', '', 25, 9, NULL, 194),
(183, 'Spitex Verband Kanton Zürich Ve. V M', '', 25, 1, 7, 195),
(184, 'Verein für Ingenieurbiologie Ve. V M', '', 25, 9, NULL, 196),
(185, 'Fachhochschulrat Nordwestschweiz (FHNW), Brugg Anst. - M', '', 26, 7, NULL, 197),
(186, 'Energiedienst AG (Sachverständiger Beirat), Laufenburg AG - Bei.', '', 26, 3, NULL, 198),
(187, 'Regionalplanungsgruppe Rohrdorferberg-Reusstal (Kommission Gemeindeverband) Komm. - P', '', 26, 14, NULL, 199),
(188, 'Verteilung Alkoholzehntel im Aargau (Kommission Kanton Aargau) Komm. - P', '', 26, 14, NULL, 200),
(189, 'Albert und Ida Nüssli-Stutz Stiftung, Mellingen Stift. Sr. P', '', 26, 8, NULL, 201),
(190, 'Ballenberg - Schweizerisches Freilichtmuseum für ländliche Kultur, Brienz Stift. Sr. M', '', 26, 8, NULL, 202),
(191, 'REHA Rheinfelden Stift. Sr. M', '', 26, 1, 5, 203),
(192, 'Schweizerische Stiftung für eine verantwortungsvolle Gentechnik (GEN SUISSE), Bern Stift.  Sr. VP', '', 26, 1, 3, 204),
(193, 'Stiftung 3 R   Stift. Sr. P', '', 26, 4, NULL, 205),
(194, 'Stiftung Öffentlichkeit und Gesellschaft   Stift. Sr. M', '', 26, 18, NULL, 206),
(195, 'Stiftung Regionales Blutspende-Zentrum Stift. Sr. M', '', 26, 1, 3, 207),
(196, 'Stiftung Vindonissapark  Stift. Sr. M', '', 26, 8, NULL, 208),
(197, 'Technopark Aargau Stift.   Sr. VP', '', 26, 9, NULL, 209),
(198, 'Forum Alter und Migration (Verband) Ve. V P', '', 26, 2, NULL, 210),
(199, 'Forum Vera   Ve. V M', '', 26, 3, NULL, 211),
(200, 'Gönnervereinigung Speranza Ve. V M', '', 26, 7, NULL, 212),
(201, 'Hauseigentümerverband (HEV) Sektion Baden/Brugg/Zurzach Ve. V M', '', 26, 9, NULL, 213),
(202, 'IG Musikinitiative Ve. - P', '', 26, 7, NULL, 214),
(204, 'Schweizer Feuilleton-Dienst Ve. - M', '', 27, 18, NULL, 216),
(205, 'Skilift Oberegg-St. Anton, Oberegg AG  VR M', '', 27, 12, NULL, 215),
(206, 'Pro Innerrhoden, Appenzell Stift. Sr. M', '', 27, 7, NULL, 217),
(207, 'Schweizer Jugend forscht Stift. Sr. M', '', 27, 6, NULL, 218),
(208, 'Stiftung Internat Gymnasium Appenzell (Aufsichtsrat) Stift. Sr. M', '', 27, 7, NULL, 219),
(209, 'Stiftung Kinderdorf Pestalozzi, Trogen   Stift. Sr. M', '', 27, 13, NULL, 220),
(211, 'FH Schweiz - Dachverband Absolventinnen und Absolventen Fachhochschulen - Bei. M', '', 27, 7, NULL, 154),
(212, 'Interstaatliche Erwachsenenmatura (Aufsichtsgremium) - - M', '', 27, 7, NULL, 221),
(213, 'Beirat Ökologie der Herzog Kull Group  AG Bei. M', '', 28, 3, NULL, 222),
(214, 'Herzog Kull Group (HKG) Aarau AG,  VR M', '', 28, 3, NULL, 223),
(215, 'Herzog Kull Group (HKG) Baden AG, Baden AG VR  M', '', 28, 3, NULL, 223),
(216, 'Herzog Kull Group (HKG) Consulting AG, Aarau AG  VR M', '', 28, 3, NULL, 223),
(217, 'seniorweb AG AG VR M', '', 28, 2, NULL, 224),
(218, 'Swiss Economy Forum, Advisory Board AG Bei. M', '', 28, 9, NULL, 225),
(219, 'Swiss Media Forum, Advisory Board AG Bei. M', '', 28, 18, NULL, 226),
(220, 'Stiftung Krebsregister Aargau, Aarau Stift. Sr. M', '', 28, 1, 3, 227),
(221, 'Freunde des Zentrums für Demokratie (ZDA), Aarau   Ve. V P', '', 28, 14, NULL, 228),
(222, 'Verein Cleantech Aargau  Ve. V P', '', 28, 4, NULL, 229),
(223, 'Wirtschaftsverband swisscleantech (politischer Beirat) Ve. Bei. M', '', 28, 4, NULL, 140),
(224, 'Advisory Board of the Center for Disability and Integration, Hochschule St. Gallen - Bei. M', '', 28, 2, NULL, 230),
(225, 'Institut für Wirtschaftsethik der Universität St. Gallen (Geschäftsleitender Ausschuss) -  A M', '', 28, 7, NULL, 231),
(226, 'SOH, Solothurner Spital AG, Solothurn  AG VR P', '', 29, 1, 5, 232),
(227, 'Stiftung Moriz und Elsa von Kuffner Stift. Sr. M', '', 29, 2, NULL, 233),
(228, 'Axpo Holding AG AG VR  M', '', 30, 3, NULL, 234),
(229, 'De Martin AG, Wängi AG   VR P', '', 30, 9, NULL, 235),
(230, 'KIBAG HOLDING AG, Zürich AG VR M', '', 30, 9, NULL, 236),
(231, 'Kartause Ittingen, Warth   Stift. Sr. P', '', 30, 12, NULL, 237),
(232, 'BDO AG (und Gruppengesellschaften)   AG VR  M', '', 31, 9, NULL, 238),
(233, 'CSS (und Gruppengesellschaften) AG   VR M', '', 31, 1, 2, 239),
(234, 'Emmi Gruppe (inkl. Stiftungen) AG VR P', '', 31, 15, NULL, 240),
(235, 'vbl Verkehrsbetriebe Luzern AG (und Gruppengesellschaften) AG VR P', '', 31, 5, NULL, 241),
(236, 'Stiftung BioPolis Entlebuch Stift. Sr. M', '', 31, 12, NULL, 242),
(237, 'Industrie- und Handelskammer Zentralschweiz Ve. V M', '', 31, 9, NULL, 243),
(238, 'Informationsdienst für den öffentlichen Verkehr (LITRA), Bern Ve. V M', '', 31, 5, NULL, 244),
(239, 'Kaufmännischer Verband, Luzern Ve.   Bei. M', '', 31, 9, NULL, 245),
(240, 'Axa Winterthur AG VR M', '', 32, 9, NULL, 246),
(241, 'Osiris Therapeutics Inc., Baltimore, USA AG VR M', '', 32, 1, 1, 247),
(242, 'Rahn AG, Zürich AG VR  M', '', 32, 1, 9, 248),
(243, 'Fritz-Gerber-Stiftung für begabte junge Menschen, Basel Stift. Sr.   M', '', 32, 7, NULL, 249),
(244, 'Sanitas Krankenkasse Stift. VR M', '', 32, 1, 2, 250),
(245, 'Stiftung Vita Parcours, Zürich Stift. Sr.  P', '', 32, 1, 3, 251),
(246, 'Swiss School of Public Health (SSPH+), Zürich (Schulrat) Stift. Sr. P', '', 32, 1, 3, 252),
(247, 'The Jerusalem Foundation, Zürich Stift.  Sr. P', '', 32, 8, NULL, 253),
(248, 'Krebsliga des Kantons Zürich Ve. V M', '', 32, 1, 3, 254),
(249, 'Arbeitsgruppe Gesundheitswesen, VIPS(Pharmafirmen)  - - M', '', 32, 1, 3, 255),
(251, 'St. Galler Stiftung für internationale Studien, St. Gallen SR M', '', 33, 7, NULL, 257),
(253, 'Pulita Putzteam GmbH, Reichenburg GmbH V P', '', 34, 9, NULL, 259),
(254, 'Schweizerische Stiftung für Klinische Krebsforschung Stift. Sr. M', '', 34, 1, 3, 98),
(255, 'Forum Gesundheit Schweiz - - Co-Präs.', '', 34, 1, 3, 261),
(256, 'Hôpitaux Universitaires de Genève, Genève EtabPubl CA Secr.', '', 35, 1, 5, 260),
(257, 'Association des Amis de la Fondation AGIR, Genève Fond. C M', '', 35, 1, 9, 262),
(258, 'ARGOS, Association d''aide aux personnes toxico-dépendantes, Genève Assoc. C P', '', 35, 1, 3, 264),
(259, 'Fédération suisse des sages-femmes (FSSF) Assoc. C P', '', 35, 1, 4, 263),
(260, 'Mobilité piétonne Suisse   Assoc. CC M', '', 35, 5, NULL, 265),
(261, 'Paul Grüninger-Stiftung  Stift. Sr. M', '', 36, 14, NULL, 266),
(262, 'Schweizerischer Gewerkschaftsbund  Ve. V P', '', 36, 9, NULL, 36),
(263, 'Interkantonale Rückversicherung (IRV), Bern Körp. VR P', '', 37, 9, NULL, 117),
(264, 'Editions D + P (Démocrate + Pays) Delémont AG VR   M', '', 37, 18, NULL, 267),
(265, 'Fiduconsult  AG VR M', '', 37, 9, NULL, 268),
(266, 'groupe-e, Freiburg AG VR M', '', 37, 3, NULL, 269),
(267, 'Imprimerie St-Paul, Freiburg AG VR M', '', 37, 9, NULL, 270),
(268, 'JPF Holding SA, Bulle AG   VR M', '', 37, 9, NULL, 271),
(269, 'Liebherr Machines Bulle SA AG VR M', '', 37, 9, NULL, 272),
(270, 'Bäuerliche Bürgschaftsgenossenschaft, Freiburg Gen. VR P', '', 37, 15, NULL, 273),
(271, 'Amis de la Fille-Dieu, Romont Ve. V P', '', 37, 8, NULL, 274),
(272, 'Cemsuisse, Verband der Schweizerischen Cementindustrie Ve. - P', '', 37, 9, NULL, 275),
(273, 'Schweizerische Pfadistiftung Stift. Sr. M', '', 38, 17, NULL, 126),
(274, 'Stiftung Comdays (Bieler Kommunikationstage), Biel   Stift. Sr. M', '', 38, NULL, NULL, 276),
(275, 'Eidgenössisches Turnfest Biel/Magglingen Ve. V P', '', 38, 17, NULL, 277),
(276, 'Jura & Drei-Seen-Land  Ve. V P', '', 38, 12, NULL, 278),
(277, 'Neue Helvetische Gesellschaft / Treffpunkt Schweiz Ve. V M', '', 38, 7, NULL, 279),
(278, 'Tour de Suisse, Biel Ve. V P', '', 38, 17, NULL, 280),
(279, 'Verein PPP (Public Private Partnership) Schweiz, Zürich Ve. V M', '', 38, 9, NULL, 281),
(281, 'Schweizerische Wettbewerbsvereinigung, Zürich Ve. V VP', '', 1, 9, NULL, 300),
(283, 'Aktion für vernünftige Energieplitik Schweiz (AVES)    - V M', '', 2, 3, NULL, 94),
(284, 'Aktion für vernünftige Energieplitik Schweiz (AVES)    - V M', '', 3, 3, NULL, 94),
(286, 'Schweizerische Akademie der medizinischen Wissenschaften (SAMW), Basel Stift. M ', '', 5, 1, 4, 302),
(287, 'Ricovero Malcantonese Fondazione Giovanni e Giuseppina Rossi, Croglio Stift. SR M', '', 5, 2, NULL, 303),
(288, 'Ospedale Malcantonese Fondazione Giuseppe Rossi, Croglio Stift. SR M', '', 5, 1, 5, 304),
(289, 'Fondazione Circolo Franchi Liberali e Filarmonica Liberale-Radicale Collina d''Oro, Collina d''Oro Stift. SR M', '', 5, 8, NULL, 305),
(290, 'Wohlfahrtsstiftung der Elektra Baselland, Liesta Stift. SR M', '', 6, 2, NULL, 306),
(291, 'Politcom, Agentur für politische Kommunikation und Public Affairs, Thomas de Courten, Liestal Einzelfirma Inhaber', '', 6, 9, NULL, 307),
(292, 'atelier politique Fehr, Winterthur Einzelfirma Inhaberin ', '', 7, 9, NULL, 308),
(293, 'Aktion für vernünftige Energieplitik Schweiz (AVES) V M', '', 12, 3, NULL, 94),
(294, 'Profil, Zürich (Pro Infirmis) Stift. SR M', '', 14, 1, 3, 309),
(295, 'Charlotte und Hans Haller Stiftung, Zürich Stift. SR M', '', 14, 1, 3, 310),
(296, 'Arbeitskreis Sicherheit und Wehrtechnik (asuw) Ve. M ', '', 16, 16, NULL, 311),
(297, 'Aktion für vernünftige Energieplitik Schweiz (AVES) Ve. M ', '', 16, 3, NULL, 94),
(298, 'Agro-Marketing Suisse (AMS), Bern Ve. V VP', '', 17, 15, NULL, 312),
(299, 'Verein Publikationen Spezialkulturen, Wädenswil Ve. M', '', 17, 15, NULL, 313),
(300, 'Genossenschaft Studentenhaus ALV, Zürich Gen. Qästor', '', 17, 2, NULL, 314),
(301, 'Hauseigentümerverband (HEV) Meilen und Umgebung Ve. M', '', 20, 9, NULL, 315),
(302, 'Aktion für vernünftige Energieplitik Schweiz (AVES)    - V M', '', 20, 3, NULL, 94),
(303, 'Stiftung Schweizer Volkskultur, Bubikon Stift. SR M', '', 26, 8, NULL, 316),
(305, 'Stiftung MyHandicap, Wil (SG) Stift. SR M', '', 28, 1, 3, 317),
(306, 'Schweizer Jugend forscht, Bern Stift. SR M', '', 28, 7, NULL, 218),
(307, 'HRS Holding AG, Frauenfeld AG VR P', '', 30, 9, NULL, 318),
(308, 'SCHMOLZ+BICKENBACH AG, Emmen AG VR M', '', 30, 9, NULL, 319),
(309, 'Spital Thurgau AG, Frauenfeld AG VR M', '', 30, 1, 5, 320),
(310, 'Roland Eberle Mercanda Consulting, Frauenfeld Einzelfirma Inhaber', '', 30, 9, NULL, 321),
(312, 'Careum Stiftung, Zürich Stift. SR M', '', 32, 1, 3, 322),
(313, 'AMIS Plus Stiftung, Zürich Stift. SR M', '', 32, 1, 4, 323),
(314, 'Dr. med. Ernst und Fanny Bachmann-Huber-Stiftung, Zürich Stift. SR M', '', 32, 7, NULL, 324),
(315, 'Foundation National Institute for Cancer Epidemiology and Registration (NICER), Zürich Stift. SR M', '', 32, 1, 4, 325),
(316, 'Pestalozzi-Stiftung für die Förderung der  Ausbildung Jugendlicher aus schweiz. Berggegenden, Zürich Stift. SR M', '', 32, 7, NULL, 326),
(317, 'Schweizerische Herzstiftung, Bern', '', 32, 1, 4, 327),
(318, 'Stiftung für Lungendiagnostik, Zürich Stift. SR M', '', 32, 1, 4, 328),
(319, 'Stiftung für Sucht- und Gesundheitsforschung, Zürich Stift. SR M', '', 32, 1, 4, 329),
(320, 'Aktion für vernünftige Energieplitik Schweiz (AVES) Ve. M', '', 32, 3, NULL, 94),
(321, 'Stiftung Walter Honegger zur Förderung der Krebsforschung, Zürich Stift. SR M', '', 32, 1, 4, 330),
(322, 'Verein "Forum Zürcher Gespräche", Zürich Ve. V M', '', 32, 7, NULL, 331),
(323, 'Adimosa  AG VR M', '', 33, 9, NULL, 332),
(325, 'NZZ-Mediengruppe AG, Zürich AG VR  M', '', 33, 18, NULL, 333),
(326, 'ASGA Pensionskasse, St. Gallen Gen. VR  M', '', 33, 9, NULL, NULL),
(327, 'Pensimo Anlagestiftung Stift. Sr. P', '', 33, 9, NULL, 335),
(328, 'Schweizerischer Arbeitgeberverband   Ve. V M', '', 33, 9, NULL, 336),
(329, 'Swiss Retail Federation Ve. V M', '', 33, 9, NULL, 337),
(330, 'Basler Leben AG, Basel, zeichnungsberechtigt', '', 34, 9, NULL, 338),
(331, 'Basler Versicherung AG, Basel, zeichnungsberechtigt', '', 34, 9, NULL, 339),
(332, 'SWISSAID, Schweizerische Stiftung für Entwicklungszusammenarbeit, Bern Stift. M', '', 37, 13, NULL, 340),
(333, 'Stiftung Allalin, Bern Stift. SR P', '', 38, 13, NULL, 341),
(334, 'Keradonum Stiftung Hornhautbank, Olten Stift. V M', '', 12, 1, 9, 74),
(335, 'Curaviva Ve. V P', '', 5, 2, NULL, 342),
(336, 'Intergenerika Ve. V P', '', 6, 1, 1, 343);
...
--
-- Daten für Tabelle `interessengruppe`
--

INSERT INTO `interessengruppe` (`id`, `bezeichnung`, `beschreibung`, `branche_id`) VALUES
...
--
-- Daten für Tabelle `kommission`
--

INSERT INTO `kommission` (`id`, `name`, `bezeichnung`, `beschreibung`) VALUES
...
CREATE TABLE IF NOT EXISTS `lobbyorganisation` (
  ...
  `beschreibung` text NOT NULL,
  `typ` set('EinzelOrganisation','DachOrganisation','MitgliedsOrganisation','LeistungsErbringer','dezidierteLobby') NOT NULL,
  `url` varchar(255) NOT NULL,
  `branche_id` int(11) DEFAULT NULL COMMENT 'FK lobbytyp',
  `interessengruppe_id` int(11) DEFAULT NULL COMMENT 'FK von lobbygruppen',
  ...
  KEY `idx_lobbytyp` (`branche_id`),
  KEY `idx_lobbygroup` (`interessengruppe_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Lobbyorganisationen' AUTO_INCREMENT=349 ;

--
-- RELATIONEN DER TABELLE `lobbyorganisation`:
--   `interessengruppe_id`
--       `interessengruppe` -> `id`
--   `branche_id`
--       `branche` -> `id`
...
--
-- Daten für Tabelle `lobbyorganisation`
--

INSERT INTO `lobbyorganisation` (`id`, `name`, `beschreibung`, `typ`, `url`, `branche_id`, `interessengruppe_id`, `vernehmlassung`, `parlam_verbindung`) VALUES
...
INSERT INTO `parlamentarier` (`id`, `name`, `vorname`, `beruf`, `ratstyp`, `kanton`, `partei_id`, `partei`, `parteifunktion`, `im_rat_seit`, `kommission`, `kleinbild`, `sitzplatz`) VALUES
(1, 'Blocher', 'Christoph', 'Unternehmer', 'NR', 'ZH', 0, 'SVP ', 'Vizepräsident SVP CH', '2011', 'SGK-NR, SPK-NR', 'blocher-SVP-ZH-klein.jpg', 30),
(2, 'Borer', 'Roland.F', 'Unternehmer', 'NR', 'SO', 0, 'SVP ', 'Mitglied', '1995', 'SGK-NR, SiK-NR', 'borer-SVP-SO-klein.jpg', 69),
(3, 'Bortoluzzi', 'Toni', 'Schreiner', 'NR', 'ZH', 0, 'SVP ', 'Mitglied', '1995', 'SGK-NR, SiK-NR', 'bortoluzzi-SVP-ZH-klein.jpg', 110),
(4, 'Carobbio Guscetti', 'Marina', 'Arzt', 'NR', 'TI', 0, 'SPS', 'Mitglied', '2007', 'SGK-NR, FK-NR, FinDel', 'carobbio-guscetti-SPS-TI-klein.jpg', 41),
(5, 'Cassis', 'Ignazio', 'Arzt', 'NR', 'TI', 0, 'FDP ', 'Mitglied', '2007', 'SGK-NR, ', 'cassis-ignazio-FDP-TI-klein.jpg', 27),
(6, 'de Courten', 'Thomas', 'Selbständiger Unternehmer,Leiter Wirtschaftsförderung Baselland ', 'NR', 'BL', 0, 'SVP ', 'Mitglied', '2011', 'SGK-NR', 'decourten-thomas-SVP-BL-klein.jpg', 161),
(7, 'Fehr', 'Jacqueline', 'Projektarbeiterin', 'NR', 'ZH', 0, 'SPS ', 'Mitglied', '1998', 'SGK-NR, GPK-NR, NAD-V', 'fehr-jacqueline-SPS-ZH-klein.jpg', 4),
(8, 'Frehner', 'Sebastian', 'Jurist, Unternehmer', 'NR', 'BS', 0, 'SVP ', 'Mitglied', '2010', 'SGK-NR', 'frehner-sebatian-SVP-BS-klein.jpg', 160),
(9, 'Gilli', 'Yvonne', 'Arzt', 'NR', 'SG', 0, 'GPS ', 'Mitglied', '2011', 'SGK-NR, WBK-NR', 'gilli-yvonne-GPS-SG-klein.jpg', 152),
(10, 'Heim', 'Bea', 'Rhythmik- und Heilpädagogin    ', 'NR', 'SO', 0, 'SPS ', 'Mitglied', '2003', 'SGK-NR, SPK-NR', 'heim-bea-SPS-SO-klein.jpg', 82),
(11, 'Hess', 'Lorenz', 'Gemeindepräsident, eidg. Dipl. PR-Berater, Unternehmer    ', 'NR', 'BE', 0, 'BDP ', 'Mitglied', '2011', 'SGK-NR', 'hess-lorenz-BDP-BE-klein.jpg', 130),
(12, 'Humbel', 'Ruth', 'Beraterin Gesundheitswesen', 'NR', 'AG', 0, 'CVP ', 'Mitglied', '2003', 'SPK-NR, SGK-NR', 'humbel-ruth-CVP-ZH-klein.jpg', 16),
(13, 'Ingold', 'Maja', 'Politikerin', 'NR', 'ZH', 0, 'EVP ', 'Mitglied', '2010', 'SGK-NR', 'ingold-maja-EVP-ZH-klein.jpg', 89),
(14, 'Lohr', 'Christian', 'Journalist, Dozent versch. Fachhochschulen, Publizist    ', 'NR', 'TG', 0, 'CVP ', 'Mitglied', '2011', 'SGK-NR', 'lohr-christian-CVP-TG-klein.jpg', 7),
(15, 'Moret', 'Isabelle', 'Avocate', 'NR', 'VD', 0, 'FDP ', 'Mitglied', '2006', 'SGK-NR, SPK-NR', 'moret-isabelle-FDP-VD-klein.jpg', 26),
(16, 'Parmelin', 'Guy', 'Viticulteur, Agriculteur ', 'NR', 'VD', 0, 'SVP', 'Vizepräsident SVP CH??', '2003', 'SGK-NR, UREK-NR', 'pamelin-guy-SVP-VD-klein.jpg', 103),
(17, 'Pezzatti', 'Bruno', 'Direktor des Schweizerischen Obstverbandes   ', 'NR', 'ZG', 0, 'FDP', 'Mitglied', '2011', 'SGK-NR', 'pezzatti-brruno-FDP-ZH-klein.jpg', 97),
(18, 'Rossini', 'Stéphane', 'Professeur, HES-SO, ESSP Lausanne et Université de Genève    ', 'NR', 'VS', 0, 'SPS ', 'Präsident GSK', '1999', 'SGK-NR', 'rossini-stephane-SPS-VS-klein.jpg', 39),
(19, 'Schenker', ' Silvia', 'Sozialarbeiterin', 'NR', 'BS', 0, 'SPS', 'Mitglied', '2003', 'SGK-NR, SPK-NR', 'schenker-silvia-SPS-BS-klein.jpg', 42),
(20, 'Schmid-Federer', 'Barbara', 'Familienfrau, Unternehmerin    ', 'NR', 'ZH', 0, 'CVP ', 'Mitglied', '2007', 'SGK-NR', 'schmid-federer-barbara-CVP-ZH-klein.jpg', 13),
(21, 'Schneeberger ', 'Daniela', 'Treuhänderin mit eidg. Fachausweis, Inhaberin und Geschäftsführerin, Steuerexpertin     ', 'NR', 'BL', 0, 'FDP ', 'Mitglied', '2011', 'SGK-NR', 'schneeberger-daniela-FDP-BL-klein.jpg', 57),
(22, 'Stahl', 'Jürg', 'Mitglied der Geschäftsleitung, Leiter Service Center   ', 'NR', 'ZH', 0, 'SVP ', 'Mitglied', '1999', 'SGK -R, WBK-NR', 'stahl-juerg-SVP-ZH-klein.jpg', 68),
(23, 'Steiert', 'Jean-François', 'Del. für interkant. Angelegenheiten der Waadtländer Erziehungsdirektion   ', 'NR', 'FR', 0, 'SPS ', 'Mitglied', '2007', 'SGK-NR, WBK-NR', 'steiert-jean-francois-SPS-FR-klein.jpg', 78),
(24, 'van Singer', 'Christian', 'Physicien', 'NR', 'VD', 0, 'GPS ', 'Mitglied', '2007', 'SGK-NR, SiK-NR', 'vansinger-christian-GPS-VD-klein.jpg', 149),
(25, 'Weibel', 'Thomas', 'dipl. Ing. ETH / SIA, Professor ', 'NR', 'ZH', 0, 'GLP  ', 'Mitglied', '2007', 'SGK-NR, WBK-NR', 'weibel-thomas-GLP-ZH-klein.jpg', 91),
(26, 'Egerszegi-Obrist ', 'Christine ', 'Politikerin', 'SR', 'AG', 0, 'FDP', 'Mitglied', '2007', 'SGK-SR, KVF-SR, SPK-SR, OSZE-V', 'egerszegi-obrist-christine-FDP-AG-klein.jpg', 22),
(27, 'Bischofberger', ' Ivo ', 'Rektor Gymnasium Appenzell ', 'SR', 'AI', 0, 'CVP', 'Mitglied', '2007', 'APK-SR,WEK-SR, SGK-SR, RedK-V, UVEK-SR', 'bischofberger-ivo-CVP-AI-klein.jpg', 27),
(28, 'Bruderer Wyss ', 'Pascale ', 'Vizepräsidentin SP Schweiz', 'SR', 'AG', 0, 'SPS', 'Mitglied', '2011', 'SGK-SR, SPK-SR,UREK-SR, DEL FL-V, DEL A-V', 'bruderer-wyss-pascale-SPS-AG-klein.jpg', 16),
(29, 'Diener Lenz ', 'Verena ', 'Mediatorin, Politikerin', 'SR', 'ZH', 0, 'GLP', 'Mitglied', '2007', 'SPK-SR, SGK-SR, UREK-SR', 'diener-lenz-verena-GLP-ZH-klein.jpg', 39),
(30, 'Eberle ', 'Roland', 'Unternehmer', 'SR', 'TG', 0, 'SVP', 'Mitglied', '2011', 'SGK-SR, APK-SR, UREK-SR, GK-V, DEL D -V', 'eberle-roland-SVP-TG-klein.jpg', 34),
(31, 'Graber ', 'Konrad ', 'dipl. Wirtschaftsprüfer, Partner, Mitglied VR BDO AG ', 'SR', 'LU', 0, 'CVP', 'Mitglied', '2007', 'SGK-SR, KVF-SR, WAK-SR, BeK-V, EFTA/EP-V', 'graber-konrad-CVP-LU-klein.jpg', 26),
(32, 'Gutzwiller ', 'Felix ', 'Professor, Institutsdirektor', 'SR', 'ZH', 0, 'FDP', 'Mitglied', '2007', 'APK-SR, WBK-SR, SGK-SR, IPU-V', 'gutzwiller-felix-FDP-ZH-klein.jpg', 9),
(33, 'Keller-Sutter', ' Karin ', 'Regierungsrätin, Vorsteherin Sicherheits- und Justizdepartement Kanton St. Gallen', 'SR', 'SG', 0, 'FDP', 'Mitglied', '2011', 'WAK-SR, SGK-SR, APK-SR, EFTA/EP-V,Del A-V,Del Fl-V', 'keller-suter-karin-FDP-SG-klein.jpg', 20),
(34, 'Kuprecht ', 'Alex ', 'Relation Manager', 'SR', 'SZ', 0, 'SVP', 'Mitglied', '2003', 'SiK-SR, SGK-SR, GPK-SR, OSZE-V, NATO-V,GPDel-V, del A-V, del FL-V ', 'kuprecht-alex-SVP-SZ-klein.jpg', 35),
(35, 'Maury Pasquier ', 'Liliane ', 'Politikerin, Hebamme', 'SR', 'GE', 0, 'SPS', 'Mitglied', '2007', 'WBK-SR,APK-SR, SGK-SR, PVER, APF,Del F-V', 'maury-pasquier-liliane-SPS-GE-klein.jpg', 29),
(36, 'Rechsteiner', 'Paul ', 'Rechtsanwalt', 'SR', 'SG', 0, 'SPS', 'Mitglied', '2011', 'SGK-SR, KVF-SR', 'rechsteiner-paul-SPS-SG-klein.jpg', 32),
(37, 'Schwaller ', 'Urs ', 'Rechtsanwalt', 'SR', 'FR', 0, 'CVP', 'Mitglied', '2003', 'SGK-SR, SPK-SR,  FK-SR, FinDel-V, ERD-V', 'schwaller-urs-CVP-FR-klein.jpg', 42),
(38, 'Stöckli', 'Hans', 'Präsident Tourismus Jura & Drei-Seen-Land ', 'SR', 'BE', 0, 'SPS', 'Mitglied', '2011', 'SGK-SR,FK-SR, SPK-SR,, BeK-V', 'stoeckli-hans-SPS-BE-klein.jpg', 18);
...
CREATE TABLE IF NOT EXISTS `partei` (
  ...
  `pt_name_lang` varchar(100) DEFAULT NULL,
  `pt_bemerkung` text,
  `pt_gruendung` date DEFAULT NULL,
  `pt_position` enum('links','rechts','mitte','') DEFAULT NULL,
  `pt_created_by` varchar(10) DEFAULT NULL,
  `pt_created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pt_updated_by` varchar(10) DEFAULT NULL,
  `pt_updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`pt_id`),
...
INSERT INTO `partei` (`pt_id`, `pt_name`, `pt_name_lang`, `pt_bemerkung`, `pt_gruendung`, `pt_position`, `pt_created_by`, `pt_created_date`, `pt_updated_by`, `pt_updated_date`) VALUES
(0, 'xy', NULL, 'bem9', NULL, NULL, NULL, '2013-11-10 11:56:26', NULL, '2013-11-10 12:16:24');
...
CREATE TABLE IF NOT EXISTS `zugangsberechtigung` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parlamentarier_id` int(11) NOT NULL COMMENT 'FK parlamentarier',
  `nachname` varchar(160) NOT NULL,
  `vorname` varchar(160) NOT NULL,
  `funktion` varchar(255) DEFAULT NULL,
  `branche_id` int(11) DEFAULT NULL COMMENT 'FK lobbytyp',
  `interessengruppe_id` int(11) DEFAULT NULL,
  `lobbyorganisation_id` int(11) DEFAULT NULL COMMENT 'FK lobbyorg',
  PRIMARY KEY (`id`),
  KEY `idx_parlam` (`parlamentarier_id`),
  KEY `idx_lobbytyp` (`branche_id`),
  KEY `idx_lobbygroup` (`interessengruppe_id`),
...
--
-- Daten für Tabelle `zugangsberechtigung`
--

INSERT INTO `zugangsberechtigung` (`id`, `parlamentarier_id`, `nachname`, `vorname`, `funktion`, `branche_id`, `interessengruppe_id`, `lobbyorganisation_id`) VALUES
...
ALTER TABLE `parlamentarier`
  ADD CONSTRAINT `fk_partei_id` FOREIGN KEY (`partei_id`) REFERENCES `partei` (`pt_id`);
