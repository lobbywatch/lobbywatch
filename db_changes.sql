...
CREATE TABLE `in_rat` (
  ...
  CONSTRAINT `fk_in_rat_rat_id` FOREIGN KEY (`rat_id`) REFERENCES `rat` (`id`),
...
CREATE TABLE `in_partei` (
  ...
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgäendert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  `in_partei_parlamentarier_partei_unique` varchar(45) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (concat_ws('_',`parlamentarier_id`,`partei_id`,ifnull(`bis`,'9999-12-31'))) VIRTUAL NOT NULL COMMENT 'Kombination aus parlamentarier_id, partei_id und bis muss eindeutig sein. (Fachlicher unique constraint)',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_in_partei_partei_id` FOREIGN KEY (`partei_id`) REFERENCES `partei` (`id`),
...
CREATE TABLE `in_fraktion` (
  ...
  `updated_visa` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Abgäendert von',
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Abgeändert am',
  `in_fraktion_parlamentarier_fraktion_unique` varchar(45) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (concat_ws('_',`parlamentarier_id`,`fraktion_id`,ifnull(`bis`,'9999-12-31'))) VIRTUAL NOT NULL COMMENT 'Kombination aus parlamentarier_id, fraktion_id und bis muss eindeutig sein. (Fachlicher unique constraint)',
  PRIMARY KEY (`id`),
...
-- 05.06.2023 add new bfs_gemeinden

INSERT INTO bfs_gemeinde SET GDEKT='ZH', GDEBZNR=102, GDENR=291, GDENAME='Andelfingen', GDENAMK='Andelfingen', GDEBZNA='Bezirk Andelfingen', GDEKTNA='Zürich', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import' ON DUPLICATE KEY UPDATE GDEKT='ZH', GDEBZNR=102, GDENR=291, GDENAME='Andelfingen', GDENAMK='Andelfingen', GDEBZNA='Bezirk Andelfingen', GDEKTNA='Zürich', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import';
INSERT INTO bfs_gemeinde SET GDEKT='BE', GDEBZNR=246, GDENR=546, GDENAME='Münchenbuchsee', GDENAMK='Münchenbuchsee', GDEBZNA='Verwaltungskreis Bern-Mittelland', GDEKTNA='Bern / Berne', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import' ON DUPLICATE KEY UPDATE GDEKT='BE', GDEBZNR=246, GDENR=546, GDENAME='Münchenbuchsee', GDENAMK='Münchenbuchsee', GDEBZNA='Verwaltungskreis Bern-Mittelland', GDEKTNA='Bern / Berne', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import';
INSERT INTO bfs_gemeinde SET GDEKT='SG', GDEBZNR=1727, GDENR=3396, GDENAME='Neckertal', GDENAMK='Neckertal', GDEBZNA='Wahlkreis Toggenburg', GDEKTNA='St. Gallen', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import' ON DUPLICATE KEY UPDATE GDEKT='SG', GDEBZNR=1727, GDENR=3396, GDENAME='Neckertal', GDENAMK='Neckertal', GDEBZNA='Wahlkreis Toggenburg', GDEKTNA='St. Gallen', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import';
INSERT INTO bfs_gemeinde SET GDEKT='AG', GDEBZNR=1905, GDENR=4139, GDENAME='Menziken', GDENAMK='Menziken', GDEBZNA='Bezirk Kulm', GDEKTNA='Aargau', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import' ON DUPLICATE KEY UPDATE GDEKT='AG', GDEBZNR=1905, GDENR=4139, GDENAME='Menziken', GDENAMK='Menziken', GDEBZNA='Bezirk Kulm', GDEKTNA='Aargau', GDEMUTDAT='2023-01-01', created_visa='import', updated_visa='import';
