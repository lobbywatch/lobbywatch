...
ALTER TABLE `parlamentarier`
  ...
  ADD `titel` VARCHAR(75) NULL DEFAULT NULL COMMENT 'Titel des Parlamentariers, wird von ws.parlament.ch importiert' AFTER `beruf_interessengruppe_id`,
...
ALTER TABLE `parlamentarier_log`
  ...
  ADD `titel` VARCHAR(75) NULL DEFAULT NULL COMMENT 'Titel des Parlamentariers' AFTER `beruf_interessengruppe_id`,
...
-- ALTER TABLE `parlamentarier` CHANGE `titel` `titel` VARCHAR(75) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Titel des Parlamentariers, wird von ws.parlament.ch importiert';
-- ALTER TABLE `parlamentarier_log` CHANGE `titel` `titel` VARCHAR(75) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Titel des Parlamentariers, wird von ws.parlament.ch importiert';
