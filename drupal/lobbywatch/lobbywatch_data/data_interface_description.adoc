...
The data interface description is also available as https://cms.lobbywatch.ch/sites/all/modules/lobbywatch/lobbywatch_data/openapi/lobbywatch_dataif_sepc.html[OpenAPI 3.0 specification].
