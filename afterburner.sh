...
for file in $dir/*.php
do
  if [[ $file != public_html/bearbeitung/parlamentarier_anhang.php ]] && ( [[ $file == public_html/bearbeitung/parlamentarier_*.php ]] || [[ $file == public_html/bearbeitung/anteil.php ]] ); then
    echo "Skip $file"
    continue
  fi
  echo "Process $file";
