...
wine "C:\Program Files (x86)\SQL Maestro Group\PHP Generator for MySQL Professional 12.8.0.18_20140722\MyPHPGeneratorPro.exe" "lobbywatch_bearbeitung_gen.pgtm" -output "public_html\bearbeitung" -generate
