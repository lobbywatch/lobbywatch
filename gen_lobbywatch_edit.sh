...
wine "C:\Program Files (x86)\SQL Maestro Group\PHP Generator for MySQL Professional 14.10.0.3\MyPHPGeneratorPro.exe" "lobbywatch_bearbeitung_gen.pgtm" -output "public_html\bearbeitung" -generate
