...
wine "C:\Program Files\SQL Maestro Group\PHP Generator for MySQL Professional\MyPHPGeneratorPro.exe" "Z:\home\rkurmann\dev\web\lobbywatch\lobbydev\lobbywatch_bearbeitung_gen.pgtm" -output "Z:\home\rkurmann\dev\web\lobbywatch\lobbydev\public_html\bearbeitung" -generate
