...
wine "C:\Program Files (x86)\SQL Maestro Group\PHP Generator for MySQL Professional 12.8.0.18_20140722\MyPHPGeneratorPro.exe" "Z:\home\rkurmann\dev\web\lobbywatch\lobbydev\lobbywatch_bearbeitung_gen.pgtm" -output "Z:\home\rkurmann\dev\web\lobbywatch\lobbydev\public_html\bearbeitung" -generate
