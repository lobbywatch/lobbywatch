...
// $testreihesr=array('0');
$standbild = array (
    "<img src='./icons/gruene_sitz.png' title='Gr&uuml;ne'/>",
    "<img src='./icons/sps_sitz.png' title='SPS'/>",
    "<img src='./icons/cvp_sitz.png' title='CVP'/>",
    "<img src='./icons/fdp_sitz.png' title='FDP'/>",
    "<img src='./icons/svp_sitz.png' title='SVP'/>",
    "<img src='./icons/bdp_sitz.png' title='BDP'/>",
    "<img src='./icons/gruenliberale_sitz.png' title='Gr&uuml;mliberale'/>" 
);
$auswahlbild = array (
    "<img src='./icons/gruene_sitz_auswahl.png' title='click for details' class='auswahlsr' />",
    "<img src='./icons/sps_sitz_auswahl.png' title='click for details' class='auswahlsr' />",
    "<img src='./icons/cvp_sitz_auswahl.png' title='click for details' class='auswahlsr' />",
    "<img src='./icons/fdp_sitz_auswahl.png' title='click for details' class='auswahlsr' />",
    "<img src='./icons/svp_sitz_auswahl.png' title='click for details' class='auswahlsr' />",
    "<img src='./icons/bdp_sitz_auswahl.png' title='click for details' class='auswahlsr' />",
    "<img src='./icons/gruenliberale_sitz_auswahl.png' title='click for details' class='auswahlsr' />" 
);
// 1. reihe 4,3,3,4
$html = "<div id='sr' style=';margin-top:600px;margin-left:180px;'>";
...
$sitzplatz = 43;
$stimmz = array (
    5 => "<img src='./icons/sps_sitz.png'/>",
    6 => "<img src='./icons/svp_sitz.png' />" 
);
for($i = 1; $i <= $anz; $i ++) {
  if ($i == 4 or $i == 7) {
