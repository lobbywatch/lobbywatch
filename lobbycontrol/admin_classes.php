...
$optionen=array(PDO::ATTR_PERSISTENT => true);
...
//print_r ($lg); 
 ...
 /*$html .="<li><label for='thema'>Themensuche</label><br> <select name='thema' id='thema' size='1' >";
 $html .="<option value='alle'>alle</option>";
 $html .="</select></li><br>";*/
 ...
 *******************************************************************************************************************/
 ...
 if(is_string($erg)){//Keine daten in dieser Abfrage
     ...
     $html="<h3> $erg</h3>";
       ...
       switch($bedeutung){
       case '1': $bedeutung='hoch';
       break;
       case '2': $bedeutung='mittel';
       break;
       case '3': $bedeutung='gering';
       break;
       default: $bedeutung='alle';
       }
...
//var colors = ["#bed6c7","#adc0b4","#8a7e66","#a79b83","#bbb2a1"]
 ...
 /***************************************************************************************************
  Kommissionen und Gesch&auml;fte ev. Vernehmlassungen
...
$user = strstr($email, '@', true); // As of PHP 5.3.0 geht bei mir  ->PHP 5.3.5
